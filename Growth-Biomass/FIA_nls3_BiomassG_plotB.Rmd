...
### cutvec and bin mids
cutvec_255 <- c(0,creditmodel::cut_equal(G_255$B_plt_t1_MgHa, g=20)[1:19], max(G_255$B_plt_t1_MgHa))
bin_mids_255 <- round(cutvec_255[-length(cutvec_255)] + diff(cutvec_255)/2)
