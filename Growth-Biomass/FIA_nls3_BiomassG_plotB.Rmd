...
gg.222.2 <- ggplot() +
             ...
             stat_summary_bin(aes(x = B_plt_t1_MgHa, y = G_obs_TreeInc_MgHaYr), data = G_222, 
                              fun.data = function(x) {
                                ...
                                names(res) <- c("ymin","y","ymax")
                                res}, 
                              col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_222)+1)), breaks = cutvec_222) +         
...
gg.263.2 <- ggplot() +
             ...
             stat_summary_bin(aes(x = B_plt_t1_MgHa, y = G_obs_TreeInc_MgHaYr), data = G_263, 
                              fun.data = function(x) {
                                ...
                                names(res) <- c("ymin","y","ymax")
                                res}, 
                              col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_263)+1)), breaks = cutvec_263) +         
...
gg.313.2 <- ggplot() +
             ...
             stat_summary_bin(aes(x = B_plt_t1_MgHa, y = G_obs_TreeInc_MgHaYr), data = G_313, 
                              fun.data = function(x) {
                                ...
                                names(res) <- c("ymin","y","ymax")
                                res}, 
                              col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_313)+1)), breaks = cutvec_313) +         
...
gg.M242.2 <- ggplot() +
             ...
             stat_summary_bin(aes(x = B_plt_t1_MgHa, y = G_obs_TreeInc_MgHaYr), data = G_M242, 
                              fun.data = function(x) {
                                ...
                                names(res) <- c("ymin","y","ymax")
                                res}, 
                              col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_M242)+1)), breaks = cutvec_M242) +         
...
gg.M332.2 <- ggplot() +
             ...
             stat_summary_bin(aes(x = B_plt_t1_MgHa, y = G_obs_TreeInc_MgHaYr), data = G_M332, 
                              fun.data = function(x) {
                                ...
                                names(res) <- c("ymin","y","ymax")
                                res}, 
                              col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_M332)+1)), breaks = cutvec_M332) +         
