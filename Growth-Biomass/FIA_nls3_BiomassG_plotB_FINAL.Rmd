---
title: "FIA NLS Models: Biomass Growth vs. Biomass"
author: "JAH"
date: "`r Sys.Date()`"
output:
  html_document:
...
setwd("C:/Users/hogan.jaaron/Dropbox/FIA_R/NLS_modeling/New_G_nov2022/BiomassG_plotB")
# setwd("C:/Users/hogie/Dropbox/FIA_R/NLS_modeling/New_G_nov2022/BiomassG_plotB")    # if working on P-50
...
__model 1:  simple tau model__
$G = (1 + (yr-1990)* \tau/100) \times \left( \frac {A \cdot B_{t1}} {k+B_{t1}} \right)$

__model 2: tau-alpha model__
$G = (1 + (yr-1990)* \tau/100) \times (1 + \phi \cdot \Delta PDSI)  \times (1 - \alpha \cdot B_l) \times \left( \frac {A \cdot B_{t1}} {k+B_{t1}} \right)$
...
### model 1
fg_1 <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))
## model 2
fg_2 <-  formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * (1 + alpha*B_L_prop) * A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))

## model 1 variants
fg_1a <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * (p*A+((1-p)*A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))))
fg_1b <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * (A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s)))
fg_1c <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * (p*A+((1-p)*A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s))))


## model 2 variants
fg_2a <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * (1-alpha*B_L_prop) * (p*A+((1-p)*A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))))
fg_2b <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * (1-alpha*B_L_prop) * (A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s)))
fg_2c <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*tau/100) * (1-alpha*B_L_prop) * (p*A+((1-p)*A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s))))
...
## get bin means
G_bin_means <- tapply(G_211$G_MassBal_MgHaYr, cut(G_211$B_plt_t1_MgHa, cutvec_211), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_211.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tauand alpha
nls.param.df2[nls.param.df2$Code == "211",]$tau.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "211",]$alpha.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "211",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "211",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "211",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "211",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_211 <-data.frame(
  ...
  data.mean = tapply(G_211$G_MassBal_MgHaYr, cut(G_211$B_plt_t1_MgHa, cutvec_211), 
                     mean), 
  data.CI.high =  tapply(G_211$G_MassBal_MgHaYr, cut(G_211$B_plt_t1_MgHa, cutvec_211), 
                    high.CI), 
  data.CI.low = tapply(G_211$G_MassBal_MgHaYr, cut(G_211$B_plt_t1_MgHa, cutvec_211),
                    low.CI), 
...
## PLOTTING 2
gg.211.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_211, 
...
## get bin means
G_bin_means <- tapply(G_212$G_MassBal_MgHaYr, cut(G_212$B_plt_t1_MgHa, cutvec_212), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_212.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
nls.param.df2[nls.param.df2$Code == "212",]$tau.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "212",]$alpha.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "212",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "212",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "212",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "212",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_212 <-data.frame(
  ...
  data.mean = tapply(G_212$G_MassBal_MgHaYr, cut(G_212$B_plt_t1_MgHa, cutvec_212), 
                     mean, na.rm =T), 
  data.CI.high =  tapply(G_212$G_MassBal_MgHaYr, cut(G_212$B_plt_t1_MgHa, cutvec_212), 
                    high.CI), 
  data.CI.low = tapply(G_212$G_MassBal_MgHaYr, cut(G_212$B_plt_t1_MgHa, cutvec_212),
                    low.CI), 
...
## PLOTTING 2
gg.212.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_212, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_221$G_MassBal_MgHaYr, cut(G_221$B_plt_t1_MgHa, cutvec_221), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_221.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "221",]$tau.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "221",]$alpha.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "221",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "221",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "221",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "221",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_221 <-data.frame(
  ...
  data.mean = tapply(G_221$G_MassBal_MgHaYr, cut(G_221$B_plt_t1_MgHa, cutvec_221), 
                     mean, na.rm =T), 
  data.CI.high =  tapply(G_221$G_MassBal_MgHaYr, cut(G_221$B_plt_t1_MgHa, cutvec_221), 
                    high.CI), 
  data.CI.low = tapply(G_221$G_MassBal_MgHaYr, cut(G_221$B_plt_t1_MgHa, cutvec_221),
                    low.CI), 
...
## PLOTTING 2
gg.221.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_221, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_222$G_MassBal_MgHaYr, cut(G_222$B_plt_t1_MgHa, cutvec_222), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_222.",  Mod.Sel1, sep ="")))["alpha"], 1)}
  ...
  assign(
    paste("nls_222.", Mod.Sel1, "c", sep =""), 
      nls(get(paste("fg_", Mod.Sel1, "c", sep ="")), 
          data = G_222,
          start = if(Mod.Sel1 == 1) {
            c(tau.fit, A.fit, k.fit, s=1.5, p=0.1)
            } else if(Mod.Sel1 == 2){
              c(tau.fit, alpha.fit, A.fit, k.fit, s=1.5, p=0.1)
              }, 
          weights = G_222$nls_weights))
 )
## end MODEL FITTING 2 ----------------------------------------------------------------------- ##
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "222",]$tau.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "222",]$alpha.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "222",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "222",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "222",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "222",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_222 <-data.frame(
  ...
  data.mean = tapply(G_222$G_MassBal_MgHaYr, cut(G_222$B_plt_t1_MgHa, cutvec_222), 
                     mean), 
  data.CI.high =  tapply(G_222$G_MassBal_MgHaYr, cut(G_222$B_plt_t1_MgHa, cutvec_222), 
                    high.CI), 
  data.CI.low = tapply(G_222$G_MassBal_MgHaYr, cut(G_222$B_plt_t1_MgHa, cutvec_222),
                    low.CI), 
...
## PLOTTING 2
gg.222.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_222, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_223$G_MassBal_MgHaYr, cut(G_223$B_plt_t1_MgHa, cutvec_223), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_223.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "223",]$tau.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "223",]$alpha.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "223",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "223",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "223",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "223",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_223 <-data.frame(
  ...
  data.mean = tapply(G_223$G_MassBal_MgHaYr, cut(G_223$B_plt_t1_MgHa, cutvec_223), 
                     mean), 
  data.CI.high =  tapply(G_223$G_MassBal_MgHaYr, cut(G_223$B_plt_t1_MgHa, cutvec_223), 
                    high.CI), 
  data.CI.low = tapply(G_223$G_MassBal_MgHaYr, cut(G_223$B_plt_t1_MgHa, cutvec_223),
                    low.CI), 
...
## PLOTTING 2
gg.223.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_223, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_231$G_MassBal_MgHaYr, cut(G_231$B_plt_t1_MgHa, cutvec_231), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_231.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "231",]$tau.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "231",]$alpha.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "231",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "231",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "231",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "231",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_231 <-data.frame(
  ...
  data.mean = tapply(G_231$G_MassBal_MgHaYr, cut(G_231$B_plt_t1_MgHa, cutvec_231), 
                     mean), 
  data.CI.high =  tapply(G_231$G_MassBal_MgHaYr, cut(G_231$B_plt_t1_MgHa, cutvec_231), 
                    high.CI), 
  data.CI.low = tapply(G_231$G_MassBal_MgHaYr, cut(G_231$B_plt_t1_MgHa, cutvec_231),
                    low.CI), 
...
## PLOTTING 2
gg.231.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_231, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_232$G_MassBal_MgHaYr, cut(G_232$B_plt_t1_MgHa, cutvec_232), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_232.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "232",]$tau.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["tau","tau"]}
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "232",]$alpha.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df2[nls.param.df2$Code == "232",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "232",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "232",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "232",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_232 <-data.frame(
  ...
  data.mean = tapply(G_232$G_MassBal_MgHaYr, cut(G_232$B_plt_t1_MgHa, cutvec_232), 
                     mean), 
  data.CI.high =  tapply(G_232$G_MassBal_MgHaYr, cut(G_232$B_plt_t1_MgHa, cutvec_232), 
                    high.CI), 
  data.CI.low = tapply(G_232$G_MassBal_MgHaYr, cut(G_232$B_plt_t1_MgHa, cutvec_232),
                    low.CI), 
...
## PLOTTING 2
gg.232.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_232, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_234$G_MassBal_MgHaYr, cut(G_234$B_plt_t1_MgHa, cutvec_234), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_234.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "234",]$alpha <- coefs["alpha"]}
nls.param.df2[nls.param.df2$Code == "234",]$A <- coefs["A"]
nls.param.df2[nls.param.df2$Code == "234",]$k <- coefs["k"]

## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "234",]$tau.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df2[nls.param.df2$Code == "234",]$alpha.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df2[nls.param.df2$Code == "234",]$tau.2.5 <- intervals_low["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "234",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "234",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_234 <-data.frame(
  ...
  data.mean = tapply(G_234$G_MassBal_MgHaYr, cut(G_234$B_plt_t1_MgHa, cutvec_234), 
                     mean), 
  data.CI.high =  tapply(G_234$G_MassBal_MgHaYr, cut(G_234$B_plt_t1_MgHa, cutvec_234), 
                    high.CI), 
  data.CI.low = tapply(G_234$G_MassBal_MgHaYr, cut(G_234$B_plt_t1_MgHa, cutvec_234),
                    low.CI), 
...
## PLOTTING 2
gg.234.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_234, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark points = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_242$G_MassBal_MgHaYr, cut(G_242$B_plt_t1_MgHa, cutvec_242), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_242.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "242",]$tau.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "242",]$alpha.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "242",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "242",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "242",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "242",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_242 <-data.frame(
  ...
  data.mean = tapply(G_242$G_MassBal_MgHaYr, cut(G_242$B_plt_t1_MgHa, cutvec_242), 
                     mean), 
  data.CI.high =  tapply(G_242$G_MassBal_MgHaYr, cut(G_242$B_plt_t1_MgHa, cutvec_242), 
                    high.CI), 
  data.CI.low = tapply(G_242$G_MassBal_MgHaYr, cut(G_242$B_plt_t1_MgHa, cutvec_242),
                    low.CI), 
...
## PLOTTING 2
gg.242.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_242, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_251$G_MassBal_MgHaYr, cut(G_251$B_plt_t1_MgHa, cutvec_251), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_251.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "251",]$tau.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "251",]$alpha.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "251",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "251",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "251",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "251",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_251 <-data.frame(
  ...
  data.mean = tapply(G_251$G_MassBal_MgHaYr, cut(G_251$B_plt_t1_MgHa, cutvec_251), 
                     mean), 
  data.CI.high =  tapply(G_251$G_MassBal_MgHaYr, cut(G_251$B_plt_t1_MgHa, cutvec_251), 
                    high.CI), 
  data.CI.low = tapply(G_251$G_MassBal_MgHaYr, cut(G_251$B_plt_t1_MgHa, cutvec_251),
                    low.CI), 
...
## PLOTTING 2
gg.251.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_251, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_255$G_MassBal_MgHaYr, cut(G_255$B_plt_t1_MgHa, cutvec_255), mean)
...
try(
  nls_255.1 <- nls(fg_1, data = G_255, 
                   start = c(tau=tau.start, A=2, k=k.start), 
...
try(
  nls_255.2 <- nls(fg_2, data=G_255, 
                   start = c(tau=tau.start, alpha=alpha.start, A=2, k=k.start), 
                   weights = G_255$nls_weights), 
 )
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_255.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "255",]$tau.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "255",]$alpha.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "255",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "255",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "255",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "255",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_255 <-data.frame(
  ...
  data.mean = tapply(G_255$G_MassBal_MgHaYr, cut(G_255$B_plt_t1_MgHa, cutvec_255), 
                     mean), 
  data.CI.high =  tapply(G_255$G_MassBal_MgHaYr, cut(G_255$B_plt_t1_MgHa, cutvec_255), 
                    high.CI), 
  data.CI.low = tapply(G_255$G_MassBal_MgHaYr, cut(G_255$B_plt_t1_MgHa, cutvec_255),
                    low.CI), 
...
## PLOTTING 2
gg.255.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_255, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_261$G_MassBal_MgHaYr, cut(G_261$B_plt_t1_MgHa, cutvec_261), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_261.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "261",]$tau.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "261",]$alpha.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "261",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "261",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "261",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "261",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_261 <-data.frame(
  ...
  data.mean = tapply(G_261$G_MassBal_MgHaYr, cut(G_261$B_plt_t1_MgHa, cutvec_261), 
                     mean), 
  data.CI.high =  tapply(G_261$G_MassBal_MgHaYr, cut(G_261$B_plt_t1_MgHa, cutvec_261), 
                    high.CI), 
  data.CI.low = tapply(G_261$G_MassBal_MgHaYr, cut(G_261$B_plt_t1_MgHa, cutvec_261),
                    low.CI), 
...
## PLOTTING 2
gg.261.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_261, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_262$G_MassBal_MgHaYr, cut(G_262$B_plt_t1_MgHa, cutvec_262), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_262.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "262",]$tau.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "262",]$alpha.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "262",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "262",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "262",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "262",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_262 <-data.frame(
  ...
  data.mean = tapply(G_262$G_MassBal_MgHaYr, cut(G_262$B_plt_t1_MgHa, cutvec_262), 
                     mean), 
  data.CI.high =  tapply(G_262$G_MassBal_MgHaYr, cut(G_262$B_plt_t1_MgHa, cutvec_262), 
                    high.CI), 
  data.CI.low = tapply(G_262$G_MassBal_MgHaYr, cut(G_262$B_plt_t1_MgHa, cutvec_262),
                    low.CI), 
...
## PLOTTING 2
gg.262.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_262, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_263$G_MassBal_MgHaYr, cut(G_263$B_plt_t1_MgHa, cutvec_263), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_263.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "263",]$tau.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "263",]$alpha.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "263",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "263",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "263",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "263",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_263 <-data.frame(
  ...
  data.mean = tapply(G_263$G_MassBal_MgHaYr, cut(G_263$B_plt_t1_MgHa, cutvec_263), 
                     mean), 
  data.CI.high =  tapply(G_263$G_MassBal_MgHaYr, cut(G_263$B_plt_t1_MgHa, cutvec_263), 
                    high.CI), 
  data.CI.low = tapply(G_263$G_MassBal_MgHaYr, cut(G_263$B_plt_t1_MgHa, cutvec_263),
                    low.CI), 
...
## PLOTTING 2
gg.263.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_263, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_313$G_MassBal_MgHaYr, cut(G_313$B_plt_t1_MgHa, cutvec_313), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_313.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "313",]$tau.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "313",]$alpha.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "313",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "313",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "313",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "313",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_313 <-data.frame(
  ...
  data.mean = tapply(G_313$G_MassBal_MgHaYr, cut(G_313$B_plt_t1_MgHa, cutvec_313), 
                     mean), 
  data.CI.high =  tapply(G_313$G_MassBal_MgHaYr, cut(G_313$B_plt_t1_MgHa, cutvec_313), 
                    high.CI), 
  data.CI.low = tapply(G_313$G_MassBal_MgHaYr, cut(G_313$B_plt_t1_MgHa, cutvec_313),
                    low.CI), 
...
## PLOTTING 2
gg.313.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_313, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_315$G_MassBal_MgHaYr, cut(G_315$B_plt_t1_MgHa, cutvec_315), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_315.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "315",]$tau.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "315",]$alpha.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "315",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "315",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "315",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "315",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_315 <-data.frame(
  ...
  data.mean = tapply(G_315$G_MassBal_MgHaYr, cut(G_315$B_plt_t1_MgHa, cutvec_315), 
                     mean), 
  data.CI.high =  tapply(G_315$G_MassBal_MgHaYr, cut(G_315$B_plt_t1_MgHa, cutvec_315), 
                    high.CI), 
  data.CI.low = tapply(G_315$G_MassBal_MgHaYr, cut(G_315$B_plt_t1_MgHa, cutvec_315),
                    low.CI), 
...
## PLOTTING 2
gg.315.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_315, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_321$G_MassBal_MgHaYr, cut(G_321$B_plt_t1_MgHa, cutvec_321), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_321.",  Mod.Sel1, sep ="")))["alpha"], 1)}
  ...
  assign(
    paste("nls_321.", Mod.Sel1, "a", sep =""), 
      nls(get(paste("fg_", Mod.Sel1, "a", sep ="")), 
          data = G_321,
          start = if(Mod.Sel1 == 1) {
            c(tau.fit, A.fit, k.fit, p=0.1, p=0.1)
            } else if(Mod.Sel1 == 2){
              c(tau.fit, alpha.fit, A.fit, k.fit, p=0.1, p=0.1)
              },
          weights = G_321$nls_weights))
 )
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "321",]$tau.variance <- vcov(get(paste("nls_321.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "321",]$alpha.variance <- vcov(get(paste("nls_321.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "321",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "321",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "321",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "321",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_321 <-data.frame(
  ...
  data.mean = tapply(G_321$G_MassBal_MgHaYr, cut(G_321$B_plt_t1_MgHa, cutvec_321), 
                     mean), 
  data.CI.high =  tapply(G_321$G_MassBal_MgHaYr, cut(G_321$B_plt_t1_MgHa, cutvec_321), 
                    high.CI), 
  data.CI.low = tapply(G_321$G_MassBal_MgHaYr, cut(G_321$B_plt_t1_MgHa, cutvec_321),
                    low.CI), 
...
## PLOTTING 2
gg.321.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_321, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_322$G_MassBal_MgHaYr, cut(G_322$B_plt_t1_MgHa, cutvec_322), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_322.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "322",]$tau.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "322",]$alpha.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "322",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "322",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "322",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "322",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_322 <-data.frame(
  ...
  data.mean = tapply(G_322$G_MassBal_MgHaYr, cut(G_322$B_plt_t1_MgHa, cutvec_322), 
                     mean), 
  data.CI.high =  tapply(G_322$G_MassBal_MgHaYr, cut(G_322$B_plt_t1_MgHa, cutvec_322), 
                    high.CI), 
  data.CI.low = tapply(G_322$G_MassBal_MgHaYr, cut(G_322$B_plt_t1_MgHa, cutvec_322),
                    low.CI), 
...
## PLOTTING 2
gg.322.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_322, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_331$G_MassBal_MgHaYr, cut(G_331$B_plt_t1_MgHa, cutvec_331), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_331.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "331",]$tau.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "331",]$alpha.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "331",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "331",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "331",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "331",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_331 <-data.frame(
  ...
  data.mean = tapply(G_331$G_MassBal_MgHaYr, cut(G_331$B_plt_t1_MgHa, cutvec_331), 
                     mean), 
  data.CI.high =  tapply(G_331$G_MassBal_MgHaYr, cut(G_331$B_plt_t1_MgHa, cutvec_331), 
                    high.CI), 
  data.CI.low = tapply(G_331$G_MassBal_MgHaYr, cut(G_331$B_plt_t1_MgHa, cutvec_331),
                    low.CI), 
...
## PLOTTING 2
gg.331.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_331, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_332$G_MassBal_MgHaYr, cut(G_332$B_plt_t1_MgHa, cutvec_332), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_332.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "332",]$tau.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "332",]$alpha.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "332",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "332",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "332",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "332",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_332 <-data.frame(
  ...
  data.mean = tapply(G_332$G_MassBal_MgHaYr, cut(G_332$B_plt_t1_MgHa, cutvec_332), 
                     mean), 
  data.CI.high =  tapply(G_332$G_MassBal_MgHaYr, cut(G_332$B_plt_t1_MgHa, cutvec_332), 
                    high.CI), 
  data.CI.low = tapply(G_332$G_MassBal_MgHaYr, cut(G_332$B_plt_t1_MgHa, cutvec_332),
                    low.CI), 
...
## PLOTTING 2
gg.332.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_332, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_341$G_MassBal_MgHaYr, cut(G_341$B_plt_t1_MgHa, cutvec_341), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_341.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "341",]$tau.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "341",]$alpha.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "341",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "341",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "341",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "341",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_341 <-data.frame(
  ...
  data.mean = tapply(G_341$G_MassBal_MgHaYr, cut(G_341$B_plt_t1_MgHa, cutvec_341), 
                     mean), 
  data.CI.high =  tapply(G_341$G_MassBal_MgHaYr, cut(G_341$B_plt_t1_MgHa, cutvec_341), 
                    high.CI), 
  data.CI.low = tapply(G_341$G_MassBal_MgHaYr, cut(G_341$B_plt_t1_MgHa, cutvec_341),
                    low.CI), 
...
## PLOTTING 2
gg.341.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_341, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_342$G_MassBal_MgHaYr, cut(G_342$B_plt_t1_MgHa, cutvec_342), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_342.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "342",]$tau.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "342",]$alpha.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "342",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "342",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "342",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "342",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_342 <-data.frame(
  ...
  data.mean = tapply(G_342$G_MassBal_MgHaYr, cut(G_342$B_plt_t1_MgHa, cutvec_342), 
                     mean), 
  data.CI.high =  tapply(G_342$G_MassBal_MgHaYr, cut(G_342$B_plt_t1_MgHa, cutvec_342), 
                    high.CI), 
  data.CI.low = tapply(G_342$G_MassBal_MgHaYr, cut(G_342$B_plt_t1_MgHa, cutvec_342),
                    low.CI), 
...
## PLOTTING 2
gg.342.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_342, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_411$G_MassBal_MgHaYr, cut(G_411$B_plt_t1_MgHa, cutvec_411), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_411.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "411",]$tau.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "411",]$alpha.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "411",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "411",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "411",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "411",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_411 <-data.frame(
  ...
  data.mean = tapply(G_411$G_MassBal_MgHaYr, cut(G_411$B_plt_t1_MgHa, cutvec_411), 
                     mean), 
  data.CI.high =  tapply(G_411$G_MassBal_MgHaYr, cut(G_411$B_plt_t1_MgHa, cutvec_411), 
                    high.CI), 
  data.CI.low = tapply(G_411$G_MassBal_MgHaYr, cut(G_411$B_plt_t1_MgHa, cutvec_411),
                    low.CI), 
...
## PLOTTING 2
gg.411.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_411, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M211$G_MassBal_MgHaYr, cut(G_M211$B_plt_t1_MgHa, cutvec_M211), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M211.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M211",]$tau.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M211",]$alpha.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M211",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M211",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M211",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M211",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M211 <-data.frame(
  ...
  data.mean = tapply(G_M211$G_MassBal_MgHaYr, cut(G_M211$B_plt_t1_MgHa, cutvec_M211), 
                     mean), 
  data.CI.high =  tapply(G_M211$G_MassBal_MgHaYr, cut(G_M211$B_plt_t1_MgHa, cutvec_M211), 
                    high.CI), 
  data.CI.low = tapply(G_M211$G_MassBal_MgHaYr, cut(G_M211$B_plt_t1_MgHa, cutvec_M211),
                    low.CI), 
...
## PLOTTING 2
gg.M211.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M211, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M221$G_MassBal_MgHaYr, cut(G_M221$B_plt_t1_MgHa, cutvec_M221), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M221.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M221",]$tau.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M221",]$alpha.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M221",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M221",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M221",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M221",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M221 <-data.frame(
  ...
  data.mean = tapply(G_M221$G_MassBal_MgHaYr, cut(G_M221$B_plt_t1_MgHa, cutvec_M221), 
                     mean), 
  data.CI.high =  tapply(G_M221$G_MassBal_MgHaYr, cut(G_M221$B_plt_t1_MgHa, cutvec_M221), 
                    high.CI), 
  data.CI.low = tapply(G_M221$G_MassBal_MgHaYr, cut(G_M221$B_plt_t1_MgHa, cutvec_M221),
                    low.CI), 
...
## PLOTTING 2
gg.M221.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M221, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M223$G_MassBal_MgHaYr, cut(G_M223$B_plt_t1_MgHa, cutvec_M223), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M223.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M223",]$tau.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M223",]$alpha.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M223",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M223",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M223",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M223",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M223 <-data.frame(
  ...
  data.mean = tapply(G_M223$G_MassBal_MgHaYr, cut(G_M223$B_plt_t1_MgHa, cutvec_M223), 
                     mean), 
  data.CI.high =  tapply(G_M223$G_MassBal_MgHaYr, cut(G_M223$B_plt_t1_MgHa, cutvec_M223), 
                    high.CI), 
  data.CI.low = tapply(G_M223$G_MassBal_MgHaYr, cut(G_M223$B_plt_t1_MgHa, cutvec_M223),
                    low.CI), 
...
## PLOTTING 2
gg.M223.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M223, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M231$G_MassBal_MgHaYr, cut(G_M231$B_plt_t1_MgHa, cutvec_M231), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M231.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M231",]$tau.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M231",]$alpha.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M231",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M231",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M231",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M231",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M231 <-data.frame(
  ...
  data.mean = tapply(G_M231$G_MassBal_MgHaYr, cut(G_M231$B_plt_t1_MgHa, cutvec_M231), 
                     mean), 
  data.CI.high =  tapply(G_M231$G_MassBal_MgHaYr, cut(G_M231$B_plt_t1_MgHa, cutvec_M231), 
                    high.CI), 
  data.CI.low = tapply(G_M231$G_MassBal_MgHaYr, cut(G_M231$B_plt_t1_MgHa, cutvec_M231),
                    low.CI), 
...
## PLOTTING 2
gg.M231.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M231, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M242$G_MassBal_MgHaYr, cut(G_M242$B_plt_t1_MgHa, cutvec_M242), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M242.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M242",]$tau.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M242",]$alpha.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M242",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M242",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M242",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M242",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M242 <-data.frame(
  ...
  data.mean = tapply(G_M242$G_MassBal_MgHaYr, cut(G_M242$B_plt_t1_MgHa, cutvec_M242), 
                     mean), 
  data.CI.high =  tapply(G_M242$G_MassBal_MgHaYr, cut(G_M242$B_plt_t1_MgHa, cutvec_M242), 
                    high.CI), 
  data.CI.low = tapply(G_M242$G_MassBal_MgHaYr, cut(G_M242$B_plt_t1_MgHa, cutvec_M242),
                    low.CI), 
...
## PLOTTING 2
gg.M242.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M242, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M261$G_MassBal_MgHaYr, cut(G_M261$B_plt_t1_MgHa, cutvec_M261), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M261.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M261",]$tau.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M261",]$alpha.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M261",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M261",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M261",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M261",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M261 <-data.frame(
  ...
  data.mean = tapply(G_M261$G_MassBal_MgHaYr, cut(G_M261$B_plt_t1_MgHa, cutvec_M261), 
                     mean), 
  data.CI.high =  tapply(G_M261$G_MassBal_MgHaYr, cut(G_M261$B_plt_t1_MgHa, cutvec_M261), 
                    high.CI), 
  data.CI.low = tapply(G_M261$G_MassBal_MgHaYr, cut(G_M261$B_plt_t1_MgHa, cutvec_M261),
                    low.CI), 
...
## PLOTTING 2
gg.M261.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M261, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M262$G_MassBal_MgHaYr, cut(G_M262$B_plt_t1_MgHa, cutvec_M262), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M262.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M262",]$tau.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M262",]$alpha.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M262",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M262",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M262",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M262",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M262 <-data.frame(
  ...
  bin.mid = bin_mids_M262,
  data.mean = tapply(G_M262$G_MassBal_MgHaYr, cut(G_M262$B_plt_t1_MgHa, cutvec_M262), 
                     mean), 
  data.CI.high =  tapply(G_M262$G_MassBal_MgHaYr, cut(G_M262$B_plt_t1_MgHa, cutvec_M262), 
                    high.CI), 
  data.CI.low = tapply(G_M262$G_MassBal_MgHaYr, cut(G_M262$B_plt_t1_MgHa, cutvec_M262),
                    low.CI), 
...
## PLOTTING 2
gg.M262.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M262, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M313$G_MassBal_MgHaYr, cut(G_M313$B_plt_t1_MgHa, cutvec_M313), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M313.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M313",]$tau.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M313",]$alpha.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M313",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M313",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M313",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M313",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M313 <-data.frame(
  ...
  data.mean = tapply(G_M313$G_MassBal_MgHaYr, cut(G_M313$B_plt_t1_MgHa, cutvec_M313), 
                     mean), 
  data.CI.high =  tapply(G_M313$G_MassBal_MgHaYr, cut(G_M313$B_plt_t1_MgHa, cutvec_M313), 
                    high.CI), 
  data.CI.low = tapply(G_M313$G_MassBal_MgHaYr, cut(G_M313$B_plt_t1_MgHa, cutvec_M313),
                    low.CI), 
...
## PLOTTING 2
gg.M313.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M313, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M331$G_MassBal_MgHaYr, cut(G_M331$B_plt_t1_MgHa, cutvec_M331), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M331.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M331",]$tau.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M331",]$alpha.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M331",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M331",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M331",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M331",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M331 <-data.frame(
  ...
  data.mean = tapply(G_M331$G_MassBal_MgHaYr, cut(G_M331$B_plt_t1_MgHa, cutvec_M331), 
                     mean), 
  data.CI.high =  tapply(G_M331$G_MassBal_MgHaYr, cut(G_M331$B_plt_t1_MgHa, cutvec_M331), 
                    high.CI), 
  data.CI.low = tapply(G_M331$G_MassBal_MgHaYr, cut(G_M331$B_plt_t1_MgHa, cutvec_M331),
                    low.CI), 
...
## PLOTTING 2
gg.M331.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M331, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M332$G_MassBal_MgHaYr, cut(G_M332$B_plt_t1_MgHa, cutvec_M332), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M332.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M332",]$tau.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M332",]$alpha.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M332",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M332",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M332",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M332",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M332 <-data.frame(
  ...
  data.mean = tapply(G_M332$G_MassBal_MgHaYr, cut(G_M332$B_plt_t1_MgHa, cutvec_M332), 
                     mean), 
  data.CI.high =  tapply(G_M332$G_MassBal_MgHaYr, cut(G_M332$B_plt_t1_MgHa, cutvec_M332), 
                    high.CI), 
  data.CI.low = tapply(G_M332$G_MassBal_MgHaYr, cut(G_M332$B_plt_t1_MgHa, cutvec_M332),
                    low.CI), 
...
## PLOTTING 2
gg.M332.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M332, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M333$G_MassBal_MgHaYr, cut(G_M333$B_plt_t1_MgHa, cutvec_M333), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M333.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M333",]$tau.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M333",]$alpha.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M333",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M333",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M333",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M333",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M333 <-data.frame(
  ...
  data.mean = tapply(G_M333$G_MassBal_MgHaYr, cut(G_M333$B_plt_t1_MgHa, cutvec_M333), 
                     mean), 
  data.CI.high =  tapply(G_M333$G_MassBal_MgHaYr, cut(G_M333$B_plt_t1_MgHa, cutvec_M333), 
                    high.CI), 
  data.CI.low = tapply(G_M333$G_MassBal_MgHaYr, cut(G_M333$B_plt_t1_MgHa, cutvec_M333),
                    low.CI), 
...
## PLOTTING 2
gg.M333.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M333, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M334$G_MassBal_MgHaYr, cut(G_M334$B_plt_t1_MgHa, cutvec_M334), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M334.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M334",]$tau.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M334",]$alpha.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M334",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M334",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M334",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M334",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M334 <-data.frame(
  ...
  data.mean = tapply(G_M334$G_MassBal_MgHaYr, cut(G_M334$B_plt_t1_MgHa, cutvec_M334), 
                     mean), 
  data.CI.high =  tapply(G_M334$G_MassBal_MgHaYr, cut(G_M334$B_plt_t1_MgHa, cutvec_M334), 
                    high.CI), 
  data.CI.low = tapply(G_M334$G_MassBal_MgHaYr, cut(G_M334$B_plt_t1_MgHa, cutvec_M334),
                    low.CI), 
...
## PLOTTING 2
gg.M334.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M334, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
## get bin means
G_bin_means <- tapply(G_M341$G_MassBal_MgHaYr, cut(G_M341$B_plt_t1_MgHa, cutvec_M341), mean)
...
if(Mod.Sel1 == 2) {alpha.fit <- round(coef(get(paste("nls_M341.",  Mod.Sel1, sep ="")))["alpha"], 1)}
...
## get variance in tau and alpha
nls.param.df2[nls.param.df2$Code == "M341",]$tau.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["tau","tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M341",]$alpha.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["alpha","alpha"]}

nls.param.df2[nls.param.df2$Code == "M341",]$tau <- coefs["tau"]
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M341",]$alpha <- coefs["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M341",]$alpha.2.5 <- intervals_low["alpha"]}
...
if(Mod.Sel1 == 2) {nls.param.df2[nls.param.df2$Code == "M341",]$alpha.97.5 <- intervals_high["alpha"]}
...
DM_compare_M341 <-data.frame(
  ...
  bin.mid = bin_mids_M341,
  data.mean = tapply(G_M341$G_MassBal_MgHaYr, cut(G_M341$B_plt_t1_MgHa, cutvec_M341), 
                     mean), 
  data.CI.high =  tapply(G_M341$G_MassBal_MgHaYr, cut(G_M341$B_plt_t1_MgHa, cutvec_M341), 
                    high.CI), 
  data.CI.low = tapply(G_M341$G_MassBal_MgHaYr, cut(G_M341$B_plt_t1_MgHa, cutvec_M341),
                    low.CI), 
...
## PLOTTING 2
gg.M341.2 <- ggplot() +
             geom_jitter(aes(x = B_plt_t1_MgHa, y = G_MassBal_MgHaYr), data = G_M341, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
...
vcov_list_3 <- list(
  ...
  ####  313
  `313` = vcov(get(paste("nls_313.", Best_mods.G[Best_mods.G$Code == 313,]$Sel.Mod, sep =""))),
  # ####  331
  # `331` = vcov(get(paste("nls_331.", Best_mods.G[Best_mods.G$Code == 331,]$Sel.Mod, sep =""))),
  ####  332
  `332` = vcov(get(paste("nls_332.", Best_mods.G[Best_mods.G$Code == 332,]$Sel.Mod, sep =""))),
  ####  342
  `342` = vcov(get(paste("nls_342.", Best_mods.G[Best_mods.G$Code == 342,]$Sel.Mod, sep =""))),
  ####  M211
...
```{r}
tiff("parameterCOR_matrices_Growth_Biomass.tiff", width = 20, height = 92.31, units= "cm", res =300, compression = "lzw")
par(mfrow = c(12,2), mar=c(5,5,1,1))
plot.COR(vcov_list_3[["211"]], "211") ; plot.COR(vcov_list_3[["212"]], "212")
plot.COR(vcov_list_3[["221"]], "221") ; plot.COR(vcov_list_3[["222"]], "222")
plot.COR(vcov_list_3[["223"]], "223") ; plot.COR(vcov_list_3[["231"]], "231")
plot.COR(vcov_list_3[["232"]], "232") ; plot.COR(vcov_list_3[["234"]], "234")
plot.COR(vcov_list_3[["251"]], "251") ; plot.COR(vcov_list_3[["255"]], "255")
plot.COR(vcov_list_3[["313"]], "313") #; plot.COR(vcov_list_3[["331"]], "331")
plot.COR(vcov_list_3[["332"]], "332") ; plot.COR(vcov_list_3[["342"]], "342")

plot.COR(vcov_list_3[["M211"]], "M211") ; plot.COR(vcov_list_3[["M221"]], "M221")
plot.COR(vcov_list_3[["M223"]], "M223") ; plot.COR(vcov_list_3[["M231"]], "M231")
plot.COR(vcov_list_3[["M242"]], "M242") ; plot.COR(vcov_list_3[["M261"]], "M261")
plot.COR(vcov_list_3[["M313"]], "M313") ; plot.COR(vcov_list_3[["M331"]], "M331")
plot.COR(vcov_list_3[["M332"]], "M332") ; plot.COR(vcov_list_3[["M333"]], "M333")
plot.COR(vcov_list_3[["M334"]], "M334")
dev.off()
```
...
gg.tau_ECOSUBCD <- ggplot(aes(x=Ecoregion, y=tau, shape = region), 
                 ...
                 theme(legend.position = "top", 
                       axis.text.x = element_text(size = 5, angle = 45, hjust = 1, vjust = 1)) + ylim(c(-5,9))

# tiff(file = "TAU_nls3_BiomassG_plotB_ReconciledG.tiff.tiff", width = 15, height = 12,  units = "cm", res = 600, compression = "lzw")
gg.tau_ECOSUBCD
# dev.off()
```
...
```{r}
nls.param.df2 <- nls.param.df2[order(nls.param.df2$k),]
