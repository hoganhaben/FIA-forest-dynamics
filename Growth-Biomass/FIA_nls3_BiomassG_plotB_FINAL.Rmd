...
### model 1
fg_1 <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))
## model 2
fg_2 <-  formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))
## model 3
fg_3 <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) *A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))


## model 1 variants
fg_1a <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (p*A+((1-p)*A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))))
fg_1b <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s)))
fg_1c <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (p*A+((1-p)*A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s))))


## model 2 variants
fg_2a <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (p*A+((1-p)*A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))))
fg_2b <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s)))
fg_2c <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (p*A+((1-p)*A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s))))


## model 3 variants
fg_3a <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * (p*A+((1-p)*A*B_plt_t1_MgHa/(k+B_plt_t1_MgHa))))
fg_3b <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * (A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s)))
fg_3c <- formula(G_MassBal_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * (p*A+((1-p)*A*B_plt_t1_MgHa^s/(k^s+B_plt_t1_MgHa^s))))
...
# load("C:/Users/hogie/Dropbox/FIA_R/Starter_FIA_data_processing/G_Nov2022.Rdata")
...
load("C:/Users/hogan.jaaron/Dropbox/FIA_R/data_PDSI/G_pdsi_data_NoIngrowth_JAN-AUG.Rdata")

# load("C:/Users/hogie/Dropbox/FIA_R/data_PDSI/G_pdsi_data_NoIngrowth_JAN-AUG.Rdata")
...
nls.param.df2[nls.param.df2$Code == "211",]$ge.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "211",]$phi.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "211",]$alpha.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "212",]$ge.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "212",]$phi.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "212",]$alpha.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "221",]$ge.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "221",]$phi.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "221",]$alpha.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "222",]$ge.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "222",]$phi.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "222",]$alpha.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "223",]$ge.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "223",]$phi.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "223",]$alpha.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "231",]$ge.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "231",]$phi.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "231",]$alpha.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "232",]$ge.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "232",]$phi.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "232",]$alpha.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "234",]$ge.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "234",]$phi.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "242",]$ge.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "242",]$phi.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "242",]$alpha.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "251",]$ge.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "251",]$phi.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "251",]$alpha.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
try(
  nls_255.1 <- nls(fg_1, data = G_255, 
                   start = c(ge=ge.start, A=2, k=k.start), 
...
try(
  nls_255.2 <- nls(fg_2, data=G_255, 
                   start = c(ge=ge.start, phi=phi.start, A=2, k=k.start), 
                   weights = G_255$nls_weights), 
 )
...
try(
  nls_255.3 <- nls(fg_3 , data = G_255, 
                   start = c(ge=ge.start, phi=phi.start, alpha=alpha.start, A=2, k=k.start),
                   weights = G_255$nls_weights), 
 )
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "255",]$ge.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "255",]$phi.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["phi","phi"]
# nls.param.df2[nls.param.df2$Code == "255",]$alpha.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "261",]$ge.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "261",]$phi.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "261",]$alpha.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "262",]$ge.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "262",]$phi.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "262",]$alpha.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "263",]$ge.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "263",]$phi.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "263",]$alpha.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "313",]$ge.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "313",]$phi.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "313",]$alpha.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "315",]$ge.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "315",]$phi.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "315",]$alpha.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "321",]$ge.variance <- vcov(get(paste("nls_321.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "321",]$phi.variance <- vcov(get(paste("nls_321.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "321",]$alpha.variance <- vcov(get(paste("nls_321.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "322",]$ge.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "322",]$phi.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "322",]$alpha.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "331",]$ge.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "331",]$phi.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "331",]$alpha.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "332",]$ge.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "332",]$phi.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "332",]$alpha.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "341",]$ge.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "341",]$phi.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "341",]$alpha.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "342",]$ge.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "342",]$phi.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "342",]$alpha.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "411",]$ge.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "411",]$phi.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "411",]$alpha.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M211",]$ge.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M211",]$phi.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M211",]$alpha.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M221",]$ge.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M221",]$phi.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M221",]$alpha.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M223",]$ge.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M223",]$phi.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M223",]$alpha.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M231",]$ge.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M231",]$phi.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M231",]$alpha.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M242",]$ge.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M242",]$phi.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M242",]$alpha.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M261",]$ge.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M261",]$phi.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M261",]$alpha.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M262",]$ge.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M262",]$phi.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M262",]$alpha.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M313",]$ge.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M313",]$phi.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M313",]$alpha.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M331",]$ge.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M331",]$phi.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M331",]$alpha.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M332",]$ge.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M332",]$phi.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M332",]$alpha.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M333",]$ge.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M333",]$phi.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M333",]$alpha.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M334",]$ge.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M334",]$phi.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M334",]$alpha.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M341",]$ge.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M341",]$phi.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["phi","phi"]
nls.param.df2[nls.param.df2$Code == "M341",]$alpha.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["alpha","alpha"]
...
# tiff(file = "GE_nls3_BiomassG_plotB_ReconciledG.tiff.tiff", width = 15, height = 12,  units = "cm", res = 600, compression = "lzw")
gg.ge_ECOSUBCD
# dev.off()
```
