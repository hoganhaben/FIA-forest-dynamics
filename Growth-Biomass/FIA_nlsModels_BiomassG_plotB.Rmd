...
# load("C:/Users/hogie/Dropbox/FIA_R/Starter_FIA_data_processing/Growth.Rdata")
```
...
G_211$Plt_B_bin <-  cut(G_211$B_plt_t1_MgHa, cutvec_211, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_212$Plt_B_bin <-  cut(G_212$B_plt_t1_MgHa, cutvec_212, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_221$Plt_B_bin <-  cut(G_221$B_plt_t1_MgHa, cutvec_221, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_222$Plt_B_bin <-  cut(G_222$B_plt_t1_MgHa, cutvec_222, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_223$Plt_B_bin <-  cut(G_223$B_plt_t1_MgHa, cutvec_223, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_231$Plt_B_bin <-  cut(G_231$B_plt_t1_MgHa, cutvec_231, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_232$Plt_B_bin <-  cut(G_232$B_plt_t1_MgHa, cutvec_232, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_234$Plt_B_bin <-  cut(G_234$B_plt_t1_MgHa, cutvec_234, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_242$Plt_B_bin <-  cut(G_242$B_plt_t1_MgHa, cutvec_242, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_251$Plt_B_bin <-  cut(G_251$B_plt_t1_MgHa, cutvec_251, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_255$Plt_B_bin <-  cut(G_255$B_plt_t1_MgHa, cutvec_255, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_261$Plt_B_bin <-  cut(G_261$B_plt_t1_MgHa, cutvec_261, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_262$Plt_B_bin <-  cut(G_262$B_plt_t1_MgHa, cutvec_262, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_263$Plt_B_bin <-  cut(G_263$B_plt_t1_MgHa, cutvec_263, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_313$Plt_B_bin <-  cut(G_313$B_plt_t1_MgHa, cutvec_313, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_315$Plt_B_bin <-  cut(G_315$B_plt_t1_MgHa, cutvec_315, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_321$Plt_B_bin <-  cut(G_321$B_plt_t1_MgHa, cutvec_321, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_322$Plt_B_bin <-  cut(G_322$B_plt_t1_MgHa, cutvec_322, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_331$Plt_B_bin <-  cut(G_331$B_plt_t1_MgHa, cutvec_331, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_332$Plt_B_bin <- cut(G_332$B_plt_t1_MgHa, cutvec_332, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_341$Plt_B_bin <-  cut(G_341$B_plt_t1_MgHa, cutvec_341, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_342$Plt_B_bin <-  cut(G_342$B_plt_t1_MgHa, cutvec_342, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_411$Plt_B_bin <-  cut(G_411$B_plt_t1_MgHa, cutvec_411, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M211$Plt_B_bin <-  cut(G_M211$B_plt_t1_MgHa, cutvec_M211, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M221$Plt_B_bin <-  cut(G_M221$B_plt_t1_MgHa, cutvec_M221, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M223$Plt_B_bin <-  cut(G_M223$B_plt_t1_MgHa, cutvec_M223, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M231$Plt_B_bin <-  cut(G_M231$B_plt_t1_MgHa, cutvec_M231, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M242$Plt_B_bin <-  cut(G_M242$B_plt_t1_MgHa, cutvec_M242, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M261$Plt_B_bin <-  cut(G_M261$B_plt_t1_MgHa, cutvec_M261, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M262$Plt_B_bin <-  cut(G_M262$B_plt_t1_MgHa, cutvec_M262, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M313$Plt_B_bin <-  cut(G_M313$B_plt_t1_MgHa, cutvec_M313, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M331$Plt_B_bin <-  cut(G_M331$B_plt_t1_MgHa, cutvec_M331, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M332$Plt_B_bin <-  cut(G_M332$B_plt_t1_MgHa, cutvec_M332, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M333$Plt_B_bin <-  cut(G_M333$B_plt_t1_MgHa, cutvec_M333, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M334$Plt_B_bin <-  cut(G_M334$B_plt_t1_MgHa, cutvec_M334, include.lowest = T)
## get bin means
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_M341$Plt_B_bin <-  cut(G_M341$B_plt_t1_MgHa, cutvec_M341, include.lowest = T)
## get bin means
