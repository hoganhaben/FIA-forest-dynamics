...
load("C:/Users/hogan.jaaron/Dropbox/FIA_R/data_PDSI/G_pdsi_PlotBiomass_data.Rdata")  ## simply load ths finished data product -- the above code takes some time to run...
...
cutvec_211 <-  c(0,creditmodel::cut_equal(G_211$STDAGE_t2, g=20)[1:19], max(G_211$STDAGE_t2))
