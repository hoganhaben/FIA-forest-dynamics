---
title: "FIA - NLS Models: Biomass vs. Stand Age, G-Reconciled, Temporally-balanced, No harvest"
author: "JAH"
date: "`r Sys.Date()`"
output:
  html_document:
...
```{r include=FALSE}
knitr::opts_chunk$set(tidy.opts=list(width.cutoff=60), tidy=TRUE, echo = FALSE)
```
...
Model selection is used to determine the best fitting models, which is implemented in two parts. The first part selected the best model form using $\alpha$: the biomass compensation effect due to lost biomass (natural mortality or harvest) and $\phi$: the effect of changing climate (quantified as $\Delta PDSI$, or the difference in the Palmer drought severity index from June - August for the 10 years preceding the biomass measurement and the 1969-1989 period).  

__model 1:  simple model__
$B = (1 + (yr-1990)* ge/100) \times \left( \frac {A \cdot STDAGE_{t2}} {k+STDAGE_{t2}} \right)$

__model 2: phi model__
$B = (1 + (yr-1990)* ge/100) \times (1 + \phi \cdot \Delta PDSI)  \times \left( \frac {A \cdot STDAGE_{t2}} {k+STDAGE_{t2}} \right)$

__model 3: phi-alpha model__
$B = (1 + (yr-1990)* ge/100) \times (1 + \phi \cdot \Delta PDSI)  \times (1 - \alpha \cdot B_l) \times \left( \frac {A \cdot STDAGE_{t2}} {k+STDAGE_{t2}} \right)$
...
$pA + \left( \frac {(1-p) *A \cdot STDAGE_{t2}^s} {k^s + STDAGE_{t2}^s} \right)$
...
### model 1
f_1 <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * A*STDAGE_t2 / (k+STDAGE_t2))
## model 2
f_2 <-  formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * A*STDAGE_t2 / (k+STDAGE_t2))
## model 3
f_3 <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * A*STDAGE_t2 / (k+STDAGE_t2))

## model 1 variants
f_1a <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (p*A+((1-p)*A*STDAGE_t2/(k+STDAGE_t2))))
f_1b <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (A*STDAGE_t2^s/(k^s+STDAGE_t2^s)))
f_1c <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (p*A+((1-p)*A*STDAGE_t2^s/(k^s+STDAGE_t2^s))))


## model 2 variants
f_2a <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * (p*A+((1-p)*A*STDAGE_t2/(k+STDAGE_t2))))
f_2b <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * (A*STDAGE_t2^s/(k^s+STDAGE_t2^s)))
f_2c <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * (p*A+((1-p)*A*STDAGE_t2^s/(k^s+STDAGE_t2^s))))


## model 3 variants
f_3a <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * (p*A+((1-p)*A*STDAGE_t2/(k+STDAGE_t2))))
f_3b <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * (A*STDAGE_t2^s/(k^s+STDAGE_t2^s)))
f_3c <- formula(B_plt_t1_MgHa ~ (1 + (MEASTIME_t2-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * (p*A+((1-p)*A*STDAGE_t2^s/(k^s+STDAGE_t2^s))))
...
### cutvec and bin means
cutvec_211 <-  round(quantile(G_212$STDAGE_t2, seq(0,1, length.out = 21)))
bin_mids_211 <- round(cutvec_211[-length(cutvec_211)] + diff(cutvec_211)/2)

## first get the correct bin  - assign as column in data frame
G_211$STDAGE_t2_bin<-  cut(G_211$STDAGE_t2, cutvec_211)
## then get bin means
G_211_bin_means <- tapply(G_211$B_plt_t1_MgHa, cut(G_211$STDAGE_t2, cutvec_211), mean)
...
G_211_pred <- predict(get(paste("nls_211.",  Mod.Sel2, sep ="")),
...
## plot
gg.211 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_211, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_211, 
                            fun.data = function(x) {
...
DM_compare_211 <- data.frame(
  ...
  data.mean = tapply(G_211$B_plt_t1_MgHa, cut(G_211$STDAGE_t2, cutvec_211), 
                     mean), 
  data.CI.high =  tapply(G_211$B_plt_t1_MgHa, cut(G_211$STDAGE_t2, cutvec_211), 
                    high.CI), 
  data.CI.low = tapply(G_211$B_plt_t1_MgHa, cut(G_211$STDAGE_t2, cutvec_211),
                    low.CI), 
  pred.mean = G_211_pred_df[G_211_pred_df$STDAGE_t2 %in% bin_mids_211,]$fitted) 
  # pred.CI.high = tapply(`211_CI_df`$fitted, cut(`211_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_211$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`211_CI_df`$fitted, cut(`211_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_211$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_212_bin_means <- tapply(G_212$B_plt_t1_MgHa, cut(G_212$STDAGE_t2, cutvec_212), mean)
...
G_212_pred <- predict(get(paste("nls_212.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.212 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_212, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_212, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_212 <- data.frame(
  ...
  data.mean = tapply(G_212$B_plt_t1_MgHa, cut(G_212$STDAGE_t2, cutvec_212), 
                     mean), 
  data.CI.high =  tapply(G_212$B_plt_t1_MgHa, cut(G_212$STDAGE_t2, cutvec_212), 
                    high.CI), 
  data.CI.low = tapply(G_212$B_plt_t1_MgHa, cut(G_212$STDAGE_t2, cutvec_212),
                    low.CI), 
  pred.mean = G_212_pred_df[G_212_pred_df$STDAGE_t2 %in% bin_mids_212,]$fitted) 
  # pred.CI.high = tapply(`212_CI_df`$fitted, cut(`212_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_212$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`212_CI_df`$fitted, cut(`212_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_212$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_221_bin_means <- tapply(G_221$B_plt_t1_MgHa, cut(G_221$STDAGE_t2, cutvec_221), mean)
...
G_221_pred <- predict(get(paste("nls_221.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.221 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_221, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_221, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_221 <- data.frame(
  ...
  data.mean = tapply(G_221$B_plt_t1_MgHa, cut(G_221$STDAGE_t2, cutvec_221), 
                     mean), 
  data.CI.high =  tapply(G_221$B_plt_t1_MgHa, cut(G_221$STDAGE_t2, cutvec_221), 
                    high.CI), 
  data.CI.low = tapply(G_221$B_plt_t1_MgHa, cut(G_221$STDAGE_t2, cutvec_221),
                    low.CI), 
  pred.mean = G_221_pred_df[G_221_pred_df$STDAGE_t2 %in% bin_mids_221,]$fitted) 
  # pred.CI.high = tapply(`221_CI_df`$fitted, cut(`221_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_221$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`221_CI_df`$fitted, cut(`221_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_221$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_222_bin_means <- tapply(G_222$B_plt_t1_MgHa, cut(G_222$STDAGE_t2,  cutvec_222), mean)
...
G_222_pred <- predict(get(paste("nls_222.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.222 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_222, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_222, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_222 <- data.frame(
  ...
  data.mean = tapply(G_222$B_plt_t1_MgHa, cut(G_222$STDAGE_t2, cutvec_222), 
                     mean), 
  data.CI.high =  tapply(G_222$B_plt_t1_MgHa, cut(G_222$STDAGE_t2, cutvec_222), 
                    high.CI), 
  data.CI.low = tapply(G_222$B_plt_t1_MgHa, cut(G_222$STDAGE_t2, cutvec_222),
                    low.CI), 
  pred.mean = G_222_pred_df[G_222_pred_df$STDAGE_t2 %in% bin_mids_222,]$fitted) 
  # pred.CI.high = tapply(`222_CI_df`$fitted, cut(`222_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_222$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`222_CI_df`$fitted, cut(`222_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_222$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_223_bin_means <- tapply(G_223$B_plt_t1_MgHa, cut(G_223$STDAGE_t2,  cutvec_223), mean)
...
G_223_pred <- predict(get(paste("nls_223.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.223 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_223, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_223, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_223 <- data.frame(
  ...
  data.mean = tapply(G_223$B_plt_t1_MgHa, cut(G_223$STDAGE_t2, cutvec_223), 
                     mean), 
  data.CI.high =  tapply(G_223$B_plt_t1_MgHa, cut(G_223$STDAGE_t2, cutvec_223), 
                    high.CI), 
  data.CI.low = tapply(G_223$B_plt_t1_MgHa, cut(G_223$STDAGE_t2, cutvec_223),
                    low.CI), 
  pred.mean = G_223_pred_df[G_223_pred_df$STDAGE_t2 %in% bin_mids_223,]$fitted) 
  # pred.CI.high = tapply(`223_CI_df`$fitted, cut(`223_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_223$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`223_CI_df`$fitted, cut(`223_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_223$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_231_bin_means <- tapply(G_231$B_plt_t1_MgHa, cut(G_231$STDAGE_t2,  cutvec_231), mean)
...
G_231_pred <- predict(get(paste("nls_231.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.231 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_231, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_231, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_231 <- data.frame(
  ...
  data.mean = tapply(G_231$B_plt_t1_MgHa, cut(G_231$STDAGE_t2, cutvec_231), 
                     mean), 
  data.CI.high =  tapply(G_231$B_plt_t1_MgHa, cut(G_231$STDAGE_t2, cutvec_231), 
                    high.CI), 
  data.CI.low = tapply(G_231$B_plt_t1_MgHa, cut(G_231$STDAGE_t2, cutvec_231),
                    low.CI), 
  pred.mean = G_231_pred_df[G_231_pred_df$STDAGE_t2 %in% bin_mids_231,]$fitted) 
  # pred.CI.high = tapply(`231_CI_df`$fitted, cut(`231_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_231$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`231_CI_df`$fitted, cut(`231_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_231$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_232_bin_means <- tapply(G_232$B_plt_t1_MgHa, cut(G_232$STDAGE_t2, cutvec_232), mean)
...
G_232_pred <- predict(get(paste("nls_232.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.232 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_232, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_232, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_232 <- data.frame(
  ...
  data.mean = tapply(G_232$B_plt_t1_MgHa, cut(G_232$STDAGE_t2, cutvec_232), 
                     mean), 
  data.CI.high =  tapply(G_232$B_plt_t1_MgHa, cut(G_232$STDAGE_t2, cutvec_232), 
                    high.CI), 
  data.CI.low = tapply(G_232$B_plt_t1_MgHa, cut(G_232$STDAGE_t2, cutvec_232),
                    low.CI), 
  pred.mean = G_232_pred_df[G_232_pred_df$STDAGE_t2 %in% bin_mids_232,]$fitted) 
  # pred.CI.high = tapply(`232_CI_df`$fitted, cut(`232_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_232$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`232_CI_df`$fitted, cut(`232_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_232$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_234_bin_means <- tapply(G_234$B_plt_t1_MgHa, cut(G_234$STDAGE_t2, cutvec_234), mean)
...
G_234_pred <- predict(get(paste("nls_234.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.234 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_234, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_234, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_234 <- data.frame(
  ...
  data.mean = tapply(G_234$B_plt_t1_MgHa, cut(G_234$STDAGE_t2, cutvec_234), 
                     mean), 
  data.CI.high =  tapply(G_234$B_plt_t1_MgHa, cut(G_234$STDAGE_t2, cutvec_234), 
                    high.CI), 
  data.CI.low = tapply(G_234$B_plt_t1_MgHa, cut(G_234$STDAGE_t2, cutvec_234),
                    low.CI), 
  pred.mean = G_234_pred_df[G_234_pred_df$STDAGE_t2 %in% bin_mids_234,]$fitted) 
  # pred.CI.high = tapply(`234_CI_df`$fitted, cut(`234_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_234$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`234_CI_df`$fitted, cut(`234_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_234$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_242_bin_means <- tapply(G_242$B_plt_t1_MgHa, cut(G_242$STDAGE_t2,  cutvec_242), mean)
...
## predict model fit
G_242_pred <- predict(get(paste("nls_242.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.242 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_242, alpha = 0.5, shape ="+", col = "#60606080") +

          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_242,
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res},
...
DM_compare_242 <- data.frame(
  ...
  data.mean = tapply(G_242$B_plt_t1_MgHa, cut(G_242$STDAGE_t2, cutvec_242),
                     mean),
  data.CI.high =  tapply(G_242$B_plt_t1_MgHa, cut(G_242$STDAGE_t2, cutvec_242),
                    high.CI),
  data.CI.low = tapply(G_242$B_plt_t1_MgHa, cut(G_242$STDAGE_t2, cutvec_242),
                    low.CI),
  pred.mean = G_242_pred_df[G_242_pred_df$STDAGE_t2 %in% bin_mids_242,]$fitted)
  # pred.CI.high = tapply(`242_CI_df`$fitted, cut(`242_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_242$STDAGE_t2, g=20))),
  #                      high.CI),
  # pred.CI.low = tapply(`242_CI_df`$fitted, cut(`242_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_242$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_251_bin_means <- tapply(G_251$B_plt_t1_MgHa, cut(G_251$STDAGE_t2,  cutvec_251), mean)
...
G_251_pred <- predict(get(paste("nls_251.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.251 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_251, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_251, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_251 <- data.frame(
  ...
  data.mean = tapply(G_251$B_plt_t1_MgHa, cut(G_251$STDAGE_t2, cutvec_251), 
                     mean), 
  data.CI.high =  tapply(G_251$B_plt_t1_MgHa, cut(G_251$STDAGE_t2, cutvec_251), 
                    high.CI), 
  data.CI.low = tapply(G_251$B_plt_t1_MgHa, cut(G_251$STDAGE_t2, cutvec_251),
                    low.CI), 
  pred.mean = G_251_pred_df[G_251_pred_df$STDAGE_t2 %in% bin_mids_251,]$fitted) 
  # pred.CI.high = tapply(`251_CI_df`$fitted, cut(`251_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_251$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`251_CI_df`$fitted, cut(`251_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_251$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_255_bin_means <- tapply(G_255$B_plt_t1_MgHa, cut(G_255$STDAGE_t2,  cutvec_255), mean)
...
G_255_pred <- predict(get(paste("nls_255.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.255 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_255, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_255, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_255 <- data.frame(
  ...
  data.mean = tapply(G_255$B_plt_t1_MgHa, cut(G_255$STDAGE_t2, cutvec_255), 
                     mean), 
  data.CI.high =  tapply(G_255$B_plt_t1_MgHa, cut(G_255$STDAGE_t2, cutvec_255), 
                    high.CI), 
  data.CI.low = tapply(G_255$B_plt_t1_MgHa, cut(G_255$STDAGE_t2, cutvec_255),
                    low.CI), 
  pred.mean = G_255_pred_df[G_255_pred_df$STDAGE_t2 %in% bin_mids_255,]$fitted) 
  # pred.CI.high = tapply(`255_CI_df`$fitted, cut(`255_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_255$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`255_CI_df`$fitted, cut(`255_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_255$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_261_bin_means <- tapply(G_261$B_plt_t1_MgHa, cut(G_261$STDAGE_t2,  cutvec_261), mean)
...
G_261_pred <- predict(get(paste("nls_261.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.261 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_261, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_261, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
                            col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=9)), breaks = cutvec_261) +  
...
DM_compare_261 <- data.frame(
  ...
  data.mean = tapply(G_261$B_plt_t1_MgHa, cut(G_261$STDAGE_t2, cutvec_261), 
                     mean), 
  data.CI.high =  tapply(G_261$B_plt_t1_MgHa, cut(G_261$STDAGE_t2, cutvec_261), 
                    high.CI), 
  data.CI.low = tapply(G_261$B_plt_t1_MgHa, cut(G_261$STDAGE_t2, cutvec_261),
                    low.CI), 
  pred.mean = G_261_pred_df[G_261_pred_df$STDAGE_t2 %in% bin_mids_261,]$fitted) 
  # pred.CI.high = tapply(`261_CI_df`$fitted, cut(`261_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_261$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`261_CI_df`$fitted, cut(`261_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_261$STDAGE_t2, g=20))),
  #                      low.CI))
...
gg.261.B2 <- ggplot(aes(x = data.mean, y = pred.mean, color = bin), data = DM_compare_261) +
           ...
           geom_pointrange(aes(xmin = data.CI.low, xmax = data.CI.high)) +
           #geom_pointrange(aes(ymin = pred.CI.low, ymax = pred.CI.high)) +
           scale_color_manual(values = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=10)), 
...
## then get bin means
G_262_bin_means <- tapply(G_262$B_plt_t1_MgHa, cut(G_262$STDAGE_t2,  cutvec_262), mean)
...
G_262_pred <- predict(get(paste("nls_262.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.262 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_262, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_262, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_262 <- data.frame(
  ...
  data.mean = tapply(G_262$B_plt_t1_MgHa, cut(G_262$STDAGE_t2, cutvec_262), 
                     mean), 
  data.CI.high =  tapply(G_262$B_plt_t1_MgHa, cut(G_262$STDAGE_t2, cutvec_262), 
                    high.CI), 
  data.CI.low = tapply(G_262$B_plt_t1_MgHa, cut(G_262$STDAGE_t2, cutvec_262),
                    low.CI), 
  pred.mean = G_262_pred_df[G_262_pred_df$STDAGE_t2 %in% bin_mids_262,]$fitted) 
  # pred.CI.high = tapply(`262_CI_df`$fitted, cut(`262_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_262$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`262_CI_df`$fitted, cut(`262_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_262$STDAGE_t2, g=20))),
  #                      low.CI))
...
gg.262.B2 <- ggplot(aes(x = data.mean, y = pred.mean, color = bin), data = DM_compare_262) +
           ...
           geom_pointrange(aes(xmin = data.CI.low, xmax = data.CI.high)) +
           #geom_pointrange(aes(ymin = pred.CI.low, ymax = pred.CI.high)) +
           scale_color_manual(values = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=14)), 
...
## then get bin means
G_263_bin_means <- tapply(G_263$B_plt_t1_MgHa, cut(G_263$STDAGE_t2,  cutvec_263), mean)
...
G_263_pred <- predict(get(paste("nls_263.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.263 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_263, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_263, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
                            col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=19)), breaks = cutvec_263) +  
...
DM_compare_263 <- data.frame(
  ...
  data.mean = tapply(G_263$B_plt_t1_MgHa, cut(G_263$STDAGE_t2, cutvec_263), 
                     mean), 
  data.CI.high =  tapply(G_263$B_plt_t1_MgHa, cut(G_263$STDAGE_t2, cutvec_263), 
                    high.CI), 
  data.CI.low = tapply(G_263$B_plt_t1_MgHa, cut(G_263$STDAGE_t2, cutvec_263),
                    low.CI), 
  pred.mean = G_263_pred_df[G_263_pred_df$STDAGE_t2 %in% bin_mids_263,]$fitted) 
  # pred.CI.high = tapply(`263_CI_df`$fitted, cut(`263_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_263$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`263_CI_df`$fitted, cut(`263_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_263$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_313_bin_means <- tapply(G_313$B_plt_t1_MgHa, cut(G_313$STDAGE_t2,  cutvec_313), mean)
...
## predict model fit 
G_313_pred <- predict(get(paste("nls_313.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.313 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_313, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_313, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_313 <- data.frame(
  ...
  data.mean = tapply(G_313$B_plt_t1_MgHa, cut(G_313$STDAGE_t2, cutvec_313), 
                     mean), 
  data.CI.high =  tapply(G_313$B_plt_t1_MgHa, cut(G_313$STDAGE_t2, cutvec_313), 
                    high.CI), 
  data.CI.low = tapply(G_313$B_plt_t1_MgHa, cut(G_313$STDAGE_t2, cutvec_313),
                    low.CI), 
  pred.mean = G_313_pred_df[G_313_pred_df$STDAGE_t2 %in% bin_mids_313,]$fitted) 
  # pred.CI.high = tapply(`313_CI_df`$fitted, cut(`313_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_313$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`313_CI_df`$fitted, cut(`313_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_313$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_315_bin_means <- tapply(G_315$B_plt_t1_MgHa, cut(G_315$STDAGE_t2, cutvec_315), mean)
...
G_315_pred <- predict(get(paste("nls_315.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.315 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_315, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_315, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_315 <- data.frame(
  ...
  data.mean = tapply(G_315$B_plt_t1_MgHa, cut(G_315$STDAGE_t2, cutvec_315), 
                     mean), 
  data.CI.high =  tapply(G_315$B_plt_t1_MgHa, cut(G_315$STDAGE_t2, cutvec_315), 
                    high.CI), 
  data.CI.low = tapply(G_315$B_plt_t1_MgHa, cut(G_315$STDAGE_t2, cutvec_315),
                    low.CI), 
  pred.mean = G_315_pred_df[G_315_pred_df$STDAGE_t2 %in% bin_mids_315,]$fitted) 
  # pred.CI.high = tapply(`315_CI_df`$fitted, cut(`315_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_315$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`315_CI_df`$fitted, cut(`315_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_315$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_321_bin_means <- tapply(G_321$B_plt_t1_MgHa, cut(G_321$STDAGE_t2, cutvec_321), mean)
...
G_321_pred <- predict(get(paste("nls_321.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.321 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_321, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_321, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_321 <- data.frame(
  ...
  data.mean = tapply(G_321$B_plt_t1_MgHa, cut(G_321$STDAGE_t2, cutvec_321), 
                     mean), 
  data.CI.high =  tapply(G_321$B_plt_t1_MgHa, cut(G_321$STDAGE_t2, cutvec_321), 
                    high.CI), 
  data.CI.low = tapply(G_321$B_plt_t1_MgHa, cut(G_321$STDAGE_t2, cutvec_321),
                    low.CI), 
  pred.mean = G_321_pred_df[G_321_pred_df$STDAGE_t2 %in% bin_mids_321,]$fitted) 
  # pred.CI.high = tapply(`321_CI_df`$fitted, cut(`321_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_321$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`321_CI_df`$fitted, cut(`321_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_321$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_322_bin_means <- tapply(G_322$B_plt_t1_MgHa, cut(G_322$STDAGE_t2, cutvec_322), mean)
...
G_322_pred <- predict(get(paste("nls_322.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.322 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_322, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_322, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_322 <- data.frame(
  ...
  data.mean = tapply(G_322$B_plt_t1_MgHa, cut(G_322$STDAGE_t2, cutvec_322), 
                     mean), 
  data.CI.high =  tapply(G_322$B_plt_t1_MgHa, cut(G_322$STDAGE_t2, cutvec_322), 
                    high.CI), 
  data.CI.low = tapply(G_322$B_plt_t1_MgHa, cut(G_322$STDAGE_t2, cutvec_322),
                    low.CI), 
  pred.mean = G_322_pred_df[G_322_pred_df$STDAGE_t2 %in% bin_mids_322,]$fitted) 
  # pred.CI.high = tapply(`322_CI_df`$fitted, cut(`322_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_322$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`322_CI_df`$fitted, cut(`322_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_322$STDAGE_t2, g=20))),
  #                      low.CI))
...
## adjust cutvec 8 so that it is not equal to value 7
cutvec_331[8] <-  83
...
## then get bin means
G_331_bin_means <- tapply(G_331$B_plt_t1_MgHa, cut(G_331$STDAGE_t2, cutvec_331), mean)
...
G_331_pred <- predict(get(paste("nls_331.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.331 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_331, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_331, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_331 <- data.frame(
  ...
  data.mean = tapply(G_331$B_plt_t1_MgHa, cut(G_331$STDAGE_t2, cutvec_331), 
                     mean), 
  data.CI.high =  tapply(G_331$B_plt_t1_MgHa, cut(G_331$STDAGE_t2, cutvec_331), 
                    high.CI), 
  data.CI.low = tapply(G_331$B_plt_t1_MgHa, cut(G_331$STDAGE_t2, cutvec_331),
                    low.CI), 
  pred.mean = G_331_pred_df[G_331_pred_df$STDAGE_t2 %in% bin_mids_331,]$fitted) 
  # pred.CI.high = tapply(`331_CI_df`$fitted, cut(`331_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_331$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`331_CI_df`$fitted, cut(`331_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_331$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_332_bin_means <- tapply(G_332$B_plt_t1_MgHa, cut(G_332$STDAGE_t2,  cutvec_332), mean)
...
G_332_pred <- predict(get(paste("nls_332.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.332 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_332, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_332, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_332 <- data.frame(
  ...
  data.mean = tapply(G_332$B_plt_t1_MgHa, cut(G_332$STDAGE_t2, cutvec_332), 
                     mean), 
  data.CI.high =  tapply(G_332$B_plt_t1_MgHa, cut(G_332$STDAGE_t2, cutvec_332), 
                    high.CI), 
  data.CI.low = tapply(G_332$B_plt_t1_MgHa, cut(G_332$STDAGE_t2, cutvec_332),
                    low.CI), 
  pred.mean = G_332_pred_df[G_332_pred_df$STDAGE_t2 %in% bin_mids_332,]$fitted) 
  # pred.CI.high = tapply(`332_CI_df`$fitted, cut(`332_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_332$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`332_CI_df`$fitted, cut(`332_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_332$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_341_bin_means <- tapply(G_341$B_plt_t1_MgHa, cut(G_341$STDAGE_t2,  cutvec_341), mean)
...
## predict model fit
G_341_pred <- predict(get(paste("nls_341.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.341 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_341, alpha = 0.5, shape ="+", col = "#60606080") +

          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_341,
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res},
...
DM_compare_341 <- data.frame(
  ...
  data.mean = tapply(G_341$B_plt_t1_MgHa, cut(G_341$STDAGE_t2, cutvec_341),
                     mean),
  data.CI.high =  tapply(G_341$B_plt_t1_MgHa, cut(G_341$STDAGE_t2, cutvec_341),
                    high.CI),
  data.CI.low = tapply(G_341$B_plt_t1_MgHa, cut(G_341$STDAGE_t2, cutvec_341),
                    low.CI),
  pred.mean = G_341_pred_df[G_341_pred_df$STDAGE_t2 %in% bin_mids_341,]$fitted)
  # pred.CI.high = tapply(`341_CI_df`$fitted, cut(`341_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_341$STDAGE_t2, g=20))),
  #                      high.CI),
  # pred.CI.low = tapply(`341_CI_df`$fitted, cut(`341_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_341$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_342_bin_means <- tapply(G_342$B_plt_t1_MgHa, cut(G_342$STDAGE_t2,  cutvec_342), mean)
...
G_342_pred <- predict(get(paste("nls_342.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.342 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_342, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_342, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_342 <- data.frame(
  ...
  data.mean = tapply(G_342$B_plt_t1_MgHa, cut(G_342$STDAGE_t2, cutvec_342), 
                     mean), 
  data.CI.high =  tapply(G_342$B_plt_t1_MgHa, cut(G_342$STDAGE_t2, cutvec_342), 
                    high.CI), 
  data.CI.low = tapply(G_342$B_plt_t1_MgHa, cut(G_342$STDAGE_t2, cutvec_342),
                    low.CI), 
  pred.mean = G_342_pred_df[G_342_pred_df$STDAGE_t2 %in% bin_mids_342,]$fitted) 
  # pred.CI.high = tapply(`342_CI_df`$fitted, cut(`342_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_342$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`342_CI_df`$fitted, cut(`342_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_342$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_411_bin_means <- tapply(G_411$B_plt_t1_MgHa, cut(G_411$STDAGE_t2,  cutvec_411), mean)
...
## predict model fit
G_411_pred <- predict(get(paste("nls_411.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.411 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_411, alpha = 0.5, shape ="+", col = "#60606080") +

          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_411,
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res},
...
DM_compare_411 <- data.frame(
  ...
  data.mean = tapply(G_411$B_plt_t1_MgHa, cut(G_411$STDAGE_t2, cutvec_411),
                     mean),
  data.CI.high =  tapply(G_411$B_plt_t1_MgHa, cut(G_411$STDAGE_t2, cutvec_411),
                    high.CI),
  data.CI.low = tapply(G_411$B_plt_t1_MgHa, cut(G_411$STDAGE_t2, cutvec_411),
                    low.CI),
  pred.mean = G_411_pred_df[G_411_pred_df$STDAGE_t2 %in% bin_mids_411,]$fitted)
  # pred.CI.high = tapply(`411_CI_df`$fitted, cut(`411_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_411$STDAGE_t2, g=20))),
  #                      high.CI),
  # pred.CI.low = tapply(`411_CI_df`$fitted, cut(`411_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_411$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M211_bin_means <- tapply(G_M211$B_plt_t1_MgHa, cut(G_M211$STDAGE_t2,  cutvec_M211), mean)
...
G_M211_pred <- predict(get(paste("nls_M211.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M211 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M211, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M211, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M211 <- data.frame(
  ...
  data.mean = tapply(G_M211$B_plt_t1_MgHa, cut(G_M211$STDAGE_t2, cutvec_M211), 
                     mean), 
  data.CI.high =  tapply(G_M211$B_plt_t1_MgHa, cut(G_M211$STDAGE_t2, cutvec_M211), 
                    high.CI), 
  data.CI.low = tapply(G_M211$B_plt_t1_MgHa, cut(G_M211$STDAGE_t2, cutvec_M211),
                    low.CI), 
  pred.mean = G_M211_pred_df[G_M211_pred_df$STDAGE_t2 %in% bin_mids_M211,]$fitted) 
  # pred.CI.high = tapply(`M211_CI_df`$fitted, cut(`M211_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M211$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M211_CI_df`$fitted, cut(`M211_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M211$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M221_bin_means <- tapply(G_M221$B_plt_t1_MgHa, cut(G_M221$STDAGE_t2,  cutvec_M221), mean)
...
G_M221_pred <- predict(get(paste("nls_M221.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M221 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M221, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M221, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M221 <- data.frame(
  ...
  data.mean = tapply(G_M221$B_plt_t1_MgHa, cut(G_M221$STDAGE_t2, cutvec_M221), 
                     mean), 
  data.CI.high =  tapply(G_M221$B_plt_t1_MgHa, cut(G_M221$STDAGE_t2, cutvec_M221), 
                    high.CI), 
  data.CI.low = tapply(G_M221$B_plt_t1_MgHa, cut(G_M221$STDAGE_t2, cutvec_M221),
                    low.CI), 
  pred.mean = G_M221_pred_df[G_M221_pred_df$STDAGE_t2 %in% bin_mids_M221,]$fitted) 
  # pred.CI.high = tapply(`M221_CI_df`$fitted, cut(`M221_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M221$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M221_CI_df`$fitted, cut(`M221_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M221$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M223_bin_means <- tapply(G_M223$B_plt_t1_MgHa, cut(G_M223$STDAGE_t2,  cutvec_M223), mean)
...
G_M223_pred <- predict(get(paste("nls_M223.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M223 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M223, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M223, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M223 <- data.frame(
  ...
  data.mean = tapply(G_M223$B_plt_t1_MgHa, cut(G_M223$STDAGE_t2, cutvec_M223), 
                     mean), 
  data.CI.high =  tapply(G_M223$B_plt_t1_MgHa, cut(G_M223$STDAGE_t2, cutvec_M223), 
                    high.CI), 
  data.CI.low = tapply(G_M223$B_plt_t1_MgHa, cut(G_M223$STDAGE_t2, cutvec_M223),
                    low.CI), 
  pred.mean = G_M223_pred_df[G_M223_pred_df$STDAGE_t2 %in% bin_mids_M223,]$fitted) 
  # pred.CI.high = tapply(`M223_CI_df`$fitted, cut(`M223_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M223$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M223_CI_df`$fitted, cut(`M223_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M223$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M231_bin_means <- tapply(G_M231$B_plt_t1_MgHa, cut(G_M231$STDAGE_t2, cutvec_M231), mean)
...
G_M231_pred <- predict(get(paste("nls_M231.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M231 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M231, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M231, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M231 <- data.frame(
  ...
  data.mean = tapply(G_M231$B_plt_t1_MgHa, cut(G_M231$STDAGE_t2, cutvec_M231), 
                     mean), 
  data.CI.high =  tapply(G_M231$B_plt_t1_MgHa, cut(G_M231$STDAGE_t2, cutvec_M231), 
                    high.CI), 
  data.CI.low = tapply(G_M231$B_plt_t1_MgHa, cut(G_M231$STDAGE_t2, cutvec_M231),
                    low.CI), 
  pred.mean = G_M231_pred_df[G_M231_pred_df$STDAGE_t2 %in% bin_mids_M231,]$fitted) 
  # pred.CI.high = tapply(`M231_CI_df`$fitted, cut(`M231_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M231$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M231_CI_df`$fitted, cut(`M231_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M231$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M242_bin_means <- tapply(G_M242$B_plt_t1_MgHa, cut(G_M242$STDAGE_t2, cutvec_M242), mean)
...
G_M242_pred <- predict(get(paste("nls_M242.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M242 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M242, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M242, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M242 <- data.frame(
  ...
  data.mean = tapply(G_M242$B_plt_t1_MgHa, cut(G_M242$STDAGE_t2, cutvec_M242), 
                     mean), 
  data.CI.high =  tapply(G_M242$B_plt_t1_MgHa, cut(G_M242$STDAGE_t2, cutvec_M242), 
                    high.CI), 
  data.CI.low = tapply(G_M242$B_plt_t1_MgHa, cut(G_M242$STDAGE_t2, cutvec_M242),
                    low.CI), 
  pred.mean = G_M242_pred_df[G_M242_pred_df$STDAGE_t2 %in% bin_mids_M242,]$fitted) 
  # pred.CI.high = tapply(`M242_CI_df`$fitted, cut(`M242_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M242$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M242_CI_df`$fitted, cut(`M242_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M242$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M261_bin_means <- tapply(G_M261$B_plt_t1_MgHa, cut(G_M261$STDAGE_t2,  cutvec_M261), mean)
...
G_M261_pred <- predict(get(paste("nls_M261.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M261 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M261, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M261, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
                            col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_M261)-1)), breaks = cutvec_M261) +  
...
DM_compare_M261 <- data.frame(
  ...
  data.mean = tapply(G_M261$B_plt_t1_MgHa, cut(G_M261$STDAGE_t2, cutvec_M261), 
                     mean), 
  data.CI.high =  tapply(G_M261$B_plt_t1_MgHa, cut(G_M261$STDAGE_t2, cutvec_M261), 
                    high.CI), 
  data.CI.low = tapply(G_M261$B_plt_t1_MgHa, cut(G_M261$STDAGE_t2, cutvec_M261),
                    low.CI), 
  pred.mean = G_M261_pred_df[G_M261_pred_df$STDAGE_t2 %in% bin_mids_M261,]$fitted) 
  # pred.CI.high = tapply(`M261_CI_df`$fitted, cut(`M261_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M261$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M261_CI_df`$fitted, cut(`M261_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M261$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M262_bin_means <- tapply(G_M262$B_plt_t1_MgHa, cut(G_M262$STDAGE_t2,  cutvec_M262), mean)
...
G_M262_pred <- predict(get(paste("nls_M262.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M262 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M262, alpha = 0.5, shape ="+", col = "#60606080") +

          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M262,
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res},
                            col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=10)), breaks = cutvec_M262) +
...
DM_compare_M262 <- data.frame(
  ...
  data.mean = tapply(G_M262$B_plt_t1_MgHa, cut(G_M262$STDAGE_t2, cutvec_M262),
                     mean),
  data.CI.high =  tapply(G_M262$B_plt_t1_MgHa, cut(G_M262$STDAGE_t2, cutvec_M262),
                    high.CI),
  data.CI.low = tapply(G_M262$B_plt_t1_MgHa, cut(G_M262$STDAGE_t2, cutvec_M262),
                    low.CI),
  pred.mean = G_M262_pred_df[G_M262_pred_df$STDAGE_t2 %in% bin_mids_M262,]$fitted)
  # pred.CI.high = tapply(`M262_CI_df`$fitted, cut(`M262_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M262$STDAGE_t2, g=20))),
  #                      high.CI),
  # pred.CI.low = tapply(`M262_CI_df`$fitted, cut(`M262_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M262$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M313_bin_means <- tapply(G_M313$B_plt_t1_MgHa, cut(G_M313$STDAGE_t2,  cutvec_M313), mean)
...
G_M313_pred <- predict(get(paste("nls_M313.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M313 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M313, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M313, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M313 <- data.frame(
  ...
  data.mean = tapply(G_M313$B_plt_t1_MgHa, cut(G_M313$STDAGE_t2, cutvec_M313), 
                     mean), 
  data.CI.high =  tapply(G_M313$B_plt_t1_MgHa, cut(G_M313$STDAGE_t2, cutvec_M313), 
                    high.CI), 
  data.CI.low = tapply(G_M313$B_plt_t1_MgHa, cut(G_M313$STDAGE_t2, cutvec_M313),
                    low.CI), 
  pred.mean = G_M313_pred_df[G_M313_pred_df$STDAGE_t2 %in% bin_mids_M313,]$fitted) 
  # pred.CI.high = tapply(`M313_CI_df`$fitted, cut(`M313_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M313$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M313_CI_df`$fitted, cut(`M313_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M313$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M331_bin_means <- tapply(G_M331$B_plt_t1_MgHa, cut(G_M331$STDAGE_t2,  cutvec_M313), mean)
...
G_M331_pred <- predict(get(paste("nls_M331.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M331 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M331, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M331, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M331 <- data.frame(
  ...
  data.mean = tapply(G_M331$B_plt_t1_MgHa, cut(G_M331$STDAGE_t2, cutvec_M331), 
                     mean), 
  data.CI.high =  tapply(G_M331$B_plt_t1_MgHa, cut(G_M331$STDAGE_t2, cutvec_M331), 
                    high.CI), 
  data.CI.low = tapply(G_M331$B_plt_t1_MgHa, cut(G_M331$STDAGE_t2, cutvec_M331),
                    low.CI), 
  pred.mean = G_M331_pred_df[G_M331_pred_df$STDAGE_t2 %in% bin_mids_M331,]$fitted) 
  # pred.CI.high = tapply(`M331_CI_df`$fitted, cut(`M331_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M331$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M331_CI_df`$fitted, cut(`M331_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M331$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M332_bin_means <- tapply(G_M332$B_plt_t1_MgHa, cut(G_M332$STDAGE_t2,  cutvec_M332), mean)
...
G_M332_pred <- predict(get(paste("nls_M332.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M332 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M332, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M332, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
                            col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_M332)-2)), breaks = cutvec_M332) +  
...
DM_compare_M332 <- data.frame(
  ...
  data.mean = tapply(G_M332$B_plt_t1_MgHa, cut(G_M332$STDAGE_t2, cutvec_M332), 
                     mean), 
  data.CI.high =  tapply(G_M332$B_plt_t1_MgHa, cut(G_M332$STDAGE_t2, cutvec_M332), 
                    high.CI), 
  data.CI.low = tapply(G_M332$B_plt_t1_MgHa, cut(G_M332$STDAGE_t2, cutvec_M332),
                    low.CI), 
  pred.mean = G_M332_pred_df[G_M332_pred_df$STDAGE_t2 %in% bin_mids_M332,]$fitted) 
  # pred.CI.high = tapply(`M332_CI_df`$fitted, cut(`M332_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M332$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M332_CI_df`$fitted, cut(`M332_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M332$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M333_bin_means <- tapply(G_M333$B_plt_t1_MgHa, cut(G_M333$STDAGE_t2, cutvec_M333), mean)
...
G_M333_pred <- predict(get(paste("nls_M333.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M333 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M333, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M333, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M333 <- data.frame(
  ...
  data.mean = tapply(G_M333$B_plt_t1_MgHa, cut(G_M333$STDAGE_t2, cutvec_M333), 
                     mean), 
  data.CI.high =  tapply(G_M333$B_plt_t1_MgHa, cut(G_M333$STDAGE_t2, cutvec_M333), 
                    high.CI), 
  data.CI.low = tapply(G_M333$B_plt_t1_MgHa, cut(G_M333$STDAGE_t2, cutvec_M333),
                    low.CI), 
  pred.mean = G_M333_pred_df[G_M333_pred_df$STDAGE_t2 %in% bin_mids_M333,]$fitted) 
  # pred.CI.high = tapply(`M333_CI_df`$fitted, cut(`M333_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M333$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M333_CI_df`$fitted, cut(`M333_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M333$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M334_bin_means <- tapply(G_M334$B_plt_t1_MgHa, cut(G_M334$STDAGE_t2,  cutvec_M334), mean)
...
G_M334_pred <- predict(get(paste("nls_M334.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M334 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M334, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M334, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M334 <- data.frame(
  ...
  data.mean = tapply(G_M334$B_plt_t1_MgHa, cut(G_M334$STDAGE_t2, cutvec_M334), 
                     mean), 
  data.CI.high =  tapply(G_M334$B_plt_t1_MgHa, cut(G_M334$STDAGE_t2, cutvec_M334), 
                    high.CI), 
  data.CI.low = tapply(G_M334$B_plt_t1_MgHa, cut(G_M334$STDAGE_t2, cutvec_M334),
                    low.CI), 
  pred.mean = G_M334_pred_df[G_M334_pred_df$STDAGE_t2 %in% bin_mids_M334,]$fitted) 
  # pred.CI.high = tapply(`M334_CI_df`$fitted, cut(`M334_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M334$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M334_CI_df`$fitted, cut(`M334_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M334$STDAGE_t2, g=20))),
  #                      low.CI))
...
## then get bin means
G_M341_bin_means <- tapply(G_M341$B_plt_t1_MgHa, cut(G_M341$STDAGE_t2,  cutvec_M341), mean)
...
G_M341_pred <- predict(get(paste("nls_M341.",  Mod.Sel2, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
...
## plot
gg.M341 <- ggplot() +
          geom_point(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M341, alpha = 0.5, shape ="+", col = "#60606080") +
         
          stat_summary_bin(aes(x = STDAGE_t2, y = B_plt_t1_MgHa), data = G_M341, 
                            fun.data = function(x) {
                              res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                              names(res) <- c("ymin","y","ymax")
                              res}, 
...
DM_compare_M341 <- data.frame(
  ...
  data.mean = tapply(G_M341$B_plt_t1_MgHa, cut(G_M341$STDAGE_t2, cutvec_M341), 
                     mean), 
  data.CI.high =  tapply(G_M341$B_plt_t1_MgHa, cut(G_M341$STDAGE_t2, cutvec_M341), 
                    high.CI), 
  data.CI.low = tapply(G_M341$B_plt_t1_MgHa, cut(G_M341$STDAGE_t2, cutvec_M341),
                    low.CI), 
  pred.mean = G_M341_pred_df[G_M341_pred_df$STDAGE_t2 %in% bin_mids_M341,]$fitted) 
  # pred.CI.high = tapply(`M341_CI_df`$fitted, cut(`M341_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M341$STDAGE_t2, g=20))),
  #                      high.CI), 
  # pred.CI.low = tapply(`M341_CI_df`$fitted, cut(`M341_CI_df`$STDAGE_t2, c(0,creditmodel::cut_equal(G_M341$STDAGE_t2, g=20))),
  #                      low.CI))
...
gg.phi_ECOSUBCD <- ggplot(aes(x=Ecoregion, y=phi, shape = region), 
                 ...
                 scale_shape_manual(values = c(16,15,17)) + 
                 theme(legend.position = "top") + ylim(c(-0.3,0.3))
