---
title: "FIA - NLS Models: Biomass vs. Stand Age, G-Reconciled, Temporally-balanced"
author: "JAH"
date: "`r Sys.Date()`"
output:
  html_document:
...
cutvec_211 <-  c(0,creditmodel::cut_equal(G_211$STDAGE_t1, g=20)[1:19], max(G_211$STDAGE_t2))
...
gg.phi_ECOSUBCD <- ggplot(aes(x=Ecoregion, y=phi, shape = region), 
                 ...
                 scale_shape_manual(values = c(16,15,17)) + 
                 theme(legend.position = "top") + ylim(c(-0.2,0.2))
