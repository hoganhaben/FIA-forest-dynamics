...
## used later for plotting lm equations
lm_eqn = function(m) {
...
# load("C:/Users/hogie/Dropbox/FIA_R/Starter_FIA_data_processing/G_Nov2022.Rdata")   # if working on P-50
```
...
Best_mods.P[Best_mods.P$Ecoprovince == "211",]$Sel.Mod.2 <- Mod.Sel2
...
nls.param.df[nls.param.df$Ecoprovince == "211",]$tau.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "211",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "211",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "211",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$k.97.5 <- intervals_high["k"]
...
try(
  nls_211.3 <- nls(f_3, data = G_211, 
                   ...
                   algorithm = "port",  # can turn on/off nls fitting with port algorithm
                   weights = G_211$nls_weights.2), 
 )
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "211",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "211",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "211",]$tau.variance <- vcov(get(paste("nls_211.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha.variance <- vcov(get(paste("nls_211.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "211",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "211",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "211",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "211",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_212$STDAGE_t2_bin<-  cut(G_212$STDAGE_t2, cutvec_212, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "212",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "212",]$tau.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "212",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "212",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "212",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "212",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "212",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "212",]$tau.variance <- vcov(get(paste("nls_212.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha.variance <- vcov(get(paste("nls_212.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "212",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "212",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "212",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "212",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_221$STDAGE_t2_bin<-  cut(G_221$STDAGE_t2, cutvec_221, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "221",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "221",]$tau.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["tau","tau"]

nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "221",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "221",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "221",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "221",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "221",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "221",]$tau.variance <- vcov(get(paste("nls_221.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha.variance <- vcov(get(paste("nls_221.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "221",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "221",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "221",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "221",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_222$STDAGE_t2_bin<-  cut(G_222$STDAGE_t2, cutvec_222, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "222",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "222",]$tau.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "222",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "222",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "222",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "222",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "222",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "222",]$tau.variance <- vcov(get(paste("nls_222.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha.variance <- vcov(get(paste("nls_222.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "222",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "222",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "222",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "222",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_223$STDAGE_t2_bin<-  cut(G_223$STDAGE_t2, cutvec_223, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "223",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "223",]$tau.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "223",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "223",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "223",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "223",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "223",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "223",]$tau.variance <- vcov(get(paste("nls_223.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha.variance <- vcov(get(paste("nls_223.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "223",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "223",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "223",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$phi.97.5 <- intervals_high["phi"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "223",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_231$STDAGE_t2_bin<-  cut(G_231$STDAGE_t2, cutvec_231, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "231",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "231",]$tau.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "231",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "231",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "231",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "231",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "231",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "231",]$tau.variance <- vcov(get(paste("nls_231.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha.variance <- vcov(get(paste("nls_231.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "231",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "231",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "231",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "231",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_232$STDAGE_t2_bin<-  cut(G_232$STDAGE_t2, cutvec_232, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "232",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "232",]$tau.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "232",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "232",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "232",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "232",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "232",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "232",]$tau.variance <- vcov(get(paste("nls_232.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha.variance <- vcov(get(paste("nls_232.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "232",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "232",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "232",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "232",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_234$STDAGE_t2_bin<-  cut(G_234$STDAGE_t2, cutvec_234, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "234",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "234",]$tau.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "234",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "234",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "234",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "234",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "234",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "234",]$tau.variance <- vcov(get(paste("nls_234.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha.variance <- vcov(get(paste("nls_234.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "234",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "234",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "234",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "234",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "242",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "242",]$tau.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "242",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "242",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "242",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "242",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "242",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "242",]$tau.variance <- vcov(get(paste("nls_242.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha.variance <- vcov(get(paste("nls_242.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "242",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "242",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "242",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "242",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column
## first get the correct bin  - assign as column in data frame
G_251$STDAGE_t2_bin<-  cut(G_251$STDAGE_t2, cutvec_251, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "251",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "251",]$tau.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "251",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "251",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "251",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "251",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "251",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "251",]$tau.variance <- vcov(get(paste("nls_251.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha.variance <- vcov(get(paste("nls_251.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "251",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "251",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "251",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "251",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "255",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "255",]$tau.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "255",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "255",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "255",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "255",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "255",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "255",]$tau.variance <- vcov(get(paste("nls_255.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha.variance <- vcov(get(paste("nls_255.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "255",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "255",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "255",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "255",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "261",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "261",]$tau.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "261",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "261",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "261",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "261",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "261",]$Best.Mod <- Mod.Sel3


## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "261",]$tau.variance <- vcov(get(paste("nls_261.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha.variance <- vcov(get(paste("nls_261.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "261",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "261",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "261",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "262",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "262",]$tau.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "262",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "262",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "262",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "262",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "262",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "262",]$tau.variance <- vcov(get(paste("nls_262.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha.variance <- vcov(get(paste("nls_262.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "262",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "262",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "262",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "262",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "263",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "263",]$tau.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "263",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$phi <- coefs["phi"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "263",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$phi.2.5 <- intervals_low["phi"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "263",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$phi.97.5 <- intervals_high["phi"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "263",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "263",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "263",]$tau.variance <- vcov(get(paste("nls_263.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha.variance <- vcov(get(paste("nls_263.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "263",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "263",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "263",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "263",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "313",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "313",]$tau.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["tau","tau"]
# nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "313",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "313",]$tau.2.5 <- intervals_low["tau"]
# nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "313",]$tau.97.5 <- intervals_high["tau"]
# nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "313",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "313",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "313",]$tau.variance <- vcov(get(paste("nls_313.",  Mod.Sel3, sep ="")))["tau","tau"]
# nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha.variance <- vcov(get(paste("nls_313.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "313",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "313",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "313",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "313",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "315",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "315",]$tau.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "315",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "315",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "315",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "315",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "315",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "315",]$tau.variance <- vcov(get(paste("nls_315.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha.variance <- vcov(get(paste("nls_315.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "315",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "315",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "315",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "315",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "321",]$Sel.Mod.2 <- Mod.Sel2
...
nls.param.df[nls.param.df$Ecoprovince == "321",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "321",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "321",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "321",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "321",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "321",]$tau.variance <- vcov(get(paste("nls_321.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$alpha.variance <- vcov(get(paste("nls_321.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "321",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "321",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "321",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "321",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "322",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "322",]$tau.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "322",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "322",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "322",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "322",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "322",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "322",]$tau.variance <- vcov(get(paste("nls_322.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha.variance <- vcov(get(paste("nls_322.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "322",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "322",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "322",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "322",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column
## first get the correct bin  - assign as column in data frame
G_331$STDAGE_t2_bin<-  cut(G_331$STDAGE_t2, cutvec_331, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "331",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "331",]$tau.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "331",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "331",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "331",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "331",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "331",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "331",]$tau.variance <- vcov(get(paste("nls_331.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha.variance <- vcov(get(paste("nls_331.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "331",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "331",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "331",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "331",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column
## first get the correct bin  - assign as column in data frame
G_332$STDAGE_t2_bin <-  cut(G_332$STDAGE_t2, cutvec_332, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "332",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "332",]$tau.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "332",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "332",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "332",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "332",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "332",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "332",]$tau.variance <- vcov(get(paste("nls_332.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha.variance <- vcov(get(paste("nls_332.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "332",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "332",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "332",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "332",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "341",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "341",]$tau.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "341",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "341",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "341",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "341",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "341",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "341",]$tau.variance <- vcov(get(paste("nls_341.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha.variance <- vcov(get(paste("nls_341.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "341",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "341",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "341",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "341",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "342",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "342",]$tau.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "342",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "342",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "342",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "342",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "342",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "342",]$tau.variance <- vcov(get(paste("nls_342.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha.variance <- vcov(get(paste("nls_342.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "342",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "342",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "342",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "342",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "411",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "411",]$tau.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "411",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "411",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "411",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "411",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "411",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "411",]$tau.variance <- vcov(get(paste("nls_411.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha.variance <- vcov(get(paste("nls_411.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "411",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "411",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "411",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "411",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M211",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M211",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M211",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau.variance <- vcov(get(paste("nls_M211.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha.variance <- vcov(get(paste("nls_M211.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M211",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M211",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column
## first get the correct bin  - assign as column in data frame
G_M221$STDAGE_t2_bin<-  cut(G_M221$STDAGE_t2, cutvec_M221, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M221",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M221",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M221",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau.variance <- vcov(get(paste("nls_M221.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha.variance <- vcov(get(paste("nls_M221.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M221",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M221",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M223",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["tau","tau"]
# nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M223",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M223",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau.variance <- vcov(get(paste("nls_M223.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha.variance <- vcov(get(paste("nls_M223.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M223",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M223",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column
## first get the correct bin  - assign as column in data frame
G_M231$STDAGE_t2_bin<-  cut(G_M231$STDAGE_t2, cutvec_M231, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M231",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M231",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M231",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau.variance <- vcov(get(paste("nls_M231.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha.variance <- vcov(get(paste("nls_M231.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M231",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M231",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M242",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M242",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M242",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau.variance <- vcov(get(paste("nls_M242.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha.variance <- vcov(get(paste("nls_M242.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M242",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M242",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
try(
  nls_M261.1 <- nls(f_1, data = G_M261, 
                   start = c(tau=-1.6, A=1000, k=k.start), 
...
try(
  nls_M261.2 <- nls(f_2, data=G_M261, 
                   start = c(tau=-1.6, alpha=alpha.start, A=1000, k=k.start), 
                   weights = G_M261$nls_weights.2), 
 )
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M261",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
try(
  nls_M261.3 <- nls(f_3, data = G_M261, 
                   start = c(tau=tau.start, a=a.start, b=b.start, c=c.start, d=d.start), 
                   lower = c(tau=-5, a=-100, b=0, c=0, d=0), 
                   upper = c(tau=10, a= 1000, b=1000, c= 5000, d=10),
                   algorithm = "port",  # can turn on/off nls fitting with port algorithm
                   weights = G_M261$nls_weights.2), 
 )
...
try(
  nls_M261.4 <- nls(f_4, data=G_M261, 
                   start = c(tau=tau.start, alpha=alpha.start, a=a.start, b=b.start, c=c.start, d=d.start), 
                   lower = c(tau=-5, alpha=0, a=-100, b=0, c=0, d=0), 
                   upper = c(tau=10, alpha=2, a= 1000, b=1000, c= 5000, d=10),
                   algorithm = "port",  # can turn on/off nls fitting with port algorithm
                   weights = G_M261$nls_weights.2), 
 )
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M261",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M261",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau.variance <- vcov(get(paste("nls_M261.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha.variance <- vcov(get(paste("nls_M261.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M261",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M261",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M262",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M262",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M262",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau.variance <- vcov(get(paste("nls_M262.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha.variance <- vcov(get(paste("nls_M262.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M262",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M262",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M313",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$alpha.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
try(
  nls_M313.3 <- nls(f_3, data = G_M313, 
                   ...
                   lower = c(tau=-5, a=0, b=0, c=0, d=0), 
                   upper = c(tau=5, a= 1000, b=1000, c= 5000, d=10),
                   algorithm = "port",  # can turn on/off nls fitting with port algorith
                   weights = G_M313$nls_weights.2), 
 )
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M313",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M313",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau.variance <- vcov(get(paste("nls_M313.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$alpha.variance <- vcov(get(paste("nls_M313.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$phi <- coefs["phi"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$phi.2.5 <- intervals_low["phi"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$phi.97.5 <- intervals_high["phi"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M313",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M331",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M313",]$tau.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M331",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M331",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M331",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M331",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M331",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M331",]$tau.variance <- vcov(get(paste("nls_M331.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha.variance <- vcov(get(paste("nls_M331.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M331",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M331",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M331",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M331",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M332",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M332",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M332",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau.variance <- vcov(get(paste("nls_M332.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha.variance <- vcov(get(paste("nls_M332.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M332",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M332",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M333",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M333",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M333",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau.variance <- vcov(get(paste("nls_M333.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha.variance <- vcov(get(paste("nls_M333.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M333",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M333",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
#### add weights data column
## first get the correct bin  - assign as column in data frame
G_M334$STDAGE_t2_bin<-  cut(G_M334$STDAGE_t2, cutvec_M334, include.lowest = T)
## then get bin means
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M334",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M334",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M334",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau.variance <- vcov(get(paste("nls_M334.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha.variance <- vcov(get(paste("nls_M334.",  Mod.Sel3, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M334",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M334",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M341",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$A <- coefs["A"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$k <- coefs["k"]

nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$A.2.5 <- intervals_low["A"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$k.2.5 <- intervals_low["k"]

nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$A.97.5 <- intervals_high["A"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$k.97.5 <- intervals_high["k"]
## end write coefficients to table 
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Ecoprovince == "M341",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Ecoprovince == "M341",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau.variance <- vcov(get(paste("nls_M341.",  Mod.Sel3, sep ="")))["tau","tau"]
# nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha.variance <- vcov(get(paste("nls_M341.",  Mod.Sel3, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau <- coefs["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha <- coefs["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$a <- coefs["a"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$b <- coefs["b"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$c <- coefs["c"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$d <- coefs["d"]

nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau.2.5 <- intervals_low["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha.2.5 <- intervals_low["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$a.2.5 <- intervals_low["a"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$b.2.5 <- intervals_low["b"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$c.2.5 <- intervals_low["c"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$d.2.5 <- intervals_low["d"]

nls.param.df[nls.param.df$Ecoprovince == "M341",]$tau.97.5 <- intervals_high["tau"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$alpha.97.5 <- intervals_high["alpha"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$a.97.5 <- intervals_high["a"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$b.97.5 <- intervals_high["b"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$c.97.5 <- intervals_high["c"]
nls.param.df[nls.param.df$Ecoprovince == "M341",]$d.97.5 <- intervals_high["d"]
## end write coefficients to table 
...
Best_mods.P$Ecoprovince <- as.factor(Best_mods.P$Ecoprovince)
...
vcov_list <- list(
  #### 211
  `211` = vcov(get(paste("nls_211.", Best_mods.P[Best_mods.P$Ecoprovince == 211,]$Best.Mod, sep =""))),
  ####  212
  `212` = vcov(get(paste("nls_212.", Best_mods.P[Best_mods.P$Ecoprovince == 212,]$Best.Mod, sep =""))),
  ####  221
  `221` = vcov(get(paste("nls_221.", Best_mods.P[Best_mods.P$Ecoprovince == 221,]$Best.Mod, sep =""))),
  ####  222
  `222` = vcov(get(paste("nls_222.", Best_mods.P[Best_mods.P$Ecoprovince == 222,]$Best.Mod, sep =""))),
  ####  223
  `223` = vcov(get(paste("nls_223.", Best_mods.P[Best_mods.P$Ecoprovince == 223,]$Best.Mod, sep =""))),
  ####  231
  `231` = vcov(get(paste("nls_231.", Best_mods.P[Best_mods.P$Ecoprovince == 231,]$Best.Mod, sep =""))),
  ####  232
  `232` = vcov(get(paste("nls_232.", Best_mods.P[Best_mods.P$Ecoprovince == 232,]$Best.Mod, sep =""))),
  ####  234
  `234` = vcov(get(paste("nls_234.", Best_mods.P[Best_mods.P$Ecoprovince == 234,]$Best.Mod, sep =""))),
  ####  251
  `251` = vcov(get(paste("nls_251.", Best_mods.P[Best_mods.P$Ecoprovince == 251,]$Best.Mod, sep =""))),
  ####  255
  `255` = vcov(get(paste("nls_255.", Best_mods.P[Best_mods.P$Ecoprovince == 255,]$Best.Mod, sep =""))),
  ####  263
  `263` = vcov(get(paste("nls_263.", Best_mods.P[Best_mods.P$Ecoprovince == 263,]$Best.Mod, sep =""))),
  ####  313
  `313` = vcov(get(paste("nls_313.", Best_mods.P[Best_mods.P$Ecoprovince == 313,]$Best.Mod, sep =""))),
  ####  331
  # `331` = vcov(get(paste("nls_331.", Best_mods.P[Best_mods.P$Ecoprovince == 331,]$Best.Mod, sep =""))),
  ####  332
  `332` = vcov(get(paste("nls_332.", Best_mods.P[Best_mods.P$Ecoprovince == 332,]$Best.Mod, sep =""))),
  ####  M211
  `M211` = vcov(get(paste("nls_M211.", Best_mods.P[Best_mods.P$Ecoprovince == "M211",]$Best.Mod, sep =""))),
  ####  M221
  `M221` = vcov(get(paste("nls_M221.", Best_mods.P[Best_mods.P$Ecoprovince == "M221",]$Best.Mod, sep =""))),
  ####  M223
  `M223` = vcov(get(paste("nls_M223.", Best_mods.P[Best_mods.P$Ecoprovince == "M223",]$Best.Mod, sep =""))),
  ####  M231
  `M231` = vcov(get(paste("nls_M231.", Best_mods.P[Best_mods.P$Ecoprovince == "M231",]$Best.Mod, sep =""))),
  ####  M242
  `M242` = vcov(get(paste("nls_M242.", Best_mods.P[Best_mods.P$Ecoprovince == "M242",]$Best.Mod, sep =""))),
  ####  M261
  `M261` = vcov(get(paste("nls_M261.", Best_mods.P[Best_mods.P$Ecoprovince == "M261",]$Best.Mod, sep =""))),
  ####  M313
  `M313` = vcov(get(paste("nls_M313.", Best_mods.P[Best_mods.P$Ecoprovince == "M313",]$Best.Mod, sep =""))),
  ####  M331
  `M331` = vcov(get(paste("nls_M331.", Best_mods.P[Best_mods.P$Ecoprovince == "M331",]$Best.Mod, sep =""))),
  ####  M332
  `M332` = vcov(get(paste("nls_M332.", Best_mods.P[Best_mods.P$Ecoprovince == "M332",]$Best.Mod, sep =""))),
  ####  M333
  `M333` = vcov(get(paste("nls_M333.", Best_mods.P[Best_mods.P$Ecoprovince == "M333",]$Best.Mod, sep =""))),
  ####  M334
  `M334` = vcov(get(paste("nls_M334.", Best_mods.P[Best_mods.P$Ecoprovince == "M334",]$Best.Mod, sep =""))),
  ####  M341
  `M341` = vcov(get(paste("nls_M341.", Best_mods.P[Best_mods.P$Ecoprovince == "M341",]$Best.Mod, sep ="")))
...
#plot.vcov(vcov_list[["331"]], "331") ; 
plot.vcov(vcov_list[["332"]], "332")
...
tau_df <-  data.frame( ECOPROVCD = as.factor(c(nls.param.df$Ecoprovince,"Water")), tau = as.numeric(c(nls.param.df[,"tau"], NA)))
