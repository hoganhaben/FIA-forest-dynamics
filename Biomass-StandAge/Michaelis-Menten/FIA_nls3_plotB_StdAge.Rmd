...
## if there are duplicated cut_vec values when using 20 (i.e., 5% quantile bins), then go to 10% quantile bins
  ...
  cutvec_242 <- round(quantile(P_242$STDAGE, seq(0,1, length.out = 11))) ## use 10 bins, becuase 20 is too many
#}
...
## if there are duplicated cut_vec values when using 20 (i.e., 5% quantile bins), then go to 10% quantile bins
  ...
  cutvec_321 <- round(quantile(P_321$STDAGE, seq(0,1, length.out = 11)))  ## use 10 bins becuase 20 is too many
#}
...
# if(any(any(duplicated(cutvec_341)))){
  cutvec_341 <- round(quantile(P_341$STDAGE, seq(0,1, length.out = 11)))  ## use 10 bins becuase 20 is too many
#}
...
### cutvec and bin mids
# <- round(quantile(P_342$STDAGE, seq(0,1, length.out = 21)))

## if there are duplicated cut_vec values when using 20 (i.e., 5% quantile bins), then go to 10% quantile bins
#if(any(any(duplicated(cutvec_342)))){
  cutvec_342 <- round(quantile(P_342$STDAGE, seq(0,1, length.out = 11)))  ## use 10 bins because 20 is too many
#}
...
```{r}
## code control 
fit.models <-  F    ### NOT ENOUGH DATA TO FIT MODEL WELL
```
...
## if there are duplicated cut_vec values when using 20 (i.e., 5% quantile bins), then go to 10% quantile bins
  ...
  cutvec_M262 <- round(quantile(P_M262$STDAGE, seq(0,1, length.out = 11)))  ## use 10 bins becuase 20 is too many
#}
...
## then get bin means
P_M262_bin_means <- tapply(P_M262$BIO_MgHa, cut(P_M262$STDAGE,  cutvec_M262), mean, na.rm = T)
...
# if(any(any(duplicated(cutvec_M313)))){
  cutvec_M313 <- round(quantile(P_M313$STDAGE, seq(0,1, length.out = 11)))  ## use 10 bins becuase 20 is too many
# }
...
## if there are duplicated cut_vec values when using 20 (i.e., 5% quantile bins), then go to 10% quantile bins
  ...
  cutvec_M341 <- round(quantile(P_M341$STDAGE, seq(0,1, length.out = 11))) ## use 10 bins, because 20 is too many
#}
