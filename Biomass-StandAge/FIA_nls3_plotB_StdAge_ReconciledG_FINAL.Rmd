---
title: "FIA NLS Models: Biomass vs. Stand Age, G-Reconciled"
author: "JAH"
date: "`r Sys.Date()`"
output:
  html_document:
...
$B = (1 + (yr-1990)* \tau/100) \times \left( \frac {A \cdot STDAGE_{t2}} {k+STDAGE_{t2}} \right)$

__model 2: alpha model__
$B = (1 + (yr-1990)* \tau/100) \times (1 - \alpha \cdot B_l)  \times \left( \frac {A \cdot STDAGE_{t2}} {k+STDAGE_{t2}} \right)$
...
$pA + \left( \frac {(1-p) * A \cdot STDAGE_{t2}} {k+STDAGE_{t2}} \right)$

__sub-model b: s form__
$\left( \frac {A \cdot STDAGE_{t2}^s} {k^s+STDAGE_{t2}^s} \right)$

__sub-model c: p and s together__
$pA + \left( \frac {(1-p) *A \cdot STDAGE_{t2}^s} {k^s + STDAGE_{t1}^s} \right)$
...
__model 4:  simple model__
$B = (1 + (yr-1990)* \tau/100) \times \left(a + b \cdot \exp{ - \left[ \frac{ \log \left(STDAGE_{t2} /c \right)} {d} \right]} ^2 \right)$

__model 5: alpha model__
$B = (1 + (yr-1990)* \tau/100) \times (1 - \alpha \cdot B_l)  \times \left(a + b \cdot \exp{ - \left[ \frac{ \log \left(STDAGE_{t2} /c \right)} {d} \right]} ^2 \right)$
...
## Log-Normal models
## model 3
f_3 <- formula(B_plt_t2_MgHa ~ (1 + (MEASTIME_t2-1990)*tau/100) * (a+b*exp(-((log(STDAGE_t2/c))/d)^2)))
## model 4
f_4 <-  formula(B_plt_t2_MgHa ~ (1 + (MEASTIME_t2-1990)*tau/100) * (1-alpha*B_L_prop) * (a+b*exp(-((log(STDAGE_t2/c))/d)^2)))
...
# load("C:/Users/hogie/Dropbox/FIA_R/Starter_FIA_data_processing/G.Rdata")   # if working on P-50

### need to clean up some dates  -- FOR MODEL BOOKEEPING figure below
# create new variable called MEASTIME_t1_filled
G$MEASTIME_t1_filled <- G$MEASTIME_t1

## take MEASTIME_t2 minus REMPER
G[is.na(G$MEASTIME_t1_filled),]$MEASTIME_t1_filled <- G[is.na(G$MEASTIME_t1_filled),]$MEASTIME_t2 - G[is.na(G$MEASTIME_t1_filled),]$REMPER
...
ge.fit <- round(coef(get(paste("nls_211.",  Mod.Sel1, sep ="")))["tau"], 1)
  ...
  assign(
    paste("nls_211.", Mod.Sel1, "a", sep =""), 
      nls(get(paste("f_", Mod.Sel1, "a", sep ="")), 
          data = G_211,
          start = if(Mod.Sel1 %in% c(1)) {
            c(ge.fit, A.fit, k.fit, p=0.1)
            } else if (Mod.Sel1 %in% c(2)){
              c(ge.fit, alpha.fit, A.fit, k.fit, p=0.1)
              } ,
          weights = G_211$nls_weights.2))
 )
      ...
      nls(get(paste("f_", Mod.Sel1, "b", sep ="")), 
          ...
          start = if(Mod.Sel1 %in% c(1)) {
            c(ge.fit, A.fit, k.fit, s=1.5)
              ...
              c(ge.fit, alpha.fit, A.fit, k.fit, s=1.5)
              } , 
          weights = G_211$nls_weights.2)) 
 )
      ...
      nls(get(paste("f_", Mod.Sel1, "c", sep ="")), 
          ...
          start = if(Mod.Sel1 %in% c(1)) {
            c(ge.fit, A.fit, k.fit, p=0.1, s=1.5)
              ...
              c(ge.fit, alpha.fit, A.fit, k.fit, p=0.1, s=1.5)
              } , 
          weights = G_211$nls_weights.2))
 )
## end MODEL FITTING 2 ----------------------------------------------------------------------- ##
...
Best_mods.P[Best_mods.P$Code == "211",]$Sel.Mod.2 <- Mod.Sel2
...
nls.param.df[nls.param.df$Code == "211",]$tau.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "211",]$alpha.variance <- vcov(get(paste("nls_211.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Code == "211",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "211",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "211",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_211.3") & exists("nls_211.4")){
  print(anova(nls_211.3, nls_211.4))
} 

## AIC comparison
AIC3_211 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "211",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "211",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "211",]$tau.variance <- vcov(get(paste("nls_211.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "211",]$alpha.variance <- vcov(get(paste("nls_211.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_211.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_211.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_212.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "212",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "212",]$tau.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "212",]$alpha.variance <- vcov(get(paste("nls_212.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "212",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "212",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "212",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_212.3") & exists("nls_212.4")){
  print(anova(nls_212.3, nls_212.4))
} 

## AIC comparison
AIC3_212 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "212",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "212",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "212",]$tau.variance <- vcov(get(paste("nls_212.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "212",]$alpha.variance <- vcov(get(paste("nls_212.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_212.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_212.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_221.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "221",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "221",]$tau.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["tau","tau"]

nls.param.df[nls.param.df$Code == "221",]$alpha.variance <- vcov(get(paste("nls_221.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Code == "221",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "221",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "221",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_221.3") & exists("nls_221.4")){
  print(anova(nls_221.3, nls_221.4))
} 

## AIC comparison
AIC3_221 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "221",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "221",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "221",]$tau.variance <- vcov(get(paste("nls_221.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "221",]$alpha.variance <- vcov(get(paste("nls_221.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_221.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_221.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_222.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "222",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "222",]$tau.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "222",]$alpha.variance <- vcov(get(paste("nls_222.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "222",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "222",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "222",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_222.3") & exists("nls_222.4")){
  print(anova(nls_222.3, nls_222.4))
} 

## AIC comparison
AIC3_222 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "222",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "222",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "222",]$tau.variance <- vcov(get(paste("nls_222.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "222",]$alpha.variance <- vcov(get(paste("nls_222.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_222.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_222.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_223.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "223",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "223",]$tau.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "223",]$alpha.variance <- vcov(get(paste("nls_223.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "223",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "223",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "223",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_223.3") & exists("nls_223.4")){
  print(anova(nls_223.3, nls_223.4))
}

## AIC comparison
AIC3_223 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "223",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "223",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "223",]$tau.variance <- vcov(get(paste("nls_223.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "223",]$alpha.variance <- vcov(get(paste("nls_223.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_223.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_223.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_231.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "231",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "231",]$tau.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "231",]$alpha.variance <- vcov(get(paste("nls_231.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "231",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "231",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "231",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_231.3") & exists("nls_231.4")){
  print(anova(nls_231.3, nls_231.4))
} 

## AIC comparison
AIC3_231 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "231",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "231",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "231",]$tau.variance <- vcov(get(paste("nls_231.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "231",]$alpha.variance <- vcov(get(paste("nls_231.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_231.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_231.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_232.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "232",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "232",]$tau.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "232",]$alpha.variance <- vcov(get(paste("nls_232.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "232",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "232",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "232",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_232.3") & exists("nls_232.4")){
  print(anova(nls_232.3, nls_232.4))
}

## AIC comparison
AIC3_232 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "232",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "232",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "232",]$tau.variance <- vcov(get(paste("nls_232.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "232",]$alpha.variance <- vcov(get(paste("nls_232.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_232.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_232.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_234.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "234",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "234",]$tau.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "234",]$alpha.variance <- vcov(get(paste("nls_234.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "234",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "234",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "234",]$tau.97.5 <- intervals_high["tau"]
...
try(
  nls_234.4 <- nls(f_4, data=G_234, 
                   start = c(tau=0.6, alpha=0.6, a=a.start, b=b.start, c=c.start, d=d.start), 
                   lower = c(tau=-5, alpha=0, a=0, b=0, c=0, d=0), 
                   upper = c(tau=5, alpha=2, a= 1000, b=1000, c= 5000, d=10),
                   algorithm= "port",
                   weights = G_234$nls_weights.2, control = nls.control(maxiter =100)), 
 )


## test
if(exists("nls_234.3") & exists("nls_234.4")){
  print(anova(nls_234.3, nls_234.4))
} 

## AIC comparison
AIC3_234 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "234",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "234",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "234",]$tau.variance <- vcov(get(paste("nls_234.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "234",]$alpha.variance <- vcov(get(paste("nls_234.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_234.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_234.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_242.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "242",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "242",]$tau.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "242",]$alpha.variance <- vcov(get(paste("nls_242.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "242",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "242",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "242",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_242.3") & exists("nls_242.4")){
  print(anova(nls_242.3, nls_242.4))
} 

## AIC comparison
AIC3_242 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "242",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "242",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "242",]$tau.variance <- vcov(get(paste("nls_242.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "242",]$alpha.variance <- vcov(get(paste("nls_242.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_242.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_242.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_251.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "251",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "251",]$tau.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "251",]$alpha.variance <- vcov(get(paste("nls_251.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "251",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "251",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "251",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_251.3") & exists("nls_251.4")){
  print(anova(nls_251.3, nls_251.4))
} 

## AIC comparison
AIC3_251 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "251",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "251",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "251",]$tau.variance <- vcov(get(paste("nls_251.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "251",]$alpha.variance <- vcov(get(paste("nls_251.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_251.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_251.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_255.",  Mod.Sel1, sep ="")))["tau"], 1)
      ...
      nls(get(paste("f_", Mod.Sel1, "a", sep ="")), 
          ...
          start = if(Mod.Sel1 %in% c(1)) {
            c(ge.fit, A.fit, k.fit, p=0.1)
              ...
              c(ge.fit, alpha.fit, A.fit, k.fit, p=0.1)
              } else if (Mod.Sel1 %in% c(3)) {
                c(ge.fit, alpha.fit, alpha.fit, A.fit, k.fit, p=0.1)}, 
          weights = G_255$nls_weights.2))
 )
          ...
          start = if(Mod.Sel1 %in% c(1)) {
            c(ge.fit, A.fit, k.fit, s=1.5)
              ...
              c(ge.fit, alpha.fit, A.fit, k.fit, s=1.5)
                ...
                c(ge.fit, alpha.fit, alpha.fit, A.fit, k.fit, s=1.5)}, 
          ...
          start = if(Mod.Sel1 %in% c(1)) {
            c(ge.fit, A.fit, k.fit, p=0.1, s=1.5)
              ...
              c(ge.fit, alpha.fit, A.fit, k.fit, p=0.1, s=1.5)
                ...
                c(ge.fit, alpha.fit, alpha.fit, A.fit, k.fit, p=0.1, s=1.5)}, 
          weights = G_255$nls_weights.2))
 )
## end MODEL FITTING 2 ----------------------------------------------------------------------- ##
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "255",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "255",]$tau.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "255",]$alpha.variance <- vcov(get(paste("nls_255.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "255",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "255",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "255",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_255.3") & exists("nls_255.4")){
  print(anova(nls_255.3, nls_255.4))
} 


## AIC comparison
AIC3_255 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "255",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "255",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "255",]$tau.variance <- vcov(get(paste("nls_255.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "255",]$alpha.variance <- vcov(get(paste("nls_255.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_255.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_255.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_261.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "261",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "261",]$tau.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "261",]$alpha.variance <- vcov(get(paste("nls_261.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "261",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "261",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "261",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_261.3") & exists("nls_261.4")){
  print(anova(nls_261.3, nls_261.4))
} 

## AIC comparison
AIC3_261 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "261",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "261",]$Best.Mod <- Mod.Sel3


## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "261",]$tau.variance <- vcov(get(paste("nls_261.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "261",]$alpha.variance <- vcov(get(paste("nls_261.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_261.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_261.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_262.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "262",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "262",]$tau.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "262",]$alpha.variance <- vcov(get(paste("nls_262.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "262",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "262",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "262",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_262.3") & exists("nls_262.4")){
  print(anova(nls_262.3, nls_262.4))
} 

## AIC comparison
AIC3_262 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "262",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "262",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "262",]$tau.variance <- vcov(get(paste("nls_262.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "262",]$alpha.variance <- vcov(get(paste("nls_262.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_262.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_262.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_263.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "263",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "263",]$tau.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "263",]$alpha.variance <- vcov(get(paste("nls_263.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "263",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "263",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "263",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_263.3") & exists("nls_263.4")){
  print(anova(nls_263.3, nls_263.4))
} 

## AIC comparison
AIC3_263 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "263",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "263",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "263",]$tau.variance <- vcov(get(paste("nls_263.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "263",]$alpha.variance <- vcov(get(paste("nls_263.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_263.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_263.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_313.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "313",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "313",]$tau.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "313",]$alpha.variance <- vcov(get(paste("nls_313.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "313",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "313",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "313",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_313.3") & exists("nls_313.4")){
  print(anova(nls_313.3, nls_313.4))
} 

## AIC comparison
AIC3_313 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "313",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "313",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "313",]$tau.variance <- vcov(get(paste("nls_313.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "313",]$alpha.variance <- vcov(get(paste("nls_313.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_313.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_313.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_315.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "315",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "315",]$tau.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "315",]$alpha.variance <- vcov(get(paste("nls_315.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Code == "315",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "315",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "315",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_315.3") & exists("nls_315.4") ){
  print(anova(nls_315.3, nls_315.4))
} 

## AIC comparison
AIC3_315 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "315",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "315",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "315",]$tau.variance <- vcov(get(paste("nls_315.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "315",]$alpha.variance <- vcov(get(paste("nls_315.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_315.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_315.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_321.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "321",]$Sel.Mod.2 <- Mod.Sel2
...
nls.param.df[nls.param.df$Code == "321",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "321",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "321",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_321.3") & exists("nls_321.4")){
  print(anova(nls_321.3, nls_321.4))
} 

## AIC comparison
AIC3_321 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "321",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "321",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "321",]$tau.variance <- vcov(get(paste("nls_321.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "321",]$alpha.variance <- vcov(get(paste("nls_321.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_321.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_321.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_322.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "322",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "322",]$tau.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "322",]$alpha.variance <- vcov(get(paste("nls_322.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "322",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "322",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "322",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_322.3") & exists("nls_322.4")){
  print(anova(nls_322.3, nls_322.4))
} 

## AIC comparison
AIC3_322 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "322",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "322",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "322",]$tau.variance <- vcov(get(paste("nls_322.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "322",]$alpha.variance <- vcov(get(paste("nls_322.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_322.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_321.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_331.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "331",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "331",]$tau.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "331",]$alpha.variance <- vcov(get(paste("nls_331.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "331",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "331",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "331",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_331.3") & exists("nls_331.4")){
  print(anova(nls_331.3, nls_331.4))
} 


## AIC comparison
AIC3_331 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "331",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "331",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "331",]$tau.variance <- vcov(get(paste("nls_331.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "331",]$alpha.variance <- vcov(get(paste("nls_331.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_331.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_331.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_332.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "332",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "332",]$tau.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "332",]$alpha.variance <- vcov(get(paste("nls_332.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "332",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "332",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "332",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_332.3") & exists("nls_332.4")){
  print(anova(nls_332.3, nls_332.4))
} 

## AIC comparison
AIC3_332 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "332",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "332",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "332",]$tau.variance <- vcov(get(paste("nls_332.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "332",]$alpha.variance <- vcov(get(paste("nls_332.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_332.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_332.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_341.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "341",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "341",]$tau.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "341",]$alpha.variance <- vcov(get(paste("nls_341.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "341",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "341",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "341",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_341.3") & exists("nls_341.4")){
  print(anova(nls_341.3, nls_341.4))
} 

## AIC comparison
AIC3_341 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "341",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "341",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "341",]$tau.variance <- vcov(get(paste("nls_341.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "341",]$alpha.variance <- vcov(get(paste("nls_341.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_341.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_341.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_342.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "342",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "342",]$tau.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "342",]$alpha.variance <- vcov(get(paste("nls_342.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "342",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "342",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "342",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_342.3") & exists("nls_342.4")){
  print(anova(nls_342.3, nls_342.4))
} 

## AIC comparison
AIC3_342 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "342",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "342",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "342",]$tau.variance <- vcov(get(paste("nls_342.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "342",]$alpha.variance <- vcov(get(paste("nls_342.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_342.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_342.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_411.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "411",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "411",]$tau.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "411",]$alpha.variance <- vcov(get(paste("nls_411.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "411",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "411",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "411",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_411.3") & exists("nls_411.4")){
  print(anova(nls_411.3, nls_411.4))
} 

## AIC comparison
AIC3_411 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "411",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "411",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "411",]$tau.variance <- vcov(get(paste("nls_411.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "411",]$alpha.variance <- vcov(get(paste("nls_411.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_411.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_411.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M211.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M211",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M211",]$tau.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M211",]$alpha.variance <- vcov(get(paste("nls_M211.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M211",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M211",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M211",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M211.3") & exists("nls_M211.4")){
  print(anova(nls_M211.3, nls_M211.4))
} 

## AIC comparison
AIC3_M211 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M211",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M211",]$tau.variance <- vcov(get(paste("nls_M211.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M211",]$alpha.variance <- vcov(get(paste("nls_M211.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M211.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M211.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M221.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M221",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M221",]$tau.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M221",]$alpha.variance <- vcov(get(paste("nls_M221.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M221",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M221",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M221",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M221.3") & exists("nls_M221.4")){
  print(anova(nls_M221.3, nls_M221.4))
} 

## AIC comparison
AIC3_M221 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M221",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M221",]$tau.variance <- vcov(get(paste("nls_M221.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M221",]$alpha.variance <- vcov(get(paste("nls_M221.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M221.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M221.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M223.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M223",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M223",]$tau.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M223",]$alpha.variance <- vcov(get(paste("nls_M223.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Code == "M223",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M223",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M223",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M223.3") & exists("nls_M223.4")){
  print(anova(nls_M223.3, nls_M223.4))
} 

## AIC comparison
AIC3_M223 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M223",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M223",]$tau.variance <- vcov(get(paste("nls_M223.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M223",]$alpha.variance <- vcov(get(paste("nls_M223.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M223.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M223.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M231.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M231",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M231",]$tau.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M231",]$alpha.variance <- vcov(get(paste("nls_M231.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M231",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M231",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M231",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M231.3") & exists("nls_M231.4")){
  print(anova(nls_M231.3, nls_M231.4))
} 
## AIC comparison
AIC3_M231 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M231",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M231",]$tau.variance <- vcov(get(paste("nls_M231.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M231",]$alpha.variance <- vcov(get(paste("nls_M231.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M231.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M231.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M242.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M242",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M242",]$tau.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M242",]$alpha.variance <- vcov(get(paste("nls_M242.",  Mod.Sel2, sep ="")))["alpha","alpha"]

nls.param.df[nls.param.df$Code == "M242",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M242",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M242",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M242.3") & exists("nls_M242.4")){
  print(anova(nls_M242.3, nls_M242.4))
}

## AIC comparison
AIC3_M242 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M242",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M242",]$tau.variance <- vcov(get(paste("nls_M242.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M242",]$alpha.variance <- vcov(get(paste("nls_M242.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M242.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M242.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M261.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M261",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M261",]$tau.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M261",]$alpha.variance <- vcov(get(paste("nls_M261.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M261",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M261",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M261",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M261.3") & exists("nls_M261.4")){
  print(anova(nls_M261.3, nls_M261.4))
} 

## AIC comparison
AIC3_M261 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M261",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M261",]$tau.variance <- vcov(get(paste("nls_M261.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M261",]$alpha.variance <- vcov(get(paste("nls_M261.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M261.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M261.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M262.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M262",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M262",]$tau.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M262",]$alpha.variance <- vcov(get(paste("nls_M262.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M262",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M262",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M262",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M262.3") & exists("nls_M262.4")){
  print(anova(nls_M262.3, nls_M262.4))
} 

## AIC comparison
AIC3_M262 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M262",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M262",]$tau.variance <- vcov(get(paste("nls_M262.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M262",]$alpha.variance <- vcov(get(paste("nls_M262.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M262.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M262.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M313.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M313",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M313",]$tau.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M313",]$alpha.variance <- vcov(get(paste("nls_M313.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M313",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M313",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M313",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M313.3") & exists("nls_M313.4")){
  print(anova(nls_M313.3, nls_M313.4))
} 

## AIC comparison
AIC3_M313 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M313",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M313",]$tau.variance <- vcov(get(paste("nls_M313.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M313",]$alpha.variance <- vcov(get(paste("nls_M313.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M313.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M313.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M331.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M331",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M313",]$tau.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M331",]$alpha.variance <- vcov(get(paste("nls_M331.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M331",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M331",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M331",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M331.3") & exists("nls_M331.4")){
  print(anova(nls_M331.3, nls_M331.4))
} 

## AIC comparison
AIC3_M331 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M331",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M331",]$tau.variance <- vcov(get(paste("nls_M331.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M331",]$alpha.variance <- vcov(get(paste("nls_M331.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M331.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M331.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M332.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M332",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M332",]$tau.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M332",]$alpha.variance <- vcov(get(paste("nls_M332.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M332",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M332",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M332",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M332.3") & exists("nls_M332.4") ){
  print(anova(nls_M332.3, nls_M332.4))
} 

## AIC comparison
AIC3_M332 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M332",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M332",]$tau.variance <- vcov(get(paste("nls_M332.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M332",]$alpha.variance <- vcov(get(paste("nls_M332.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M332.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M332.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M333.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M333",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M333",]$tau.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M333",]$alpha.variance <- vcov(get(paste("nls_M333.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M333",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M333",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M333",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M333.3") & exists("nls_M333.4")){
  print(anova(nls_M333.3, nls_M333.4))
} 

## AIC comparison
AIC3_M333 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M333",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M333",]$tau.variance <- vcov(get(paste("nls_M333.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M333",]$alpha.variance <- vcov(get(paste("nls_M333.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M333.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M333.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M334.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M334",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M334",]$tau.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M334",]$alpha.variance <- vcov(get(paste("nls_M334.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M334",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M334",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M334",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M334.3") & exists("nls_M334.4")){
  print(anova(nls_M334.3, nls_M334.4))
} 

## AIC comparison
AIC3_M334 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M334",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M334",]$tau.variance <- vcov(get(paste("nls_M334.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M334",]$alpha.variance <- vcov(get(paste("nls_M334.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M334.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M334.4"), "fits", "does not fit")`
...
### define parameters from model selection 1
ge.fit <- round(coef(get(paste("nls_M341.",  Mod.Sel1, sep ="")))["tau"], 1)
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M341",]$Sel.Mod.2 <- Mod.Sel2
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M341",]$tau.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M341",]$alpha.variance <- vcov(get(paste("nls_M341.",  Mod.Sel2, sep ="")))["alpha","alpha"]


nls.param.df[nls.param.df$Code == "M341",]$tau <- coefs["tau"]
...
nls.param.df[nls.param.df$Code == "M341",]$tau.2.5 <- intervals_low["tau"]
...
nls.param.df[nls.param.df$Code == "M341",]$tau.97.5 <- intervals_high["tau"]
...
## test
if(exists("nls_M341.3") & exists("nls_M341.4")){
  print(anova(nls_M341.3, nls_M341.4))
} 

## AIC comparison
AIC3_M341 <- data.frame(model = c(Mod.Sel2, 3,4), AIC = c(
...
## best model -- write the best fitting model to Best_mods df
Best_mods.P[Best_mods.P$Code == "M341",]$Sel.Mod.3 <- Mod.Sel3
Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod <- Mod.Sel3
...
## get variance in ge, phi and alpha
nls.param.df[nls.param.df$Code == "M341",]$tau.variance <- vcov(get(paste("nls_M341.",  Mod.Sel3, sep ="")))["tau","tau"]
nls.param.df[nls.param.df$Code == "M341",]$alpha.variance <- vcov(get(paste("nls_M341.",  Mod.Sel3, sep ="")))["alpha","alpha"]
...
### summary 
* simple log-normal model: `r ifelse(exists("nls_M341.3"), "fits", "does not fit")`
* log-normal alpha model: `r ifelse(exists("nls_M341.4"), "fits", "does not fit")`
...
```{r}
## clean up the Best_mods.P dataframe
Best_mods.P$Code <- as.factor(Best_mods.P$Code)
Best_mods.P$Ecoregion <- as.factor(Best_mods.P$Ecoregion)

Best_mods.P$Sel.Mod.2 <- as.factor(Best_mods.P$Sel.Mod.2)
Best_mods.P$Sel.Mod.3 <- as.factor(Best_mods.P$Sel.Mod.3)
Best_mods.P$Best.Mod <- as.factor(Best_mods.P$Best.Mod)
...
vcov_list <- list(
  #### 211
  `211` = vcov(get(paste("nls_211.", Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod, sep =""))),
  ####  212
  `212` = vcov(get(paste("nls_212.", Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod, sep =""))),
  ####  221
  `221` = vcov(get(paste("nls_221.", Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod, sep =""))),
  ####  222
  `222` = vcov(get(paste("nls_222.", Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod, sep =""))),
  ####  223
  `223` = vcov(get(paste("nls_223.", Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod, sep =""))),
  ####  231
  `231` = vcov(get(paste("nls_231.", Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod, sep =""))),
  ####  232
  `232` = vcov(get(paste("nls_232.", Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod, sep =""))),
  ####  234
  `234` = vcov(get(paste("nls_234.", Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod, sep =""))),
  ####  251
  `251` = vcov(get(paste("nls_251.", Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod, sep =""))),
  ####  255
  `255` = vcov(get(paste("nls_255.", Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod, sep =""))),
  ####  263
  `263` = vcov(get(paste("nls_263.", Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod, sep =""))),
  ####  313
  `313` = vcov(get(paste("nls_313.", Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod, sep =""))),
  ####  331
  `331` = vcov(get(paste("nls_331.", Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod, sep =""))),
  ####  332
  `332` = vcov(get(paste("nls_332.", Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod, sep =""))),
  ####  M211
  `M211` = vcov(get(paste("nls_M211.", Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod, sep =""))),
  ####  M221
  `M221` = vcov(get(paste("nls_M221.", Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod, sep =""))),
  ####  M223
  `M223` = vcov(get(paste("nls_M223.", Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod, sep =""))),
  ####  M231
  `M231` = vcov(get(paste("nls_M231.", Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod, sep =""))),
  ####  M242
  `M242` = vcov(get(paste("nls_M242.", Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod, sep =""))),
  ####  M261
  `M261` = vcov(get(paste("nls_M261.", Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod, sep =""))),
  ####  M313
  `M313` = vcov(get(paste("nls_M313.", Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod, sep =""))),
  ####  M331
  `M331` = vcov(get(paste("nls_M331.", Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod, sep =""))),
  ####  M332
  `M332` = vcov(get(paste("nls_M332.", Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod, sep =""))),
  ####  M333
  `M333` = vcov(get(paste("nls_M333.", Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod, sep =""))),
  ####  M334
  `M334` = vcov(get(paste("nls_M334.", Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod, sep =""))),
  ####  M341
  `M341` = vcov(get(paste("nls_M341.", Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod, sep ="")))
...
```{r}
# https://rdrr.io/cran/eqs2lavaan/man/plotCov.html

## plot vcov function - taken from defunct eqs2lavaan package
plot.vcov <- function(cov, title) {
    V <- cov
    R <- cov2cor(V)
    V[lower.tri(V)] <- 0
    ...
    fields::image.plot(V + R, 
                       sub = "Correlation (Upper); Covariance (Lower)",
                       xaxt = "n", yaxt = "n", 
                       main = paste(title))
...
tiff("vcov_matrices.tiff", width = 20, height = 100, units= "cm", res =300, compression = "lzw")
par(mfrow = c(13,2), mar=c(5,5,1,1))
plot.vcov(vcov_list[["211"]], "211") ; plot.vcov(vcov_list[["212"]], "212")
plot.vcov(vcov_list[["221"]], "221") ; plot.vcov(vcov_list[["222"]], "222")
plot.vcov(vcov_list[["223"]], "223") ; plot.vcov(vcov_list[["231"]], "231")
plot.vcov(vcov_list[["232"]], "232") ; plot.vcov(vcov_list[["234"]], "234")
plot.vcov(vcov_list[["251"]], "251") ; plot.vcov(vcov_list[["255"]], "255")
plot.vcov(vcov_list[["263"]], "263") ; plot.vcov(vcov_list[["313"]], "313")
plot.vcov(vcov_list[["331"]], "331") ; plot.vcov(vcov_list[["332"]], "332")

plot.vcov(vcov_list[["M211"]], "M211") ; plot.vcov(vcov_list[["M221"]], "M221")
plot.vcov(vcov_list[["M223"]], "M223") ; plot.vcov(vcov_list[["M231"]], "M231")
plot.vcov(vcov_list[["M242"]], "M242") ; plot.vcov(vcov_list[["M261"]], "M261")
plot.vcov(vcov_list[["M313"]], "M313") ; plot.vcov(vcov_list[["M331"]], "M331")
plot.vcov(vcov_list[["M332"]], "M332") ; plot.vcov(vcov_list[["M333"]], "M333")
plot.vcov(vcov_list[["M334"]], "M334") ; plot.vcov(vcov_list[["M341"]], "M341")
dev.off()
```
...
plot.COR <- function(cov, title) {
    R <- cov2cor(cov)
    fields::image.plot(R, 
                       xaxt = "n", yaxt = "n", 
                       main = paste(title), 
                       zlim=c(-1,1))
    axis(2, at = seq(0, 1, 1/((dim(R)[1]) - 1)), labels = rownames(R), 
        las = 2)
    axis(1, at = seq(0, 1, 1/((dim(R)[1]) - 1)), labels = rownames(R), 
        las = 2)
}
...
```{r}
tiff("parameterCOR_matrices_Biomass_Age.tiff", width = 20, height = 100, units= "cm", res =300, compression = "lzw")
par(mfrow = c(13,2), mar=c(5,5,1,1))
plot.COR(vcov_list[["211"]], "211") ; plot.COR(vcov_list[["212"]], "212")
plot.COR(vcov_list[["221"]], "221") ; plot.COR(vcov_list[["222"]], "222")
plot.COR(vcov_list[["223"]], "223") ; plot.COR(vcov_list[["231"]], "231")
plot.COR(vcov_list[["232"]], "232") ; plot.COR(vcov_list[["234"]], "234")
plot.COR(vcov_list[["251"]], "251") ; plot.COR(vcov_list[["255"]], "255")
plot.COR(vcov_list[["263"]], "263") ; plot.COR(vcov_list[["313"]], "313")
plot.COR(vcov_list[["331"]], "331") ; plot.COR(vcov_list[["332"]], "332")

plot.COR(vcov_list[["M211"]], "M211") ; plot.COR(vcov_list[["M221"]], "M221")
plot.COR(vcov_list[["M223"]], "M223") ; plot.COR(vcov_list[["M231"]], "M231")
plot.COR(vcov_list[["M242"]], "M242") ; plot.COR(vcov_list[["M261"]], "M261")
plot.COR(vcov_list[["M313"]], "M313") ; plot.COR(vcov_list[["M331"]], "M331")
plot.COR(vcov_list[["M332"]], "M332") ; plot.COR(vcov_list[["M333"]], "M333")
plot.COR(vcov_list[["M334"]], "M334") ; plot.COR(vcov_list[["M341"]], "M341")
dev.off()
```
...
## order data
nls.param.df$Ecoregion<- factor(nls.param.df$Ecoregion, levels = nls.param.df[rev(order(nls.param.df$tau)), "Ecoregion"])

library(ggplot2)

#### create color vector 
col_vec.tau <- rep(NA, length(nls.param.df$tau))

for (i in 1:length(nls.param.df$tau)) {
  if(is.na(nls.param.df$tau[i])){
     col_vec.tau[i] <-  "white"
  } else if(nls.param.df$tau.2.5[i]>0) {
       col_vec.tau[i] <- scales::muted("green")  
    } else if(nls.param.df$tau.97.5[i]<0){
...
tau_df <-  data.frame( ECOPROVCD = as.factor(c(nls.param.df$Code,"Water")), tau = as.numeric(c(nls.param.df[,"tau"], NA)))
...
N <- sum(nls.param.df$`n.plots`)

## add weights 
nls.param.df$weight.sq <- (nls.param.df$n.plots / N)^2


weighted.tau.df <-  data.frame(
  region = c("entire US", "pacific",  "east", "interior west"),
## all
  "weighted ge" = c(sum(nls.param.df$tau*nls.param.df$n.plots, na.rm = T) / N,
                    
## pacific
sum(nls.param.df[nls.param.df$region == "pacific",]$tau * nls.param.df[nls.param.df$region == "pacific",]$n.plots, na.rm = T) / N,

## east 
sum(nls.param.df[nls.param.df$region == "east",]$tau * nls.param.df[nls.param.df$region == "east",]$n.plots, na.rm = T) / N,

## west
sum(nls.param.df[nls.param.df$region == "interior west",]$tau * nls.param.df[nls.param.df$region == "interior west",]$n.plots, na.rm = T) / N),
...
## all
  "weighted.tau.std_Error" = c(
    sqrt(sum(nls.param.df$tau.variance * nls.param.df$weight.sq, na.rm = T)),
    
## pacific
sqrt(sum(nls.param.df[nls.param.df$region == "pacific",]$tau.variance * nls.param.df[nls.param.df$region == "pacific",]$weight.sq, na.rm = T)),
                               
## east
sqrt(sum(nls.param.df[nls.param.df$region == "east",]$tau.variance * nls.param.df[nls.param.df$region == "east",]$weight.sq, na.rm = T)),

## west
sqrt(sum(nls.param.df[nls.param.df$region == "interior west",]$tau.variance * nls.param.df[nls.param.df$region == "interior west",]$weight.sq, na.rm = T)))

)

weighted.tau.df$`95 % CI, upper` <-  weighted.tau.df$weighted.ge + 1.96* weighted.tau.df$weighted.tau.std_Error

weighted.tau.df$`95 % CI, lower` <-  weighted.tau.df$weighted.ge - 1.96* weighted.tau.df$weighted.tau.std_Error
...
weighted.alpha.df <-  data.frame(
  region = c("entire US", "pacific", "east", "interior west"),
## all
  "weighted alpha" = c(sum(nls.param.df$alpha * nls.param.df$n.plots, na.rm = T) / N,
                    
## pacific
sum(nls.param.df[nls.param.df$region == "pacific",]$alpha * nls.param.df[nls.param.df$region == "pacific",]$n.plots, na.rm = T) / N,

## east 
sum(nls.param.df[nls.param.df$region == "east",]$alpha * nls.param.df[nls.param.df$region == "east",]$n.plots, na.rm = T) / N,

## west
sum(nls.param.df[nls.param.df$region == "interior west",]$alpha * nls.param.df[nls.param.df$region == "interior west",]$n.plots, na.rm = T) / N),
...
## all
  "weighted.alpha.std_Error" = c(
    sqrt(sum(nls.param.df$alpha.variance * nls.param.df$weight.sq, na.rm = T)) / N,
    
## pacific
sqrt(sum(nls.param.df[nls.param.df$region == "pacific",]$alpha.variance * nls.param.df[nls.param.df$region == "pacific",]$weight.sq, na.rm = T)),
                               
## east
sqrt(sum(nls.param.df[nls.param.df$region == "east",]$alpha.variance * nls.param.df[nls.param.df$region == "east",]$weight.sq, na.rm = T)),

## west
sqrt(sum(nls.param.df[nls.param.df$region == "interior west",]$alpha.variance * nls.param.df[nls.param.df$region == "interior west",]$weight.sq, na.rm = T)))
...
```{r}
### Calculate DeltaB_total  -- the differnce btween t2 and t2 B_plot

#### 211
G_211$DeltaB_total <- (G_211$B_plt_t2_MgHa - G_211$B_plt_t1_MgHa) / G_211$MEASTIME_REMPER
####  212
G_212$DeltaB_total <- (G_212$B_plt_t2_MgHa - G_212$B_plt_t1_MgHa) / G_212$MEASTIME_REMPER
####  221
G_221$DeltaB_total <- (G_221$B_plt_t2_MgHa - G_221$B_plt_t1_MgHa) / G_221$MEASTIME_REMPER
####  222
G_222$DeltaB_total <- (G_222$B_plt_t2_MgHa - G_222$B_plt_t1_MgHa) / G_222$MEASTIME_REMPER
####  223
G_223$DeltaB_total <- (G_223$B_plt_t2_MgHa - G_223$B_plt_t1_MgHa) / G_223$MEASTIME_REMPER
####  231
G_231$DeltaB_total <- (G_231$B_plt_t2_MgHa - G_231$B_plt_t1_MgHa) / G_231$MEASTIME_REMPER
####  232
G_232$DeltaB_total <- (G_232$B_plt_t2_MgHa - G_232$B_plt_t1_MgHa) / G_232$MEASTIME_REMPER
####  234
G_234$DeltaB_total <- (G_234$B_plt_t2_MgHa - G_234$B_plt_t1_MgHa) / G_234$MEASTIME_REMPER
####  251
G_251$DeltaB_total <- (G_251$B_plt_t2_MgHa - G_251$B_plt_t1_MgHa) / G_251$MEASTIME_REMPER
####  255
G_255$DeltaB_total <- (G_255$B_plt_t2_MgHa - G_255$B_plt_t1_MgHa) / G_255$MEASTIME_REMPER
####  263
G_263$DeltaB_total <- (G_263$B_plt_t2_MgHa - G_263$B_plt_t1_MgHa) / G_263$MEASTIME_REMPER
####  313
G_313$DeltaB_total <- (G_313$B_plt_t2_MgHa - G_313$B_plt_t1_MgHa) / G_313$MEASTIME_REMPER
####  331
G_331$DeltaB_total <- (G_331$B_plt_t2_MgHa - G_331$B_plt_t1_MgHa) / G_331$MEASTIME_REMPER
####  332
G_332$DeltaB_total <- (G_332$B_plt_t2_MgHa - G_332$B_plt_t1_MgHa) / G_332$MEASTIME_REMPER
####  M211
G_M211$DeltaB_total <- (G_M211$B_plt_t2_MgHa - G_M211$B_plt_t1_MgHa) / G_M211$MEASTIME_REMPER
####  M221
G_M221$DeltaB_total <- (G_M221$B_plt_t2_MgHa - G_M221$B_plt_t1_MgHa) / G_M221$MEASTIME_REMPER
####  M223
G_M223$DeltaB_total <- (G_M223$B_plt_t2_MgHa - G_M223$B_plt_t1_MgHa) / G_M223$MEASTIME_REMPER
####  M231
G_M231$DeltaB_total <- (G_M231$B_plt_t2_MgHa - G_M231$B_plt_t1_MgHa) / G_M231$MEASTIME_REMPER
####  M242
G_M242$DeltaB_total <- (G_M242$B_plt_t2_MgHa - G_M242$B_plt_t1_MgHa) / G_M242$MEASTIME_REMPER
####  M261
G_M261$DeltaB_total <- (G_M261$B_plt_t2_MgHa - G_M261$B_plt_t1_MgHa) / G_M261$MEASTIME_REMPER
####  M313
G_M313$DeltaB_total <- (G_M313$B_plt_t2_MgHa - G_M313$B_plt_t1_MgHa) / G_M313$MEASTIME_REMPER
####  M331
G_M331$DeltaB_total <- (G_M331$B_plt_t2_MgHa - G_M331$B_plt_t1_MgHa) / G_M331$MEASTIME_REMPER
####  M332
G_M332$DeltaB_total <- (G_M332$B_plt_t2_MgHa - G_M332$B_plt_t1_MgHa) / G_M332$MEASTIME_REMPER
####  M333
G_M333$DeltaB_total <- (G_M333$B_plt_t2_MgHa - G_M333$B_plt_t1_MgHa) / G_M333$MEASTIME_REMPER
####  M334
G_M334$DeltaB_total <- (G_M334$B_plt_t2_MgHa - G_M334$B_plt_t1_MgHa) / G_M334$MEASTIME_REMPER
####  M341
G_M341$DeltaB_total <- (G_M341$B_plt_t2_MgHa - G_M341$B_plt_t1_MgHa) / G_M341$MEASTIME_REMPER
```
...
if(!Best_mods.P[Best_mods.P$Code == "211",]$Best.Mod == "NA"){
    
    G_211$B_pred_age2 <- predict(get(paste("nls_211.",  Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_211$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_211$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_211$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_211$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_211$B_L_prop, na.rm = T), length(G_211$pltID)))
                                      } )
    
    G_211$B_pred_age1 <- predict(get(paste("nls_211.",  Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_211$MEASTIME_t1_filled_filled,
...
if(!Best_mods.P[Best_mods.P$Code == "212",]$Best.Mod == "NA"){
    
    G_212$B_pred_age2 <- predict(get(paste("nls_212.",  Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_212$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_212$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_212$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_212$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_212$B_L_prop, na.rm = T), length(G_212$pltID)))
                                      } )
    
    G_212$B_pred_age1 <- predict(get(paste("nls_212.",  Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_212$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_212$DeltaB_age <- (G_212$B_pred_age2 - G_212$B_pred_age1) / G_212$MEASTIME_REMPER
}

### 221

if(!Best_mods.P[Best_mods.P$Code == "221",]$Best.Mod == "NA"){
    
    G_221$B_pred_age2 <- predict(get(paste("nls_221.",  Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_221$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_221$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_221$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_221$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_221$B_L_prop, na.rm = T), length(G_221$pltID)))
                                      } )
    
    G_221$B_pred_age1 <- predict(get(paste("nls_221.",  Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_221$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_221$DeltaB_age <- (G_221$B_pred_age2 - G_221$B_pred_age1) / G_221$MEASTIME_REMPER
}

### 222

if(!Best_mods.P[Best_mods.P$Code == "222",]$Best.Mod == "NA"){
    
    G_222$B_pred_age2 <- predict(get(paste("nls_222.",  Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_222$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_222$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_222$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_222$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_222$B_L_prop, na.rm = T), length(G_222$pltID)))
                                      } )
    
    G_222$B_pred_age1 <- predict(get(paste("nls_222.",  Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_222$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_222$DeltaB_age <- (G_222$B_pred_age2 - G_222$B_pred_age1) / G_222$MEASTIME_REMPER
}

### 223

if(!Best_mods.P[Best_mods.P$Code == "223",]$Best.Mod == "NA"){
    
    G_223$B_pred_age2 <- predict(get(paste("nls_223.",  Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_223$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_223$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_223$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_223$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_223$B_L_prop, na.rm = T), length(G_223$pltID)))
                                      } )
    
    G_223$B_pred_age1 <- predict(get(paste("nls_223.",  Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_223$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_223$DeltaB_age <- (G_223$B_pred_age2 - G_223$B_pred_age1) / G_223$MEASTIME_REMPER
}

### 231

if(!Best_mods.P[Best_mods.P$Code == "231",]$Best.Mod == "NA"){
    
    G_231$B_pred_age2 <- predict(get(paste("nls_231.",  Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_231$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_231$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_231$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_231$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_231$B_L_prop, na.rm = T), length(G_231$pltID)))
                                      } )
    
    G_231$B_pred_age1 <- predict(get(paste("nls_231.",  Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_231$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_231$DeltaB_age <- (G_231$B_pred_age2 - G_231$B_pred_age1) / G_231$MEASTIME_REMPER
}

### 232

if(!Best_mods.P[Best_mods.P$Code == "232",]$Best.Mod == "NA"){
    
    G_232$B_pred_age2 <- predict(get(paste("nls_232.",  Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_232$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_232$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_232$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_232$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_232$B_L_prop, na.rm = T), length(G_232$pltID)))
                                      } )
    
    G_232$B_pred_age1 <- predict(get(paste("nls_232.",  Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_232$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_232$DeltaB_age <- (G_232$B_pred_age2 - G_232$B_pred_age1) / G_232$MEASTIME_REMPER
}

### 234

if(!Best_mods.P[Best_mods.P$Code == "234",]$Best.Mod == "NA"){
    
    G_234$B_pred_age2 <- predict(get(paste("nls_234.",  Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_234$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_234$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_234$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_234$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_234$B_L_prop, na.rm = T), length(G_234$pltID)))
                                      } )
    
    G_234$B_pred_age1 <- predict(get(paste("nls_234.",  Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_234$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_234$DeltaB_age <- (G_234$B_pred_age2 - G_234$B_pred_age1) / G_234$MEASTIME_REMPER
}

### 242

if(!Best_mods.P[Best_mods.P$Code == "242",]$Best.Mod == "NA"){
    
    G_242$B_pred_age2 <- predict(get(paste("nls_242.",  Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_242$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_242$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_242$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_242$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_242$B_L_prop, na.rm = T), length(G_242$pltID)))
                                      } )
    
    G_242$B_pred_age1 <- predict(get(paste("nls_242.",  Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_242$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_242$DeltaB_age <- (G_242$B_pred_age2 - G_242$B_pred_age1) / G_242$MEASTIME_REMPER
}

### 251

if(!Best_mods.P[Best_mods.P$Code == "251",]$Best.Mod == "NA"){
    
    G_251$B_pred_age2 <- predict(get(paste("nls_251.",  Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_251$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_251$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_251$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_251$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_251$B_L_prop, na.rm = T), length(G_251$pltID)))
                                      } )
    
    G_251$B_pred_age1 <- predict(get(paste("nls_251.",  Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_251$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_251$DeltaB_age <- (G_251$B_pred_age2 - G_251$B_pred_age1) / G_251$MEASTIME_REMPER
}

### 255

if(!Best_mods.P[Best_mods.P$Code == "255",]$Best.Mod == "NA"){
    
    G_255$B_pred_age2 <- predict(get(paste("nls_255.",  Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_255$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_255$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_255$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_255$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_255$B_L_prop, na.rm = T), length(G_255$pltID)))
                                      } )
    
    G_255$B_pred_age1 <- predict(get(paste("nls_255.",  Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_255$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_255$DeltaB_age <- (G_255$B_pred_age2 - G_255$B_pred_age1) / G_255$MEASTIME_REMPER
}

### 261
if(!Best_mods.P[Best_mods.P$Code == "261",]$Best.Mod == "NA"){
    
    G_261$B_pred_age2 <- predict(get(paste("nls_261.",  Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_261$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_261$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_261$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_261$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_261$B_L_prop, na.rm = T), length(G_261$pltID)))
                                      } )
    
    G_261$B_pred_age1 <- predict(get(paste("nls_261.",  Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_261$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_261$DeltaB_age <- (G_261$B_pred_age2 - G_261$B_pred_age1) / G_261$MEASTIME_REMPER
}

### 262
if(!Best_mods.P[Best_mods.P$Code == "262",]$Best.Mod == "NA"){
    
    G_262$B_pred_age2 <- predict(get(paste("nls_262.",  Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_262$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_262$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_262$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_262$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_262$B_L_prop, na.rm = T), length(G_262$pltID)))
                                      } )
    
    G_262$B_pred_age1 <- predict(get(paste("nls_262.",  Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_262$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_262$DeltaB_age <- (G_262$B_pred_age2 - G_262$B_pred_age1) / G_262$MEASTIME_REMPER
}

### 263

if(!Best_mods.P[Best_mods.P$Code == "263",]$Best.Mod == "NA"){
    
    G_263$B_pred_age2 <- predict(get(paste("nls_263.",  Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_263$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_263$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_263$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_263$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_263$B_L_prop, na.rm = T), length(G_263$pltID)))
                                      } )
    
    G_263$B_pred_age1 <- predict(get(paste("nls_263.",  Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_263$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_263$DeltaB_age <- (G_263$B_pred_age2 - G_263$B_pred_age1) / G_263$MEASTIME_REMPER
}

### 313

if(!Best_mods.P[Best_mods.P$Code == "313",]$Best.Mod == "NA"){
    
    G_313$B_pred_age2 <- predict(get(paste("nls_313.",  Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_313$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_313$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_313$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_313$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_313$B_L_prop, na.rm = T), length(G_313$pltID)))
                                      } )
    
    G_313$B_pred_age1 <- predict(get(paste("nls_313.",  Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_313$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_313$DeltaB_age <- (G_313$B_pred_age2 - G_313$B_pred_age1) / G_313$MEASTIME_REMPER
}

### 315

if(!Best_mods.P[Best_mods.P$Code == "315",]$Best.Mod == "NA"){
    
    G_315$B_pred_age2 <- predict(get(paste("nls_315.",  Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_315$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_315$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_315$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_315$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_315$B_L_prop, na.rm = T), length(G_315$pltID)))
                                      } )
    
    G_315$B_pred_age1 <- predict(get(paste("nls_315.",  Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_315$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_315$DeltaB_age <- (G_315$B_pred_age2 - G_315$B_pred_age1) / G_315$MEASTIME_REMPER
}

### 321

if(!Best_mods.P[Best_mods.P$Code == "321",]$Best.Mod == "NA"){
    
    G_321$B_pred_age2 <- predict(get(paste("nls_321.",  Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_321$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_321$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_321$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_321$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_321$B_L_prop, na.rm = T), length(G_321$pltID)))
                                      } )
    
    G_321$B_pred_age1 <- predict(get(paste("nls_321.",  Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_321$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_321$DeltaB_age <- (G_321$B_pred_age2 - G_321$B_pred_age1) / G_321$MEASTIME_REMPER
}

### 322

if(!Best_mods.P[Best_mods.P$Code == "322",]$Best.Mod == "NA"){
    
    G_322$B_pred_age2 <- predict(get(paste("nls_322.",  Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_322$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_322$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_322$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_322$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_322$B_L_prop, na.rm = T), length(G_322$pltID)))
                                      }  )
    
    G_322$B_pred_age1 <- predict(get(paste("nls_322.",  Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_322$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_322$DeltaB_age <- (G_322$B_pred_age2 - G_322$B_pred_age1) / G_322$MEASTIME_REMPER
}

### 331

if(!Best_mods.P[Best_mods.P$Code == "331",]$Best.Mod == "NA"){
    
    G_331$B_pred_age2 <- predict(get(paste("nls_331.",  Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_331$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_331$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_331$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_331$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_331$B_L_prop, na.rm = T), length(G_331$pltID)))
                                      } )
    
    G_331$B_pred_age1 <- predict(get(paste("nls_331.",  Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_331$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_331$DeltaB_age <- (G_331$B_pred_age2 - G_331$B_pred_age1) / G_331$MEASTIME_REMPER
}

### 332

if(!Best_mods.P[Best_mods.P$Code == "332",]$Best.Mod == "NA"){
    
    G_332$B_pred_age2 <- predict(get(paste("nls_332.",  Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_332$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_332$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_332$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_332$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_332$B_L_prop, na.rm = T), length(G_332$pltID)))
                                      } )
    
    G_332$B_pred_age1 <- predict(get(paste("nls_332.",  Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_332$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_332$DeltaB_age <- (G_332$B_pred_age2 - G_332$B_pred_age1) / G_332$MEASTIME_REMPER
}

### 341

if(!Best_mods.P[Best_mods.P$Code == "341",]$Best.Mod == "NA"){
    
    G_341$B_pred_age2 <- predict(get(paste("nls_341.",  Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_341$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_341$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_341$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_341$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_341$B_L_prop, na.rm = T), length(G_341$pltID)))
                                      } )
    
    G_341$B_pred_age1 <- predict(get(paste("nls_341.",  Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_341$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_341$DeltaB_age <- (G_341$B_pred_age2 - G_341$B_pred_age1) / G_341$MEASTIME_REMPER
}

### 342

if(!Best_mods.P[Best_mods.P$Code == "342",]$Best.Mod == "NA"){
    
    G_342$B_pred_age2 <- predict(get(paste("nls_342.",  Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_342$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_342$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_342$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_342$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_342$B_L_prop, na.rm = T), length(G_342$pltID)))
                                      } )
    
    G_342$B_pred_age1 <- predict(get(paste("nls_342.",  Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_342$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_342$DeltaB_age <- (G_342$B_pred_age2 - G_342$B_pred_age1) / G_342$MEASTIME_REMPER
}

### 411

if(!Best_mods.P[Best_mods.P$Code == "411",]$Best.Mod == "NA"){
    
    G_411$B_pred_age2 <- predict(get(paste("nls_411.",  Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_411$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_411$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_411$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_411$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_411$B_L_prop, na.rm = T), length(G_411$pltID)))
                                      } )
    
    G_411$B_pred_age1 <- predict(get(paste("nls_411.",  Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_411$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_411$DeltaB_age <- (G_411$B_pred_age2 - G_411$B_pred_age1) / G_411$MEASTIME_REMPER
}

### M211

if(!Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod == "NA"){
    
    G_M211$B_pred_age2 <- predict(get(paste("nls_M211.",  Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M211$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M211$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M211$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M211$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M211$B_L_prop, na.rm = T), length(G_M211$pltID)))
                                      } )
    
    G_M211$B_pred_age1 <- predict(get(paste("nls_M211.",  Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M211$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M211$DeltaB_age <- (G_M211$B_pred_age2 - G_M211$B_pred_age1) / G_M211$MEASTIME_REMPER
}

### M221

if(!Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod == "NA"){
    
    G_M221$B_pred_age2 <- predict(get(paste("nls_M221.",  Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M221$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M221$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M221$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M221$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M221$B_L_prop, na.rm = T), length(G_M221$pltID)))
                                      } )
    
    G_M221$B_pred_age1 <- predict(get(paste("nls_M221.",  Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M221$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M221$STDAGE_t1)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M221$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M221$STDAGE_t1,
                                                 "B_L_prop" = rep(mean(G_M221$B_L_prop, na.rm = T), length(G_M221$pltID)))
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M221$DeltaB_age <- (G_M221$B_pred_age2 - G_M221$B_pred_age1) / G_M221$MEASTIME_REMPER
}

### M223

if(!Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod == "NA"){
    
    G_M223$B_pred_age2 <- predict(get(paste("nls_M223.",  Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M223$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M223$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M223$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M223$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M223$B_L_prop, na.rm = T), length(G_M223$pltID)))
                                      } )
    
    G_M223$B_pred_age1 <- predict(get(paste("nls_M223.",  Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M223$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M223$DeltaB_age <- (G_M223$B_pred_age2 - G_M223$B_pred_age1) / G_M223$MEASTIME_REMPER
}

### M231

if(!Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod == "NA"){
    
    G_M231$B_pred_age2 <- predict(get(paste("nls_M231.",  Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M231$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M231$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M231$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M231$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M231$B_L_prop, na.rm = T), length(G_M231$pltID)))
                                      } )
    
    G_M231$B_pred_age1 <- predict(get(paste("nls_M231.",  Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M231$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M231$DeltaB_age <- (G_M231$B_pred_age2 - G_M231$B_pred_age1) / G_M231$MEASTIME_REMPER
}

### M242

if(!Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod == "NA"){
    
    G_M242$B_pred_age2 <- predict(get(paste("nls_M242.",  Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M242$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M242$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M242$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M242$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M242$B_L_prop, na.rm = T), length(G_M242$pltID)))
                                      } )
    
    G_M242$B_pred_age1 <- predict(get(paste("nls_M242.",  Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M242$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M242$DeltaB_age <- (G_M242$B_pred_age2 - G_M242$B_pred_age1) / G_M242$MEASTIME_REMPER
}

### M261

if(!Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod == "NA"){
    
    G_M261$B_pred_age2 <- predict(get(paste("nls_M261.",  Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M261$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M261$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M261$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M261$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M261$B_L_prop, na.rm = T), length(G_M261$pltID)))
                                      } )
    
    G_M261$B_pred_age1 <- predict(get(paste("nls_M261.",  Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M261$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M261$DeltaB_age <- (G_M261$B_pred_age2 - G_M261$B_pred_age1) / G_M261$MEASTIME_REMPER
}

### M262

if(!Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod == "NA"){
    
    G_M262$B_pred_age2 <- predict(get(paste("nls_M262.",  Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M262$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M262$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M262$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M262$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M262$B_L_prop, na.rm = T), length(G_M262$pltID)))
                                      }  )
    
    G_M262$B_pred_age1 <- predict(get(paste("nls_M262.",  Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M262$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M262$DeltaB_age <- (G_M262$B_pred_age2 - G_M262$B_pred_age1) / G_M262$MEASTIME_REMPER
}

### M313

if(!Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod == "NA"){
    
    G_M313$B_pred_age2 <- predict(get(paste("nls_M313.",  Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M313$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M313$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M313$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M313$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M313$B_L_prop, na.rm = T), length(G_M313$pltID)))
                                      } )
    
    G_M313$B_pred_age1 <- predict(get(paste("nls_M313.",  Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M313$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M313$DeltaB_age <- (G_M313$B_pred_age2 - G_M313$B_pred_age1) / G_M313$MEASTIME_REMPER
}

### M331

if(!Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod == "NA"){
    
    G_M331$B_pred_age2 <- predict(get(paste("nls_M331.",  Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M331$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M331$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M331$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M331$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M331$B_L_prop, na.rm = T), length(G_M331$pltID)))
                                      } )
    
    G_M331$B_pred_age1 <- predict(get(paste("nls_M331.",  Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M331$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M331$DeltaB_age <- (G_M331$B_pred_age2 - G_M331$B_pred_age1) / G_M331$MEASTIME_REMPER
}

### M332

if(!Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod == "NA"){
    
    G_M332$B_pred_age2 <- predict(get(paste("nls_M332.",  Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M332$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M332$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M332$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M332$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M332$B_L_prop, na.rm = T), length(G_M332$pltID)))
                                      } )
    
    G_M332$B_pred_age1 <- predict(get(paste("nls_M332.",  Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M332$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M332$DeltaB_age <- (G_M332$B_pred_age2 - G_M332$B_pred_age1) / G_M332$MEASTIME_REMPER
}

### M333

if(!Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod == "NA"){
    
    G_M333$B_pred_age2 <- predict(get(paste("nls_M333.",  Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M333$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M333$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M333$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M333$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M333$B_L_prop, na.rm = T), length(G_M333$pltID)))
                                      } )
    
    G_M333$B_pred_age1 <- predict(get(paste("nls_M333.",  Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M333$MEASTIME_t1_filled,
                                      ...
                                      data.frame("MEASTIME_t2" =  G_M333$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M333$STDAGE_t1,
                                                 "B_L_prop" = rep(mean(G_M333$B_L_prop, na.rm = T), length(G_M333$pltID)))
                                      } else if (Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod %in% c(3,"3a","3b","3c",6)){
                                        data.frame("MEASTIME_t2" =  G_M333$MEASTIME_t1_filled,
                                                   "STDAGE_t2" =  G_M333$STDAGE_t1,
                                                   "B_L_prop" = rep(mean(G_M333$B_L_prop, na.rm = T), length(G_M333$pltID)),
                                                   "B_L_prop" = rep(mean(G_M333$B_L_prop, na.rm = T), length(G_M333$pltID)))
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M333$DeltaB_age <- (G_M333$B_pred_age2 - G_M333$B_pred_age1) / G_M333$MEASTIME_REMPER
}

### M334

if(!Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod == "NA"){
    
    G_M334$B_pred_age2 <- predict(get(paste("nls_M334.",  Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M334$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M334$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M334$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M334$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M334$B_L_prop, na.rm = T), length(G_M334$pltID)))
                                      } )
    
    G_M334$B_pred_age1 <- predict(get(paste("nls_M334.",  Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M334$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M334$DeltaB_age <- (G_M334$B_pred_age2 - G_M334$B_pred_age1) / G_M334$MEASTIME_REMPER
}

### M341

if(!Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod == "NA"){
    
    G_M341$B_pred_age2 <- predict(get(paste("nls_M341.",  Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M341$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M341$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M341$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M341$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M341$B_L_prop, na.rm = T), length(G_M341$pltID)))
                                      } )
    
    G_M341$B_pred_age1 <- predict(get(paste("nls_M341.",  Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M341$MEASTIME_t1_filled,
    ...
    # calculate delta-B due to delta STDAGE -- simple subtraction
    G_M341$DeltaB_age <- (G_M341$B_pred_age2 - G_M341$B_pred_age1) / G_M341$MEASTIME_REMPER
}

```

## 3. Delta-B due to Delta-Year (_ge_)
...
if(!Best_mods.P[Best_mods.P$Code == "211",]$Best.Mod == "NA"){
    ...
    G_211$B_pred_year1 <- predict(get(paste("nls_211.",  Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    G_211$B_pred_year2 <- predict(get(paste("nls_211.",  Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 211,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    G_211$DeltaB_year<- (G_211$B_pred_year2 - G_211$B_pred_year1) / G_211$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "212",]$Best.Mod == "NA"){
    ...
    G_212$B_pred_year1 <- predict(get(paste("nls_212.",  Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_212$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_212$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_212$B_pred_year2 <- predict(get(paste("nls_212.",  Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 212,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_212$DeltaB_year<- (G_212$B_pred_year2 - G_212$B_pred_year1) / G_212$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "221",]$Best.Mod == "NA"){
    ...
    G_221$B_pred_year1 <- predict(get(paste("nls_221.",  Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_221$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_221$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_221$B_pred_year2 <- predict(get(paste("nls_221.",  Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 221,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_221$DeltaB_year<- (G_221$B_pred_year2 - G_221$B_pred_year1) / G_221$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "222",]$Best.Mod == "NA"){
    ...
    G_222$B_pred_year1 <- predict(get(paste("nls_222.",  Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_222$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_222$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_222$B_pred_year2 <- predict(get(paste("nls_222.",  Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 222,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_222$DeltaB_year<- (G_222$B_pred_year2 - G_222$B_pred_year1) / G_222$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "223",]$Best.Mod == "NA"){
    ...
    G_223$B_pred_year1 <- predict(get(paste("nls_223.",  Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_223$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_223$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_223$B_pred_year2 <- predict(get(paste("nls_223.",  Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 223,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_223$DeltaB_year<- (G_223$B_pred_year2 - G_223$B_pred_year1) / G_223$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "231",]$Best.Mod == "NA"){
    ...
    G_231$B_pred_year1 <- predict(get(paste("nls_231.",  Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_231$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_231$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_231$B_pred_year2 <- predict(get(paste("nls_231.",  Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 231,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_231$DeltaB_year<- (G_231$B_pred_year2 - G_231$B_pred_year1) / G_231$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "232",]$Best.Mod == "NA"){
    ...
    G_232$B_pred_year1 <- predict(get(paste("nls_232.",  Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_232$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_232$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_232$B_pred_year2 <- predict(get(paste("nls_232.",  Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 232,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_232$DeltaB_year<- (G_232$B_pred_year2 - G_232$B_pred_year1) / G_232$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "234",]$Best.Mod == "NA"){
    ...
    G_234$B_pred_year1 <- predict(get(paste("nls_234.",  Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_234$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_234$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_234$B_pred_year2 <- predict(get(paste("nls_234.",  Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 234,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_234$DeltaB_year<- (G_234$B_pred_year2 - G_234$B_pred_year1) / G_234$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "242",]$Best.Mod == "NA"){
    ...
    G_242$B_pred_year1 <- predict(get(paste("nls_242.",  Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_242$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_242$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_242$B_pred_year2 <- predict(get(paste("nls_242.",  Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 242,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_242$DeltaB_year<- (G_242$B_pred_year2 - G_242$B_pred_year1) / G_242$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "251",]$Best.Mod == "NA"){
    ...
    G_251$B_pred_year1 <- predict(get(paste("nls_251.",  Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_251$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_251$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_251$B_pred_year2 <- predict(get(paste("nls_251.",  Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 251,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_251$DeltaB_year<- (G_251$B_pred_year2 - G_251$B_pred_year1) / G_251$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "255",]$Best.Mod == "NA"){
    ...
    G_255$B_pred_year1 <- predict(get(paste("nls_255.",  Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_255$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_255$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_255$B_pred_year2 <- predict(get(paste("nls_255.",  Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 255,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_255$DeltaB_year<- (G_255$B_pred_year2 - G_255$B_pred_year1) / G_255$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "261",]$Best.Mod == "NA"){
    ...
    G_261$B_pred_year1 <- predict(get(paste("nls_261.",  Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_261$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_261$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_261$B_pred_year2 <- predict(get(paste("nls_261.",  Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 261,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_261$DeltaB_year<- (G_261$B_pred_year2 - G_261$B_pred_year1) / G_261$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "262",]$Best.Mod == "NA"){
    ...
    G_262$B_pred_year1 <- predict(get(paste("nls_262.",  Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_262$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_262$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_262$B_pred_year2 <- predict(get(paste("nls_262.",  Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 262,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_262$DeltaB_year<- (G_262$B_pred_year2 - G_262$B_pred_year1) / G_262$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "263",]$Best.Mod == "NA"){
    ...
    G_263$B_pred_year1 <- predict(get(paste("nls_263.",  Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_263$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_263$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_263$B_pred_year2 <- predict(get(paste("nls_263.",  Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 263,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_263$DeltaB_year<- (G_263$B_pred_year2 - G_263$B_pred_year1) / G_263$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "313",]$Best.Mod == "NA"){
    ...
    G_313$B_pred_year1 <- predict(get(paste("nls_313.",  Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_313$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_313$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_313$B_pred_year2 <- predict(get(paste("nls_313.",  Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 313,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_313$DeltaB_year<- (G_313$B_pred_year2 - G_313$B_pred_year1) / G_313$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "315",]$Best.Mod == "NA"){
    ...
    G_315$B_pred_year1 <- predict(get(paste("nls_315.",  Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_315$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_315$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_315$B_pred_year2 <- predict(get(paste("nls_315.",  Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 315,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_315$DeltaB_year<- (G_315$B_pred_year2 - G_315$B_pred_year1) / G_315$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "321",]$Best.Mod == "NA"){
    ...
    G_321$B_pred_year1 <- predict(get(paste("nls_321.",  Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_321$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_321$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_321$B_pred_year2 <- predict(get(paste("nls_321.",  Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 321,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_321$DeltaB_year<- (G_321$B_pred_year2 - G_321$B_pred_year1) / G_321$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "322",]$Best.Mod == "NA"){
    ...
    G_322$B_pred_year1 <- predict(get(paste("nls_322.",  Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_322$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_322$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_322$B_pred_year2 <- predict(get(paste("nls_322.",  Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 322,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_322$DeltaB_year<- (G_322$B_pred_year2 - G_322$B_pred_year1) / G_322$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "331",]$Best.Mod == "NA"){
    ...
    G_331$B_pred_year1 <- predict(get(paste("nls_331.",  Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_331$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_331$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_331$B_pred_year2 <- predict(get(paste("nls_331.",  Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 331,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_331$DeltaB_year<- (G_331$B_pred_year2 - G_331$B_pred_year1) / G_331$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "332",]$Best.Mod == "NA"){
    ...
    G_332$B_pred_year1 <- predict(get(paste("nls_332.",  Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_332$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_332$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_332$B_pred_year2 <- predict(get(paste("nls_332.",  Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 332,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_332$DeltaB_year<- (G_332$B_pred_year2 - G_332$B_pred_year1) / G_332$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "341",]$Best.Mod == "NA"){
    ...
    G_341$B_pred_year1 <- predict(get(paste("nls_341.",  Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_341$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_341$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_341$B_pred_year2 <- predict(get(paste("nls_341.",  Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 341,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_341$DeltaB_year<- (G_341$B_pred_year2 - G_341$B_pred_year1) / G_341$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "342",]$Best.Mod == "NA"){
    ...
    G_342$B_pred_year1 <- predict(get(paste("nls_342.",  Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_342$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_342$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_342$B_pred_year2 <- predict(get(paste("nls_342.",  Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 342,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_342$DeltaB_year<- (G_342$B_pred_year2 - G_342$B_pred_year1) / G_342$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "411",]$Best.Mod == "NA"){
    ...
    G_411$B_pred_year1 <- predict(get(paste("nls_411.",  Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_411$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_411$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_411$B_pred_year2 <- predict(get(paste("nls_411.",  Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == 411,]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_411$DeltaB_year<- (G_411$B_pred_year2 - G_411$B_pred_year1) / G_411$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod == "NA"){
    ...
    G_M211$B_pred_year1 <- predict(get(paste("nls_M211.",  Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M211$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M211$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M211$B_pred_year2 <- predict(get(paste("nls_M211.",  Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M211",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M211$DeltaB_year<- (G_M211$B_pred_year2 - G_M211$B_pred_year1) / G_M211$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod == "NA"){
    ...
    G_M221$B_pred_year1 <- predict(get(paste("nls_M221.",  Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M221$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M221$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M221$B_pred_year2 <- predict(get(paste("nls_M221.",  Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M221$MEASTIME_t2,
                                               "STDAGE_t2" = G_M221$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M221",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M221$MEASTIME_t2,
                                                 "STDAGE_t2" =  G_M221$STDAGE_t2,
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M221$DeltaB_year<- (G_M221$B_pred_year2 - G_M221$B_pred_year1) / G_M221$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod == "NA"){
    ...
    G_M223$B_pred_year1 <- predict(get(paste("nls_M223.",  Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M223$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M223$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M223$B_pred_year2 <- predict(get(paste("nls_M223.",  Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M223",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M223$DeltaB_year<- (G_M223$B_pred_year2 - G_M223$B_pred_year1) / G_M223$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod == "NA"){
    ...
    G_M231$B_pred_year1 <- predict(get(paste("nls_M231.",  Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M231$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M231$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M231$B_pred_year2 <- predict(get(paste("nls_M231.",  Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M231",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M231$DeltaB_year<- (G_M231$B_pred_year2 - G_M231$B_pred_year1) / G_M231$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod == "NA"){
    ...
    G_M242$B_pred_year1 <- predict(get(paste("nls_M242.",  Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M242$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M242$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M242$B_pred_year2 <- predict(get(paste("nls_M242.",  Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M242",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M242$DeltaB_year<- (G_M242$B_pred_year2 - G_M242$B_pred_year1) / G_M242$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod == "NA"){
    ...
    G_M261$B_pred_year1 <- predict(get(paste("nls_M261.",  Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M261$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M261$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M261$B_pred_year2 <- predict(get(paste("nls_M261.",  Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M261",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M261$DeltaB_year<- (G_M261$B_pred_year2 - G_M261$B_pred_year1) / G_M261$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod == "NA"){
    ...
    G_M262$B_pred_year1 <- predict(get(paste("nls_M262.",  Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M262$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M262$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
                                      data.frame("MEASTIME_t2" =  G_M262$MEASTIME_t1_filled,
                                                 "STDAGE_t2" =  G_M262$STDAGE_t2,
                                                 "B_L_prop" = rep(mean(G_M262$B_L_prop, na.rm = T), length(G_M262$pltID)))
                                      } )
    
    G_M262$B_pred_year2 <- predict(get(paste("nls_M262.",  Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M262",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M262$DeltaB_year<- (G_M262$B_pred_year2 - G_M262$B_pred_year1) / G_M262$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod == "NA"){
    ...
    G_M313$B_pred_year1 <- predict(get(paste("nls_M313.",  Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M313$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M313$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M313$B_pred_year2 <- predict(get(paste("nls_M313.",  Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M313",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M313$DeltaB_year<- (G_M313$B_pred_year2 - G_M313$B_pred_year1) / G_M313$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod == "NA"){
    ...
    G_M331$B_pred_year1 <- predict(get(paste("nls_M331.",  Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M331$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M331$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M331$B_pred_year2 <- predict(get(paste("nls_M331.",  Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M331",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M331$DeltaB_year<- (G_M331$B_pred_year2 - G_M331$B_pred_year1) / G_M331$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod == "NA"){
    ...
    G_M332$B_pred_year1 <- predict(get(paste("nls_M332.",  Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M332$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M332$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M332$B_pred_year2 <- predict(get(paste("nls_M332.",  Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M332",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M332$DeltaB_year<- (G_M332$B_pred_year2 - G_M332$B_pred_year1) / G_M332$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod == "NA"){
    ...
    G_M333$B_pred_year1 <- predict(get(paste("nls_M333.",  Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M333$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M333$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M333$B_pred_year2 <- predict(get(paste("nls_M333.",  Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M333",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M333$DeltaB_year<- (G_M333$B_pred_year2 - G_M333$B_pred_year1) / G_M333$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod == "NA"){
    ...
    G_M334$B_pred_year1 <- predict(get(paste("nls_M334.",  Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M334$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M334$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M334$B_pred_year2 <- predict(get(paste("nls_M334.",  Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M334",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M334$DeltaB_year<- (G_M334$B_pred_year2 - G_M334$B_pred_year1) / G_M334$MEASTIME_REMPER
}
...
if(!Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod == "NA"){
    ...
    G_M341$B_pred_year1 <- predict(get(paste("nls_M341.",  Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
                                    data.frame("MEASTIME_t2" = G_M341$MEASTIME_t1_filled,
                                               "STDAGE_t2" = G_M341$STDAGE_t2)
                                    } else if (Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod %in% c(2,"2a","2b","2c",4)){
    ...
    G_M341$B_pred_year2 <- predict(get(paste("nls_M341.",  Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod, sep ="")),
                                  newdata = if(Best_mods.P[Best_mods.P$Code == "M341",]$Best.Mod %in% c(1,"1a","1b","1c",3)){
    ...
    # calculate delta-B due to year (ge) -- simple subtraction
    G_M341$DeltaB_year<- (G_M341$B_pred_year2 - G_M341$B_pred_year1) / G_M341$MEASTIME_REMPER
}
```
...
####### 01.11.2023
####################################################################
### equations for the DeltaBs

# DeltaB tau   = ( (c1 * f_bar(age) ) / 100 ) * tau      
# DeltaB B_L  =   (c2 * f_bar(age) )  * Beta_B_L * alpha

# note: by Ecoprovince
# note: f_bar is the mean of the fitted funtion for biomass~standage

####################################################################
## Define constants 
## these constants are used in the caluclation of the DeltaB

### tau constant
# c1 = (1 - alpha (mean(B_L))) 
### alpha constant
# c2 = (1 + tau/100*(mean(yr) - 1990))


# note: using ecoprov means

### make constants data.frame
ECOPROV_DeltaB_constants <- data.frame(
  Region = c("east", "east", "east", "east", "east", "east", "east", "east", 
             "east", "east", "pacific", "interior west", "interior west", "interior west", 
             "east", "east", "east", "east", "pacific", "pacific", "interior west", "interior west",
             "interior west", "interior west", "interior west", "interior west"),
   
  Ecoprovince = c("211", "212", "221", "222", "223", "231", "232", "234", 
                  "251", "255", "263", "313", "331", "332", "M211", "M221", 
                  "M223", "M231", "M242", "M261", "M313", "M331", "M332",
                  "M333", "M334", "M341"),
  
  ## c1: tau constant
  c1 = c(
    #### 211
    (1 - nls.param.df[nls.param.df$Code == "211", "alpha"] * mean(G_211$B_L_prop, na.rm = T)), 
    #### 212
    (1 - nls.param.df[nls.param.df$Code == "212", "alpha"] * mean(G_212$B_L_prop, na.rm = T)), 
    #### 221
    (1 - nls.param.df[nls.param.df$Code == "221", "alpha"] * mean(G_221$B_L_prop, na.rm = T)), 
    #### 222
    (1 - nls.param.df[nls.param.df$Code == "222", "alpha"] * mean(G_222$B_L_prop, na.rm = T)), 
    #### 223
    (1 - nls.param.df[nls.param.df$Code == "223", "alpha"] * mean(G_223$B_L_prop, na.rm = T)), 
    #### 231
    (1 - nls.param.df[nls.param.df$Code == "231", "alpha"] * mean(G_231$B_L_prop, na.rm = T)), 
    #### 232
    (1 - nls.param.df[nls.param.df$Code == "232", "alpha"] * mean(G_232$B_L_prop, na.rm = T)), 
    #### 234
    (1 - nls.param.df[nls.param.df$Code == "234", "alpha"] * mean(G_234$B_L_prop, na.rm = T)), 
    #### 251
    (1 - nls.param.df[nls.param.df$Code == "251", "alpha"] * mean(G_251$B_L_prop, na.rm = T)), 
    #### 255
    (1 - nls.param.df[nls.param.df$Code == "255", "alpha"] * mean(G_255$B_L_prop, na.rm = T)), 
    #### 263
    (1 - nls.param.df[nls.param.df$Code == "263", "alpha"] * mean(G_263$B_L_prop, na.rm = T)), 
    #### 313
    (1 - nls.param.df[nls.param.df$Code == "313", "alpha"] * mean(G_313$B_L_prop, na.rm = T)), 
    #### 331
    (1 - nls.param.df[nls.param.df$Code == "331", "alpha"] * mean(G_331$B_L_prop, na.rm = T)), 
    #### 332
    (1 - nls.param.df[nls.param.df$Code == "332", "alpha"] * mean(G_332$B_L_prop, na.rm = T)), 
    #### M211
    (1 - nls.param.df[nls.param.df$Code == "M211", "alpha"] * mean(G_M211$B_L_prop, na.rm = T)), 
    #### M221
    (1 - nls.param.df[nls.param.df$Code == "M221", "alpha"] * mean(G_221$B_L_prop, na.rm = T)), 
    #### M223
    (1 - nls.param.df[nls.param.df$Code == "M223", "alpha"] * mean(G_223$B_L_prop, na.rm = T)), 
    #### M231
    (1 - nls.param.df[nls.param.df$Code == "M231", "alpha"] * mean(G_M231$B_L_prop, na.rm = T)), 
    #### M242
    (1 - nls.param.df[nls.param.df$Code == "M242", "alpha"] * mean(G_M242$B_L_prop, na.rm = T)), 
    #### M261
    (1 - nls.param.df[nls.param.df$Code == "M261", "alpha"] * mean(G_M261$B_L_prop, na.rm = T)), 
    #### M313
    (1 - nls.param.df[nls.param.df$Code == "M313", "alpha"] * mean(G_M313$B_L_prop, na.rm = T)), 
    #### M331
    (1 - nls.param.df[nls.param.df$Code == "M331", "alpha"] * mean(G_M331$B_L_prop, na.rm = T)), 
    #### M332
    (1 - nls.param.df[nls.param.df$Code == "M332", "alpha"] * mean(G_M332$B_L_prop, na.rm = T)), 
    #### M333
    (1 - nls.param.df[nls.param.df$Code == "M333", "alpha"] * mean(G_M333$B_L_prop, na.rm = T)), 
    #### M334
    (1 - nls.param.df[nls.param.df$Code == "M334", "alpha"] * mean(G_M334$B_L_prop, na.rm = T)), 
    #### M341
    (1 - nls.param.df[nls.param.df$Code == "M341", "alpha"] * mean(G_M341$B_L_prop, na.rm = T))
  ), 
  
  ## c2: B_L constant
  c2 = c(
    #### 211
    (1 + nls.param.df[nls.param.df$Code == "211", "tau"] / 100 * (mean(G_211$MEASTIME_t2) - 1990)), 
    #### 212
    (1 + nls.param.df[nls.param.df$Code == "212", "tau"] / 100 * (mean(G_212$MEASTIME_t2) - 1990)), 
    #### 221
    (1 + nls.param.df[nls.param.df$Code == "221", "tau"] / 100 * (mean(G_221$MEASTIME_t2) - 1990)), 
    #### 222
    (1 + nls.param.df[nls.param.df$Code == "222", "tau"] / 100 * (mean(G_222$MEASTIME_t2) - 1990)), 
    #### 223
    (1 + nls.param.df[nls.param.df$Code == "223", "tau"] / 100 * (mean(G_223$MEASTIME_t2) - 1990)), 
    #### 231
    (1 + nls.param.df[nls.param.df$Code == "231", "tau"] / 100 * (mean(G_231$MEASTIME_t2) - 1990)), 
    #### 232
    (1 + nls.param.df[nls.param.df$Code == "232", "tau"] / 100 * (mean(G_232$MEASTIME_t2) - 1990)), 
    #### 234
    (1 + nls.param.df[nls.param.df$Code == "234", "tau"] / 100 * (mean(G_234$MEASTIME_t2) - 1990)), 
    #### 251
    (1 + nls.param.df[nls.param.df$Code == "251", "tau"] / 100 * (mean(G_251$MEASTIME_t2) - 1990)), 
    #### 255
    (1 + nls.param.df[nls.param.df$Code == "255", "tau"] / 100 * (mean(G_255$MEASTIME_t2) - 1990)), 
    #### 263
    (1 + nls.param.df[nls.param.df$Code == "263", "tau"] / 100 * (mean(G_263$MEASTIME_t2) - 1990)), 
    #### 313
    (1 + nls.param.df[nls.param.df$Code == "313", "tau"] / 100 * (mean(G_313$MEASTIME_t2) - 1990)), 
    #### 331
    (1 + nls.param.df[nls.param.df$Code == "331", "tau"] / 100 * (mean(G_331$MEASTIME_t2) - 1990)), 
    #### 332
    (1 + nls.param.df[nls.param.df$Code == "332", "tau"] / 100 * (mean(G_332$MEASTIME_t2) - 1990)), 
    #### M211
    (1 + nls.param.df[nls.param.df$Code == "M211", "tau"] / 100 * (mean(G_M211$MEASTIME_t2) - 1990)) , 
    #### M221
    (1 + nls.param.df[nls.param.df$Code == "M221", "tau"] / 100 * (mean(G_M221$MEASTIME_t2) - 1990)), 
    #### M223
    (1 + nls.param.df[nls.param.df$Code == "M223", "tau"] / 100 * (mean(G_M223$MEASTIME_t2) - 1990)), 
    #### M231
    (1 + nls.param.df[nls.param.df$Code == "M231", "tau"] / 100 * (mean(G_M231$MEASTIME_t2) - 1990)), 
    #### M242
    (1 + nls.param.df[nls.param.df$Code == "M242", "tau"] / 100 * (mean(G_M242$MEASTIME_t2) - 1990)) , 
    #### M261
    (1 + nls.param.df[nls.param.df$Code == "M261", "tau"] / 100 * (mean(G_M261$MEASTIME_t2) - 1990)), 
    #### M313
    (1 + nls.param.df[nls.param.df$Code == "M313", "tau"] / 100 * (mean(G_M313$MEASTIME_t2) - 1990)), 
    #### M331
    (1 + nls.param.df[nls.param.df$Code == "M331", "tau"] / 100 * (mean(G_M331$MEASTIME_t2) - 1990)) , 
    #### M332
    (1 + nls.param.df[nls.param.df$Code == "M332", "tau"] / 100 * (mean(G_M332$MEASTIME_t2) - 1990)) , 
    #### M333
    (1 + nls.param.df[nls.param.df$Code == "M333", "tau"] / 100 * (mean(G_M333$MEASTIME_t2) - 1990)), 
    #### M334
    (1 + nls.param.df[nls.param.df$Code == "M334", "tau"] / 100 * (mean(G_M334$MEASTIME_t2) - 1990)), 
    #### M341
    (1 + nls.param.df[nls.param.df$Code == "M341", "tau"] / 100 * (mean(G_M341$MEASTIME_t2) - 1990))
  ) 
)  
```

```{r, warning = F}
### FUNCTION: solve for f(age)

## USED DOWNSTREAM to for to predict DELTAB--B_L and DELTAB--DeltaPDSI

### write function to predict f.age
predict_f.age <- function(ecoprov, data){
  ## get model
  mod <- get(paste("nls_", ecoprov, ".",  Best_mods.P[Best_mods.P$Code == paste(ecoprov),]$Best.Mod, sep =""))
  mod.num <-  Best_mods.P[Best_mods.P$Code == paste(ecoprov),]$Best.Mod
  parameters <- summary(mod)$param
  ### if loop to solve function given STDAGE_t2 data
  if (mod.num == 4) {
    a = parameters["a","Estimate"]
    b = parameters["b","Estimate"]
    c = parameters["c","Estimate"]
    d = parameters["d","Estimate"]
    B_pred <- (a+b*exp(-((log(data$STDAGE_t2/c))/d)^2))
  } else if (mod.num == 2) {
    A = parameters["A","Estimate"]
    k = parameters["k","Estimate"]
    B_pred <- A*data$STDAGE_t2 / (k+data$STDAGE_t2)
  } else if (mod.num == "2a") {
    A = parameters["A","Estimate"]
    k = parameters["k","Estimate"]
    p = parameters["p","Estimate"]
    B_pred <- (p*A+((1-p)*A*data$STDAGE_t2/(k+data$STDAGE_t2)))
  } else if (mod.num == "2b") {
    A = parameters["A","Estimate"]
    k = parameters["k","Estimate"]
    s = parameters["s","Estimate"]
    B_pred <- (A*data$STDAGE_t2^s/(k^s+data$STDAGE_t2^s))
  } else if (mod.num == "2c") {
    A = parameters["A","Estimate"]
    k = parameters["k","Estimate"]
    p = parameters["p","Estimate"]
    s = parameters["s","Estimate"]
    B_pred <-  (p*A+((1-p)*A*data$STDAGE_t2^s/(k^s+data$STDAGE_t2^s)))
    }
  return(B_pred)
}

### use functio to create   B_sim_pred_f_age column in G_ecoprov dataframe

## 211
G_211$B_sim_pred_f_age <- predict_f.age("211", G_211)
## 212
G_212$B_sim_pred_f_age <- predict_f.age("212", G_212)
## 221
G_221$B_sim_pred_f_age <- predict_f.age("221", G_221)
## 222
G_222$B_sim_pred_f_age <- predict_f.age("222", G_222)
## 223
G_223$B_sim_pred_f_age <- predict_f.age("223", G_223)
## 231
G_231$B_sim_pred_f_age <- predict_f.age("231", G_231)
## 232
G_232$B_sim_pred_f_age <- predict_f.age("232", G_232)
## 234
G_234$B_sim_pred_f_age <- predict_f.age("234", G_234)
## 251
G_251$B_sim_pred_f_age <- predict_f.age("251", G_251)
## 255
G_255$B_sim_pred_f_age <- predict_f.age("255", G_255)
## 263
G_263$B_sim_pred_f_age <- predict_f.age("263", G_263)
## 313
G_313$B_sim_pred_f_age <- predict_f.age("313", G_313)
## 331
G_331$B_sim_pred_f_age <- predict_f.age("331", G_331)
## 332
G_332$B_sim_pred_f_age <- predict_f.age("332", G_332)
## M211
G_M211$B_sim_pred_f_age <- predict_f.age("M211", G_M211)
## M221
G_M221$B_sim_pred_f_age <- predict_f.age("M221", G_M221)
## M223
G_M223$B_sim_pred_f_age <- predict_f.age("M223", G_M223)
## M231
G_M231$B_sim_pred_f_age <- predict_f.age("M231", G_M231)
## M242
G_M242$B_sim_pred_f_age <- predict_f.age("M242", G_M242)
## M261
G_M261$B_sim_pred_f_age <- predict_f.age("M261", G_M261)
## M313
G_M313$B_sim_pred_f_age <- predict_f.age("M313", G_M313)
## M331
G_M331$B_sim_pred_f_age <- predict_f.age("M331", G_M331)
## M332
G_M332$B_sim_pred_f_age <- predict_f.age("M332", G_M332)
## M333
G_M333$B_sim_pred_f_age <- predict_f.age("M333", G_M333)
## M334
G_M334$B_sim_pred_f_age <- predict_f.age("M334", G_M334)
## M341
G_M341$B_sim_pred_f_age <- predict_f.age("M341", G_M341)
...
```{r}
## function which uses f(age1)
predict_f.age1 <- function(X, mod.number, data) {
  ## if loop to solve function given STDAGE_t2 data
  if (mod.num == 4) {
    a = X["a"]
    b = X["b"]
    c = X["c"]
    d = X["d"]
    B <- (a+b*exp(-((log((data[,"STDAGE_t1"]/c)))/d)^2))
  } else if (mod.num == 2) {
    A = X["A"]
    k = X["k"]
    B <- A*data[,"STDAGE_t1"] / (k+data[,"STDAGE_t1"])
  } else if (mod.num == "2a") {
    A = X["A"]
    k = X["k"]
    p = X["p"]
    B <- (p*A+((1-p)*A*data[,"STDAGE_t1"]/(k+data[,"STDAGE_t1"])))
  } else if (mod.num == "2b") {
    A = X["A"]
    k = X["k"]
    s = X["s"]
    B <- (A*data[,"STDAGE_t1"]^s/(k^s+data[,"STDAGE_t1"]^s))
  } else if (mod.num == "2c") {
    A = X["A"]
    k = X["k"]
    p = X["p"]
    s = X["s"]
    B <- (p*A+((1-p)*A*data[,"STDAGE_t1"]^s/(k^s+data[,"STDAGE_t1"]^s)))    
  } ## end if 
  B
} ## end function

## for f(age2)
predict_f.age2 <- function(X, mod.number, data) {
  ## if loop to solve function given STDAGE_t2 data
  if (mod.num == 4) {
    a = X["a"]
    b = X["b"]
    c = X["c"]
    d = X["d"]
    B <- (a+b*exp(-((log((data[,"STDAGE_t2"]/c)))/d)^2))
  } else if (mod.num == 2) {
    A = X["A"]
    k = X["k"]
    B <- A*data[,"STDAGE_t2"] / (k+data[,"STDAGE_t2"])
  } else if (mod.num == "2a") {
    A = X["A"]
    k = X["k"]
    p = X["p"]
    B <- (p*A+((1-p)*A*data[,"STDAGE_t2"]/(k+data[,"STDAGE_t2"])))
  } else if (mod.num == "2b") {
    A = X["A"]
    k = X["k"]
    s = X["s"]
    B <- (A*data[,"STDAGE_t2"]^s/(k^s+data[,"STDAGE_t2"]^s))
  } else if (mod.num == "2c") {
    A = X["A"]
    k = X["k"]
    p = X["p"]
    s = X["s"]
    B <- (p*A+((1-p)*A*data[,"STDAGE_t2"]^s/(k^s+data[,"STDAGE_t2"]^s)))    
  } ## end if 
  B
} ## end function
...
#### 211
# G_211$B_pred_f_age <- predict_f.age(211, G_211)                                            ## point estimate

### define a few things 
ecoprov = 211
mod <- get(paste("nls_", ecoprov, ".",  Best_mods.P[Best_mods.P$Code == paste(ecoprov),]$Best.Mod, sep =""))
mod.num <-  Best_mods.P[Best_mods.P$Code == paste(ecoprov),]$Best.Mod
data <- get(paste("G_", ecoprov, sep = ""))
...
# G_211$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar

### solve f(age) function at age1 and age2
sim_f_age1 <- apply(parameters, 1, predict_f.age1, data = data, mod.number = mod.num, simplify = T)
sim_f_age2 <- apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T)

### take constant times difference in f(age1) and f(age2) over deltaT (aka meastime_REMPER)  --  need to transform the numerator to get plots in rows and sim samples down columns -- then can do division 
sim_DeltaB <- t(ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince == ecoprov,]$c1 * (sim_f_age2 - sim_f_age1)) / data$MEASTIME_REMPER 

### take means and store in list 
B_sim_pred_f_age_bar[[paste(ecoprov)]] <- rowMeans(sim_DeltaB, na.rm = T)

####  212
# G_212$B_pred_f_age <- predict_f.age(212, G_212)                                            ## point estimate
...
# G_212$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  221
# G_221$B_pred_f_age <- predict_f.age(221, G_221)                                            ## point estimate
...
# G_221$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  222
# G_222$B_pred_f_age_B <- predict_f.age(222, G_222)                                            ## point estimate
...
# G_222$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  223
# G_223$B_pred_f_age <- predict_f.age(223, G_223)                                            ## point estimate
...
# G_223$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  231
# G_231$B_pred_f_age <- predict_f.age(231, G_231)                                            ## point estimate
...
# G_231$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  232
# G_232$B_pred_f_age <- predict_f.age(232, G_232)                                            ## point estimate
...
# G_232$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  234
# G_234$B_pred_f_age <- predict_f.age(234, G_234)                                            ## point estimate
...
# G_234$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  251
# G_251$B_pred_f_age <- predict_f.age(251, G_251)                                            ## point estimate
...
# G_251$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
### take constant times difference in f(age1) and f(age2)  over deltaT (aka ### take constant times difference in f(age1) and f(age2) over deltaT (aka meastime_REMPER)  --  need to transform the numerator to get plots in rows and sim samples down columns -- then can do division 
sim_DeltaB <- t(ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince == ecoprov,]$c1 * (sim_f_age2 - sim_f_age1)) / data$MEASTIME_REMPER 
...
####  255
# G_255$B_pred_f_age <- predict_f.age(255, G_255)                                            ## point estimate
...
# G_255$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  263
# G_263$B_pred_f_age <- predict_f.age(263, G_263)                                            ## point estimate
...
# G_263$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  313
# G_313$B_pred_f_age <- predict_f.age(313, G_313)                                            ## point estimate
...
# G_313$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  331
# G_331$B_pred_f_age <- predict_f.age(331, G_331)                                            ## point estimate
...
# G_331$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  332
# G_332$B_pred_f_age <- predict_f.age(332, G_332)                                            ## point estimate
...
# G_332$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),  ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M211
# G_M211$B_pred_f_age <- predict_f.age("M211", G_M211)                                      ## point estimate
...
# G_M211$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),  ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M221
# G_M221$B_pred_f_age <- predict_f.age("M221", G_M221)                                      ## point estimate
...
# G_M221$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),  ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M223
# G_M223$B_pred_f_age <- predict_f.age("M223", G_M223)                                      ## point estimate
...
# G_M223$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M231
# G_M231$B_pred_f_age <- predict_f.age("M231", G_M231)                                       ## point estimate
...
# G_M231$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M242
# G_M242$B_pred_f_age <- predict_f.age("M242", G_M242)                                       ## point estimate
...
# G_M242$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M261
# G_M261$B_pred_f_age <- predict_f.age("M261", G_M261)                                       ## point estimate
...
# G_M261$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M313
# G_M313$B_pred_f_age <- predict_f.age("M313", G_M313)                                       ## point estimate
...
# G_M313$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M331
# G_M331$B_pred_f_age <- predict_f.age("M331", G_M331)                                       ## point estimate
...
# G_M331$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M332
# G_M332$B_pred_f_age <- predict_f.age("M332", G_M332)                                       ## point estimate
...
# G_M332$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
### take constant times difference in f(age1) and f(age2)  over deltaT (aka meastime_REMPER)  --  mapply rowwise elemental division   --- this gives delta B  -- then take the mean
sim_DeltaB <- mapply("/", as.data.frame((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince == ecoprov,]$c1 *  (sim_f_age2 - sim_f_age1))), data$MEASTIME_REMPER) 

### take means and store in list 
B_sim_pred_f_age_bar[[paste(ecoprov)]] <- colMeans(sim_DeltaB, na.rm = T)


####  M333
# G_M333$B_pred_f_age <- predict_f.age("M333", G_M333)                                       ## point estimate
...
# G_M333$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M334
# G_M334$B_pred_f_age <- predict_f.age("M334", G_M334)                                       ## point estimate
...
# G_M334$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
####  M341
# G_M341$B_pred_f_age <- predict_f.age("M341", G_M341)                                       ## point estimate
...
# G_M341$B_sim_pred_f_age <- rowMeans(
#   apply(parameters, 1, predict_f.age2, data = data, mod.number = mod.num, simplify = T),   ## simulated     
#   na.rm = T)   ## run if you want to get simulated f(age) bar
...
```{r}
## DeltaB_ge -- method 2 --
### Calculation for DELTA B due to tau using constants

#### 211
G_211$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="211", "c1"] * 
                      G_211$B_sim_pred_f_age) /100) *
                      nls.param.df[nls.param.df$Code == "211", "tau"] 
####  212
G_212$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="212", "c1"] * 
                     G_212$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "212", "tau"]  
####  221
G_221$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="221", "c1"] * 
                     G_221$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "221", "tau"]  
####  222
G_222$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="222", "c1"] * 
                     G_222$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "222", "tau"] 
####  223
G_223$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="223", "c1"] * 
                     G_223$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "223", "tau"]
####  231
G_231$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="231", "c1"] * 
                     G_231$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "231", "tau"] 
####  232
G_232$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="232", "c1"] * 
                      G_232$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "232", "tau"] 
####  234
G_234$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="234", "c1"] * 
                     G_234$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "234", "tau"]  
####  251
G_251$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="251", "c1"] * 
                     G_251$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "251", "tau"]  
####  255
G_255$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="255", "c1"] * 
                     G_255$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "255", "tau"]  
####  263
G_263$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="263", "c1"] * 
                     G_263$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "263", "tau"]  
####  313
G_313$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="313", "c1"] * 
                     G_313$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "313", "tau"]  
####  331
G_331$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="331", "c1"] * 
                     G_331$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "331", "tau"]  
####  332
G_332$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="332", "c1"] * 
                     G_332$B_sim_pred_f_age) /100) * 
                     nls.param.df[nls.param.df$Code == "332", "tau"]  
####  M211
G_M211$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M211", "c1"] * 
                      G_M211$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M211", "tau"]  
####  M221
G_M221$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M221", "c1"] * 
                      G_M221$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M221", "tau"]  
####  M223
G_M223$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M223", "c1"] * 
                      G_M223$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M223", "tau"]  
####  M231
G_M231$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M231", "c1"] * 
                      G_M231$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M231", "tau"]  
####  M242
G_M242$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M242", "c1"] * 
                      G_M242$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M242", "tau"]  
####  M261
G_M261$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M261", "c1"] * 
                      G_M261$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M261", "tau"] 
####  M313
G_M313$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M313", "c1"] * 
                      G_M313$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M313", "tau"] 
####  M331
G_M331$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M331", "c1"] * 
                      G_M331$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M331", "tau"] 
####  M332
G_M332$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M332", "c1"] * 
                      G_M332$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M332", "tau"]  
####  M333
G_M333$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M333", "c1"] * 
                      G_M333$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M333", "tau"] 
####  M334
G_M334$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M334", "c1"] * 
                      G_M334$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M334", "tau"] 
####  M341
G_M341$DeltaB_tau <- ((ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M341", "c1"] * 
                      G_M341$B_sim_pred_f_age) /100) * 
                      nls.param.df[nls.param.df$Code == "M341", "tau"]  
```

## 5. Delta B due to  B_l

```{r}
## fitting linear regressions by ecoprovince 

#### 211
lm2_211 <- lm(B_L_prop ~ MEASTIME_t2, data = G_211)
# summary(lm2_211)

#### 212
lm2_212 <- lm(B_L_prop ~ MEASTIME_t2, data = G_212)
# summary(lm2_212)

#### 221
lm2_221 <- lm(B_L_prop ~ MEASTIME_t2, data = G_221)
# summary(lm2_221)

#### 222
lm2_222 <- lm(B_L_prop ~ MEASTIME_t2, data = G_222)
# summary(lm2_222)

#### 223
lm2_223 <- lm(B_L_prop ~ MEASTIME_t2, data = G_223)
# summary(lm2_223)

#### 231
lm2_231 <- lm(B_L_prop ~ MEASTIME_t2, data = G_231)
# summary(lm2_231)

#### 232
lm2_232 <- lm(B_L_prop ~ MEASTIME_t2, data = G_232)
# summary(lm2_232)

#### 234
lm2_234 <- lm(B_L_prop ~ MEASTIME_t2, data = G_234)
# summary(lm2_234)

#### 251
lm2_251 <- lm(B_L_prop ~ MEASTIME_t2, data = G_251)
# summary(lm2_251)

#### 255
lm2_255 <- lm(B_L_prop ~ MEASTIME_t2, data = G_255)
# summary(lm2_255)

#### 263
lm2_263 <- lm(B_L_prop ~ MEASTIME_t2, data = G_263)
# summary(lm2_263)

#### 313
lm2_313 <- lm(B_L_prop ~ MEASTIME_t2, data = G_313)
# summary(lm2_313)

#### 331
lm2_331 <- lm(B_L_prop ~ MEASTIME_t2, data = G_331)
# summary(lm2_331)

#### 332
lm2_332 <- lm(B_L_prop ~ MEASTIME_t2, data = G_332)
# summary(lm2_332)

#### M211
lm2_M211 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M211)
# summary(lm2_M211)

#### M221
lm2_M221 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M221)
# summary(lm2_M221)

#### M223
lm2_M223 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M223)
# summary(lm2_M223)

#### M231
lm2_M231 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M231)
# summary(lm2_M231)

#### M242
lm2_M242 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M242)
# summary(lm2_M242)

#### M261
lm2_M261 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M261)
# summary(lm2_M261)

#### M313
lm2_M313 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M313)
# summary(lm2_M313)

#### M331
lm2_M331 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M331)
# summary(lm2_M331)

#### M332
lm2_M332 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M332)
# summary(lm2_M332)

#### M333
lm2_M333 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M333)
# summary(lm2_M333)

#### M334
lm2_M334 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M334)
# summary(lm2_M334)

#### M341
lm2_M341 <- lm(B_L_prop ~ MEASTIME_t2, data = G_M341)
# summary(lm2_M341)

#########################################
## wrangle dataframe of regression slopes

## collect coefficients 
lm2_B_L_frame <- as.data.frame(cbind(
 Region = c("east", "east", "east", "east", "east", "east", "east", "east", 
            "east", "east", "pacific", "interior west", "interior west", "interior west", 
            "east", "east", "east", "east", "pacific", "pacific", "interior west", "interior west",
            "interior west", "interior west", "interior west", "interior west"),
 Ecoprovince = c("211", "212", "221", "222", "223", "231", "232", "234", 
                 ...
                 "M333", "M334", "M341"),
 rbind(
   summary(lm2_211)$coef["MEASTIME_t2",c("Estimate", "Std. Error")], 
   summary(lm2_212)$coef["MEASTIME_t2",c("Estimate", "Std. Error")], 
   summary(lm2_221)$coef["MEASTIME_t2",c("Estimate", "Std. Error")], 
   summary(lm2_222)$coef["MEASTIME_t2",c("Estimate", "Std. Error")], 
   summary(lm2_223)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_231)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_232)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_234)$coef["MEASTIME_t2",c("Estimate", "Std. Error")], 
   summary(lm2_251)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_255)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_263)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_313)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_331)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_332)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M211)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M221)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M223)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M231)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M242)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M261)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M313)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M331)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M332)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M333)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M334)$coef["MEASTIME_t2",c("Estimate", "Std. Error")],
   summary(lm2_M341)$coef["MEASTIME_t2",c("Estimate", "Std. Error")])))

##setting order for plotting
lm2_B_L_frame <-  lm2_B_L_frame[match(c("221", "234", "251", "222", "M223", "223",  
                                        "M221", "211", "M231", "M211", "231", "232", 
                                        "212", "255", "313", "332", "M333", "M313", 
                                        "331", "M332", "M334", "M341", "M331", "263", 
                                        "M242", "M261"), lm2_B_L_frame$Ecoprovince),]

## colnames and factors etc.
colnames(lm2_B_L_frame) <- c("Region", "Ecoprovince", "est", "se")
lm2_B_L_frame$Region <- as.factor(lm2_B_L_frame$Region)
lm2_B_L_frame$Ecoprovince <- factor(lm2_B_L_frame$Ecoprovince, 
                                    levels = c("221", "234", "251", "222", "M223", "223",
                                               "M221", "211", "M231", "M211","231", "232", 
                                               "212", "255", "313", "332", "M333", "M313",
                                               "331", "M332", "M334", "M341", "M331", "263", 
                                               "M242", "M261"))

lm2_B_L_frame$est <- as.numeric(lm2_B_L_frame$est)
lm2_B_L_frame$se <- as.numeric(lm2_B_L_frame$se)
```

```{r}
### Calculation for DELTA B due to DPDSI

#### 211
G_211$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="211", "c2"] * 
                     G_211$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "211", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "211","est"]
####  212
G_212$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="212", "c2"] * 
                     G_212$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "212", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "212","est"] 
####  221
G_221$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="221", "c2"] * 
                     G_221$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "221", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "221","est"]
####  222
G_222$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="222", "c2"] * 
                     G_222$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "222", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "222","est"]
####  223
G_223$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="223", "c2"] * 
                     G_223$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "223", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "223","est"]
####  231
G_231$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="231", "c2"] * 
                     G_231$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "231", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "231","est"]
####  232
G_232$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="232", "c2"] * 
                      G_232$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "232", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "232","est"]
####  234
G_234$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="234", "c2"] * 
                     G_234$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "234", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "234","est"]
####  251
G_251$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="251", "c2"] * 
                     G_251$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "251", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "251","est"]
####  255
G_255$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="255", "c2"] * 
                     G_255$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "255", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "255","est"]
####  263
G_263$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="263", "c2"] * 
                     G_263$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "263", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "263","est"]
####  313
G_313$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="313", "c2"] * 
                     G_313$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "313", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "313","est"]
####  331
G_331$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="331", "c2"] * 
                     G_331$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "331", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "331","est"]
####  332
G_332$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="332", "c2"] * 
                     G_332$B_sim_pred_f_age * 
                     nls.param.df[nls.param.df$Code == "332", "alpha"]  * 
                     lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "332","est"]
####  M211
G_M211$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M211", "c2"] * 
                      G_M211$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M211", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M211","est"]
####  M221
G_M221$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M221", "c2"] * 
                      G_M221$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M221", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M221","est"]
####  M223
G_M223$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M223", "c2"] * 
                      G_M223$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M223", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M223","est"]
####  M231
G_M231$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M231", "c2"] * 
                      G_M231$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M231", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M231","est"]
####  M242
G_M242$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M242", "c2"] * 
                      G_M242$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M242", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M242","est"]
####  M261
G_M261$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M261", "c2"] * 
                      G_M261$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M261", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M261","est"]
####  M313
G_M313$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M313", "c2"] * 
                      G_M313$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M313", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M313","est"]
####  M331
G_M331$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M331", "c2"] * 
                      G_M331$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M331", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M331","est"]
####  M332
G_M332$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M332", "c2"] * 
                      G_M332$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M332", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M332","est"]
####  M333
G_M333$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M333", "c2"] * 
                      G_M333$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M333", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M333","est"]
####  M334
G_M334$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M334", "c2"] * 
                      G_M334$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M334", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M334","est"]
####  M341
G_M341$DeltaB_B_L <- ECOPROV_DeltaB_constants[ECOPROV_DeltaB_constants$Ecoprovince =="M341", "c2"] * 
                      G_M341$B_sim_pred_f_age * 
                      nls.param.df[nls.param.df$Code == "M341", "alpha"]  * 
                      lm2_B_L_frame[lm2_B_L_frame$Ecoprovince == "M341","est"]
```
...
BK_df <-  cbind(Region = c(rep("east", length(G_211$pltID)), 
                                ...
                                # rep("pacific", length(G_263$pltID)),
                                ...
                                rep("east", length(G_M221$pltID)),
                                rep("east", length(G_M223$pltID)),
                                rep("east", length(G_M231$pltID)),
                ...
                #                 rep("263 - California Coastal Steppe - Mixed Forest and Redwood Forest", length(G_263$pltID)),
                ...
                #                 rep("M221 - Central Appalachian Broadleaf Forest - Coniferous Forest - Meadow", length(G_M221$pltID)),
                #                 rep("M223 - Ozark Broadleaf Forest Meadow", length(G_M223$pltID)),
                #                 rep("M231 - Ouachita Mixed Forest", length(G_M231$pltID)),
                ...
                rbind(G_211[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_212[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_221[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_222[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_223[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_231[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_232[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_234[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_251[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_255[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      # G_263[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_313[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_331[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_332[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M211[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M221[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M223[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M231[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M242[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M261[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M313[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M331[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M332[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M333[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M334[,c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")],
                      G_M341[c("diff_STDAGE", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L")]))

## add column for total DeltaB
BK_df$DeltaB_total <- (BK_df$DeltaB_age + BK_df$DeltaB_tau + BK_df$DeltaB_B_L)


## reshape data wide to long
BK_df_long <- reshape2::melt(BK_df, id.vars = c("Region", "Ecoprovince"), measure.vars = c("DeltaB_total", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L"))
...
var.f_age["332"] <- var(unlist(B_sim_pred_f_age_bar["332"])[unlist(B_sim_pred_f_age_bar["332"])>0])
var.f_age["M313"] <- var(unlist(B_sim_pred_f_age_bar["M313"])[unlist(B_sim_pred_f_age_bar["M313"])>0 & unlist(B_sim_pred_f_age_bar["M313"])<1000])

##### important!:  need to re-calculate variance in DeltaB_ge 

## NOTE: var in the BK_df_age_avg is var_age

BK_df_age_avg$se <- sqrt(var.f_age[match(BK_df_age_avg$Ecoprovince, names(var.f_age))] + BK_df_age_avg$var) / sqrt(BK_df_age_avg$N) 
## recalcualte se as sqrt of summed variances
...
## apply summary SE function to age data in new dataframe to get average and se 
BK_df_tau_avg <- summarySE(BK_df, measurevar = "DeltaB_tau", groupvars = c("Region","Ecoprovince"), na.rm = T)
colnames(BK_df_tau_avg)[4] <- "value" # rename the mean to "Value" to match other df

BK_df_tau_avg$Ecoprovince <- factor(BK_df_tau_avg$Ecoprovince, levels=BK_df_age_avg$Ecoprovince)

##### important!:  need to re-calculate variance in DeltaB_ge 
#####  this is done my multiplying the standard error of the ge parameter by DeltaB_year (ge) -- see manuscript methods for futher detail
BK_df_tau_avg$se <- (BK_df_tau_avg$value * 
                    ECOPROV_DeltaB_constants[match(BK_df_tau_avg$Ecoprovince, ECOPROV_DeltaB_constants$Ecoprovince),"c1"]) *
                    sqrt(nls.param.df[match(BK_df_tau_avg$Ecoprovince, nls.param.df$Code), "tau.variance"])  
                    ## note this overwrites previous se calculation from summarySE
#############
#### B_L     

## apply summary SE function to age data in new dataframe to get average and se 
BK_df_B_L_avg <- summarySE(BK_df, measurevar = "DeltaB_B_L", groupvars = c("Region","Ecoprovince"), na.rm = T)
colnames(BK_df_B_L_avg)[4] <- "value" # rename the mean to "Value" to match other df

BK_df_B_L_avg$Ecoprovince <- factor(BK_df_B_L_avg$Ecoprovince, levels=BK_df_age_avg$Ecoprovince)

##### important!:  need to re-calculate variance in DeltaB_PDSI
#####  this is done my multiplying the standard error of the ALPHA! parameter AND the standard error of the slope of the linear regression of B_L~year by DeltaB_PDSI -- see manuscript methods for futher detail
BK_df_B_L_avg$se <- (BK_df_B_L_avg$value *
                     ECOPROV_DeltaB_constants[match(BK_df_B_L_avg$Ecoprovince, ECOPROV_DeltaB_constants$Ecoprovince),"c2"]) *
                    (sqrt(nls.param.df[match(BK_df_B_L_avg$Ecoprovince, nls.param.df$Code), "alpha.variance"]) *
                    lm2_B_L_frame[match(BK_df_B_L_avg$Ecoprovince, lm2_B_L_frame$Ecoprovince),"se"])
                    ## note this overwrites previous se calculation from summarySE
...
## apply summary SE function to age data in new dataframe to get average and se 
BK_df_total_avg <- summarySE(BK_df, measurevar = "DeltaB_total", groupvars = c("Region","Ecoprovince"), na.rm = T)
colnames(BK_df_total_avg)[4] <- "value" # rename the mean to "Value" to match other df
...
BK_df_avg <- rbind(BK_df_total_avg, BK_df_age_avg, BK_df_tau_avg, BK_df_B_L_avg)
BK_df_avg$variable <- c(rep("DeltaB_total", 25), rep("DeltaB_age", 25), rep("DeltaB_tau", 25), rep("DeltaB_B_L", 25))

BK_df_avg$Ecoprovince <- factor(BK_df_avg$Ecoprovince, levels=BK_df_age_avg$Ecoprovince)
BK_df_avg$variable <- factor(BK_df_avg$variable, levels = c("DeltaB_total", "DeltaB_age", "DeltaB_tau", "DeltaB_B_L"))
...
## Delta B
```{r}
gg_BK1 <- ggplot2::ggplot(aes(x=Ecoprovince, y = value, group = variable), 
                 data = BK_df_long) +
          ...
          geom_point(aes(x=Ecoprovince, y = value, col = variable), 
                    data = BK_df_avg, 
                    position = position_dodge(width = 0.75),  shape = 20) + 
          
          geom_errorbar(aes(x=Ecoprovince, y = value, ymax = value+se, ymin = value-se, col = variable), 
                    data = BK_df_avg, 
                    position = position_dodge(width = 0.75), width = 0.75) +
          
          scale_color_manual(values = c("black", "#DC3220BF", "#005AB5BF", "#FFC107BF"),
                             labels = c(expression(Delta*B[total]), expression(Delta*B[age]), expression(Delta*B[productivity~trend]), 
...
# tiff("FIA_Bookkeeper_APRIL2023.tiff", width = 19, height = 8, units = "cm", res = 600, compression ="lzw")        
 gg_BK1
# dev.off()
```
...
```{r}
# gg_BK2 <- ggplot(aes(x=Ecoprovince, y = value, group = variable), 
#                  data = BK_df_long) +
#           
#           geom_hline(yintercept = 0, lty = 2) +
#           
...
#                     position = position_dodge(width = 0.75), width = 0.75) +
#           
#           scale_color_manual(values = c("#DC3220BF", "#005AB5BF", "#FFC107BF", "#004D40BF"),
#                              labels = c(expression(Delta*B~age), expression(Delta*B~growth~enhancement), 
#                                         expression(Delta*B~Delta*PDSI), Delta*B~B[L]), name="effect") +
#           
#           guides(fill="none") +  ## removed second legend
#          
#           ylab(expression(Delta*B~"(Mg ha"^-1~year^-1*")")) +
...
#           
#           
# # tiff("FIA_Bookkeeper_v2.tiff", width = 19, height = 8, units = "cm", res = 600, compression ="lzw")        
# gg_BK2
# # dev.off()
```

```{r}
BK_df_long3 <- BK_df_long[BK_df_long$variable %in% c("DeltaB_total", "DeltaB_age", "DeltaB_tau"),]

BK_df_avg3 <- BK_df_avg[BK_df_avg$variable %in% c("DeltaB_total", "DeltaB_age", "DeltaB_tau"),]


BK_df_avg3 <- droplevels(BK_df_avg3)
BK_df_long3 <- droplevels(BK_df_long3)
...
gg_BK2b <- ggplot(aes(x=Ecoprovince, y = value, group = variable), 
          ...
          scale_color_manual(values = c("#00000080", "#E2204680", "#1D00FF80"),
                             #c("#00000080", "#DC322080", "#005AB580"), #,"#FFC10780", "#004D4080"),
                             labels = c(expression(Delta*B[total]), 
                                        expression(Delta*B[age]),
                                        expression(Delta*B[productivity~trend])), name = " ") +
          ...
          theme(axis.text.x = element_text(angle = 33, vjust = 1, hjust=1),
                legend.position = "top", 
                legend.margin = margin(0, 0, 0, 0), 
                axis.title.x = element_blank(), strip.text.y = element_blank()) 

          
          
          
# tiff("FIA_Bookkeeper_v2C_April2023.tiff", width = 19, height = 16, units = "cm", res = 600, compression ="lzw")        
gg_BK2b + coord_cartesian(ylim=c(-6, 5))
# dev.off()
```


```{r}
BK_df_long4 <- BK_df_long[BK_df_long$variable %in% c("DeltaB_total",  "DeltaB_B_L"),]

BK_df_avg4 <- BK_df_avg[BK_df_avg$variable %in% c("DeltaB_total",  "DeltaB_B_L"),]
...
# tiff("FIA_Bookkeeper_disturbance_April_2023.tiff", width = 20, height = 9.33, units = "cm", res = 600, compression ="lzw")        
gg_BK2c + coord_cartesian(ylim=c(-4, 5))
# dev.off()
```


```{r}
### 2bX -- this is the March 2023 version where I wanted to plot them all side-by-side-on a single panel

gg_BK2bX <- ggplot(aes(x=Ecoprovince, y = value, group = variable), 
                 data = BK_df_avg3) +
          ...
          scale_color_manual(values = c("#00000080", "#D4115980", "#1A85FF80"),
                               #c("#00000080", "#DC322080", "#005AB580"), #,"#FFC10780", "#004D4080"),
                             labels = c(expression(Delta*B), 
                                        expression(Delta*B[age]),
                                        expression(Delta*B[productivity~trend])), name = " ") +
...
# tiff("FIA_Bookkeeper_v2b_APR_2023.tiff", width = 19, height = 16, units = "cm", res = 600, compression ="lzw")        
gg_BK2bX + coord_cartesian(ylim=c(-6, 4))
# dev.off()
```
...
```{r}
ylims = list( c(-4,4), c(-2, 3), c(-7,5))

gg_BK2b_scaled <- scale_inidividual_facet_y_axes(gg_BK2b, ylims = ylims)

# tiff("FIA_Bookkeeper_v2b.tiff", width = 19, height = 16, units = "cm", res = 600, compression ="lzw")
gg_BK2b_scaled
# dev.off()
```
...
G_first_mtnWest <- G[G$ECOPROVCD %in% c("313", "331", "M313", "M331", "M341"),c("ECOPROVCD", "STDAGE_t1")]
colnames(G_first_mtnWest)[2] <- "STDAGE"
G_first_mtnWest$measurement <- "first"

G_last <- G_last[,c("ECOPROVCD", "STDAGE_t2")]  #subset the needed columns
colnames(G_last)[2] <- "STDAGE"
G_last$measurement <- "most recent"

G_last_mtnWest <- G[G$ECOPROVCD %in% c("313" ,"331", "M313", "M331", "M341"),c("ECOPROVCD", "STDAGE_t2")]
colnames(G_last_mtnWest)[2] <- "STDAGE"
G_last_mtnWest$measurement <- "most recent"

##################
### need to to special trick for ECOPROV 263 -- simulate some data with mean and sd 

# set.seed(77) ## set seed for reproducibility
# 
# G_age_263 <-  data.frame(
#   "ECOPROVCD" = rep("263", 999*2),
#   "STDAGE" = c(rnorm(999, mean(G_first[G_first$ECOPROVCD == 263,]$STDAGE),
#                      sd(G_first[G_first$ECOPROVCD == 263,]$STDAGE)),
#                rnorm(999, mean(G_last[G_last$ECOPROVCD == 263,]$STDAGE),
#                      sd(G_last[G_last$ECOPROVCD == 263,]$STDAGE))), 
#   "measurement" = c(rep("first", 999), rep("most recent", 999)))
# ###########

## stack the three data.frames
G_age <- rbind(G_first, G_first_mtnWest, G_last, G_last_mtnWest)
# G_age <- rbind(G_age, G_age_263)
G_age$measurement <- as.factor(G_age$measurement)
G_age$ECOPROVCD <- droplevels(G_age$ECOPROVCD)

## subset "M223",
G_age <- G_age[G_age$ECOPROVCD %in% c("221", "251", "222", "234", "223", "211",  "M223", "M221", "M211", "M231",
                                      "232", "212", "231", "255", "313",  "332", "M333", "M313", "331",
                                       "M332", "M334", "M341", "M331", "M242", "M261"),]

G_age$ECOPROVCD <- factor(G_age$ECOPROVCD, levels= c("221", "251", "222", "234", "223", "211",  "M223", "M221", "M211", "M231",
                                                     "232", "212", "231", "255", "313",  "332", "M333", "M313", "331",
                                                     "M332", "M334", "M341", "M331", "M242", "M261"))
...
G_age[G_age$ECOPROVCD %in% c("221", "222", "223", "251", "234", "231", "232", "211", "M211", "M221", "M223", "212", "255", "M231"),]$region <- "east"

G_age[G_age$ECOPROVCD %in% c("313", "331", "332", "M333", "M313", "M332", "M334", "M331", "M341"),]$region <- "interior west"

G_age[G_age$ECOPROVCD %in% c("M242", "M261"),]$region <- "pacific"

G_age$region <- as.factor(G_age$region)


##################  NEED TO RE-ORDER BK_df_long  factor levels to get order correct for plotting
# G_age$Ecoprovince <- factor(BK_df_long$Ecoprovince, levels=BK_df_age_avg$Ecoprovince)
...
gg_age_dist <- ggplot(aes(y=ECOPROVCD, x=STDAGE), data = G_age) +
               ...
               facet_grid(cols = vars(region), scales= "free", space = "free", drop = T) +
...
# tiff("FIA_AgeDistsX.tiff", width = 8, height = 22, units = "cm", res = 600, compression ="lzw")        
gg_age_dist
# dev.off()
```
...
Age_effect_df.2 <- Age_effect_df[!Age_effect_df$Ecoprovince %in% 263,]


### fit lm
lm_age <- lm(DeltaB_age~diff_STDAGE, data = Age_effect_df)
lm_age.2 <- lm(DeltaB_age~diff_STDAGE, data = Age_effect_df.2)

## ggplot

gg.age_effect <- ggplot(aes(x= diff_STDAGE, y= DeltaB_age, col = Region),
                        data = Age_effect_df.2) + 
                 #geom_abline(intercept = 0, slope = 1, lty = 2, size =1, alpha = 0.5) +   
                 ...
                 scale_color_manual(values = c("#134B19BF", "#E66100BF", "#5D3A9BBF")) + 
                 labs(col="region") + 
                 ggrepel::geom_text_repel(aes(label = Ecoprovince), 
                                          data = Age_effect_df.2, size = 2, direction = "both", 
                                          min.segment.length = 10) +
                 geom_text(aes(x = max(diff_STDAGE)/2, 
                               y = 1.5, label = lm_eqn(lm_age.2)),
                           parse = TRUE, col = "black", size = 3)
...
# gg_BK1.X <- gg_BK1 + theme(axis.text.x = element_blank())
# 
# gg_age_dist.X <- gg_age_dist + theme(axis.title.x = element_blank(),
#                                      axis.text.x = element_blank(),
#                                      strip.text.x = element_blank())
# 
# gg_coef_lms.X <- gg_coef_lms + theme(axis.title.x = element_blank(),
#                                      strip.text.x = element_blank(), 
#                                      axis.text.x = element_blank())
# 
# gg_coef_lm2s.X <- gg_coef_lm2s + theme(strip.text.x = element_blank())
# 
# ### combine
# gg_fig3.X <- ggpubr::ggarrange(gg_BK1.X, gg_age_dist.X, gg_coef_lms.X, gg_coef_lm2s.X, nrow =4, ncol =1, align = "hv", labels = "AUTO",
#                                heights = c(1.25,1.1,0.95,1.2))
# 
# ## make the graphic
# tiff(filename = "NewFig3_se_1.9.23.tiff", width = 22, height = 22, units = "cm", res = 600, compression = "lzw")
# gg_fig3.X
# dev.off()



gg_BK2b.X <- gg_BK2b + theme(axis.text.x = element_blank(), 
                             plot.margin = margin(t = 0, r = 12.5, b = 0, l = 0, unit = "pt")) + 
             coord_cartesian(ylim=c(-6, 5)) 


gg_BK2b_scaled.X <- gg_BK2b_scaled + theme(axis.text.x = element_blank(), 
                                           plot.margin = margin(t = 0, r = 12.5, b = 0, l = 0, unit = "pt"))

gg_age_dist.X <- gg_age_dist + theme(strip.text.x = element_blank(),
                                     legend.position = "bottom")


# ### combine
gg_fig3.Xb <- cowplot::plot_grid(gg_BK2b.X,
                                 gg_age_dist.X, nrow =2, ncol =1, align = "v", axis = "l", 
                                 labels = "AUTO",
                                 rel_heights = c(2,1))


## make the graphic
tiff(filename = "Fig3_04.19.2023_3_stacker.tiff", width = 20, height = 20, units = "cm", res = 600, compression = "lzw")
gg_fig3.Xb
dev.off()
```
...
```{r}
# ### combine
gg_fig3.XXzz <- cowplot::plot_grid(gg_BK1 + theme(axis.text.x = element_blank(), 
                                                  plot.margin = margin(t = 0, r = 12.5, b = 0, l = 0, unit = "pt")),
                                   gg_age_dist.X, nrow =2, ncol =1, align = "v", axis = "l", 
                                   labels = "AUTO",
                                   rel_heights = c(1.5,1))
...
## make the graphic
tiff(filename = "Fig3_04.19.2023_ALT_VERSION.tiff", width = 20, height = 17, units = "cm", res = 600, compression = "lzw")
gg_fig3.XXzz
dev.off()
```
```
