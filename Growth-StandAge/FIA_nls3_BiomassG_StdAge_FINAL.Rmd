...
nls.param.df2[nls.param.df2$Code == "211",]$ge.variance <- vcov(get(paste("nls_211.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "211",]$phi.variance <- vcov(get(paste("nls_211.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "212",]$ge.variance <- vcov(get(paste("nls_212.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "212",]$phi.variance <- vcov(get(paste("nls_212.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "221",]$ge.variance <- vcov(get(paste("nls_221.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "221",]$phi.variance <- vcov(get(paste("nls_221.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "222",]$ge.variance <- vcov(get(paste("nls_222.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "222",]$phi.variance <- vcov(get(paste("nls_222.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "223",]$ge.variance <- vcov(get(paste("nls_223.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "223",]$phi.variance <- vcov(get(paste("nls_223.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "231",]$ge.variance <- vcov(get(paste("nls_231.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "231",]$phi.variance <- vcov(get(paste("nls_231.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "232",]$ge.variance <- vcov(get(paste("nls_232.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "232",]$phi.variance <- vcov(get(paste("nls_232.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "234",]$ge.variance <- vcov(get(paste("nls_234.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "234",]$phi.variance <- vcov(get(paste("nls_234.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "242",]$ge.variance <- vcov(get(paste("nls_242.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "242",]$phi.variance <- vcov(get(paste("nls_242.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "251",]$ge.variance <- vcov(get(paste("nls_251.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "251",]$phi.variance <- vcov(get(paste("nls_251.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "255",]$ge.variance <- vcov(get(paste("nls_255.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "255",]$phi.variance <- vcov(get(paste("nls_255.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "261",]$ge.variance <- vcov(get(paste("nls_261.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "261",]$phi.variance <- vcov(get(paste("nls_261.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "262",]$ge.variance <- vcov(get(paste("nls_262.",  Mod.Sel1, sep ="")))["ge","ge"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "263",]$ge.variance <- vcov(get(paste("nls_263.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "263",]$phi.variance <- vcov(get(paste("nls_263.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "313",]$ge.variance <- vcov(get(paste("nls_313.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "313",]$phi.variance <- vcov(get(paste("nls_313.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "315",]$ge.variance <- vcov(get(paste("nls_315.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "315",]$phi.variance <- vcov(get(paste("nls_315.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "321",]$ge.variance <- vcov(get(paste("nls_321.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "321",]$phi.variance <- vcov(get(paste("nls_321.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "322",]$ge.variance <- vcov(get(paste("nls_322.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "322",]$phi.variance <- vcov(get(paste("nls_322.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "331",]$ge.variance <- vcov(get(paste("nls_331.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "331",]$phi.variance <- vcov(get(paste("nls_331.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "332",]$ge.variance <- vcov(get(paste("nls_332.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "332",]$phi.variance <- vcov(get(paste("nls_332.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "341",]$ge.variance <- vcov(get(paste("nls_341.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "341",]$phi.variance <- vcov(get(paste("nls_341.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "342",]$ge.variance <- vcov(get(paste("nls_342.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "342",]$phi.variance <- vcov(get(paste("nls_342.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "411",]$ge.variance <- vcov(get(paste("nls_411.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "411",]$phi.variance <- vcov(get(paste("nls_411.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M211",]$ge.variance <- vcov(get(paste("nls_M211.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M211",]$phi.variance <- vcov(get(paste("nls_M211.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M221",]$ge.variance <- vcov(get(paste("nls_M221.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M221",]$phi.variance <- vcov(get(paste("nls_M221.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M223",]$ge.variance <- vcov(get(paste("nls_M223.",  Mod.Sel1, sep ="")))["ge","ge"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M231",]$ge.variance <- vcov(get(paste("nls_M231.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M231",]$phi.variance <- vcov(get(paste("nls_M231.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M242",]$ge.variance <- vcov(get(paste("nls_M242.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M242",]$phi.variance <- vcov(get(paste("nls_M242.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M261",]$ge.variance <- vcov(get(paste("nls_M261.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M261",]$phi.variance <- vcov(get(paste("nls_M261.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M262",]$ge.variance <- vcov(get(paste("nls_M262.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M262",]$phi.variance <- vcov(get(paste("nls_M262.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M313",]$ge.variance <- vcov(get(paste("nls_M313.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M313",]$phi.variance <- vcov(get(paste("nls_M313.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M331",]$ge.variance <- vcov(get(paste("nls_M331.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M331",]$phi.variance <- vcov(get(paste("nls_M331.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M332",]$ge.variance <- vcov(get(paste("nls_M332.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M332",]$phi.variance <- vcov(get(paste("nls_M332.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M333",]$ge.variance <- vcov(get(paste("nls_M333.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M333",]$phi.variance <- vcov(get(paste("nls_M333.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M334",]$ge.variance <- vcov(get(paste("nls_M334.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M334",]$phi.variance <- vcov(get(paste("nls_M334.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## get variance in ge, phi and alpha
nls.param.df2[nls.param.df2$Code == "M341",]$ge.variance <- vcov(get(paste("nls_M341.",  Mod.Sel1, sep ="")))["ge","ge"]
nls.param.df2[nls.param.df2$Code == "M341",]$phi.variance <- vcov(get(paste("nls_M341.",  Mod.Sel1, sep ="")))["phi","phi"]
...
## order data
nls.param.df2$Ecoregion<- factor(nls.param.df2$Ecoregion, levels = nls.param.df2[rev(order(nls.param.df2$ge)), "Ecoregion"])
...
## all
  "weighted ge" = c(sum(nls.param.df2$ge*nls.param.df2$n.plots, na.rm = T) / N,
                    
## pacific
sum(nls.param.df2[nls.param.df2$region == "pacific",]$ge * nls.param.df2[nls.param.df2$region == "pacific",]$n.plots, na.rm = T) / N,

## east 
sum(nls.param.df2[nls.param.df2$region == "east",]$ge * nls.param.df2[nls.param.df2$region == "east",]$n.plots, na.rm = T) / N,

## west
sum(nls.param.df2[nls.param.df2$region == "interior west",]$ge * nls.param.df2[nls.param.df2$region == "interior west",]$n.plots, na.rm = T) / N),
...
## all
  "weighted.ge.std_Error" = c(
    sqrt(sum(nls.param.df2$ge.variance * nls.param.df2$weight.sq, na.rm = T)),
    
## pacific
sqrt(sum(nls.param.df2[nls.param.df2$region == "pacific",]$ge.variance * nls.param.df2[nls.param.df2$region == "pacific",]$weight.sq, na.rm = T)),
                               
## east
sqrt(sum(nls.param.df2[nls.param.df2$region == "east",]$ge.variance * nls.param.df2[nls.param.df2$region == "east",]$weight.sq, na.rm = T)),

## west
sqrt(sum(nls.param.df2[nls.param.df2$region == "interior west",]$ge.variance * nls.param.df2[nls.param.df2$region == "interior west",]$weight.sq, na.rm = T)))
...
weighted.phi.df2 <-  data.frame(
  region = c("entire US", "pacific", "east", "interior west"),
## all
  "weighted phi" = c(sum(nls.param.df2$phi*nls.param.df2$n.plots, na.rm = T) / N,
                    
## pacific
sum(nls.param.df2[nls.param.df2$region == "pacific",]$phi * nls.param.df2[nls.param.df2$region == "pacific",]$n.plots, na.rm = T) / N,

## east 
sum(nls.param.df2[nls.param.df2$region == "east",]$phi * nls.param.df2[nls.param.df2$region == "east",]$n.plots, na.rm = T) / N,

## west
sum(nls.param.df2[nls.param.df2$region == "interior west",]$phi * nls.param.df2[nls.param.df2$region == "interior west",]$n.plots, na.rm = T) / N),
...
## all
  "weighted.phi.std_Error" = c(
    sqrt(sum(nls.param.df2$phi.variance * nls.param.df2$weight.sq, na.rm = T)),
    
## pacific
sqrt(sum(nls.param.df2[nls.param.df2$region == "pacific",]$phi.variance * nls.param.df2[nls.param.df2$region == "pacific",]$weight.sq, na.rm = T)),
                               
## east
sqrt(sum(nls.param.df2[nls.param.df2$region == "east",]$phi.variance * nls.param.df2[nls.param.df2$region == "east",]$weight.sq, na.rm = T)),

## west
sqrt(sum(nls.param.df2[nls.param.df2$region == "interior west",]$phi.variance * nls.param.df2[nls.param.df2$region == "interior west",]$weight.sq, na.rm = T)))
