...
#####################################################
#####################################################
 load("C:/Users/hogan.jaaron/Dropbox/FIA_R/data_PDSI/G_pdsi_data_2_JAN-AUG.Rdata")  ## simply load ths finished data product -- the above code takes some time to run...
...
gg.242.2 <- ggplot() +
             ...
             theme_classic() + theme(axis.text.x=element_text(angle=90,hjust=1)) + 
             scale_x_continuous(limits = c(0, cutvec_242[20]*1.05), expand =c(0,0)) +
             coord_cartesian(ylim=c(-2, 10))
...
gg.261.2 <- ggplot() +
             ...
             theme_classic() + theme(axis.text.x=element_text(angle=90,hjust=1)) + 
             scale_x_continuous(limits = c(0, cutvec_261[20]*1.05), expand =c(0,0)) +
             coord_cartesian(ylim=c(-2, 10))
...
gg.341.2 <- ggplot() +
             ...
             theme_classic() + theme(axis.text.x=element_text(angle=90,hjust=1)) + 
             scale_x_continuous(limits = c(0, cutvec_341[20]*1.05), expand =c(0,0)) +
             coord_cartesian(ylim=c(-2, 10))
...
gg.411.2 <- ggplot() +
             ...
             theme_classic() + theme(axis.text.x=element_text(angle=90,hjust=1)) + 
             scale_x_continuous(limits = c(0, cutvec_411[20]*1.05), expand =c(0,0)) +
             coord_cartesian(ylim=c(-2, 10))
