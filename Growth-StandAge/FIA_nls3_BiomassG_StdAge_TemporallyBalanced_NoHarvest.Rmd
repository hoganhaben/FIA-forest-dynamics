---
title: "FIA - NLS Models: Biomass Growth vs. Stand Age, Temporally-Balanced, No Harvest"
author: "JAH"
date: "`r Sys.Date()`"
output:
  html_document:
...
### dependencies
library(nlstools); library(ggplot2); library(dplyr)
...
*This analysis further excludes plots were timber harvest occurred*
...
### model 1
fg2_1 <- formula(G_obs_TreeInc_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (a+b*exp(-((log(STDAGE_t1/c))/d)^2)))
## model 2
fg2_2 <-  formula(G_obs_TreeInc_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (a+b*exp(-((log(STDAGE_t1/c))/d)^2)))
## model 3
fg2_3 <- formula(G_obs_TreeInc_MgHaYr ~ (1+(MEASTIME_avg-1990)*ge/100) * (1 + phi*DeltaPDSI) * (1-alpha*B_L_prop) * (a+b*exp(-((log(STDAGE_t1/c))/d)^2)))
###########################################

## define nls starting parameters 
a.start = 0.1       # y-intercept term
b.start = 5         # a+b = peak G value
c.start = 20        # STDAGE at peak G
...
# 
# ###### COMBINE G_calc
# G <- dplyr::left_join(FIA_G_calc, P_cond_surv[,c("STATE", "CN", "PLT_CN", "INVYR", "STDAGE", "STDORGCD", "CONDPROP_UNADJ", "SITECLCD", "STDSZCD", "COND_STATUS_CD", "P3_OZONE_IND", "ANN_INVENTORY")], by = c("STATE", "CN" = "PLT_CN", "INVYR")) %>% distinct()  # 370598 observations
# 
...
## get bin means
G_bin_means <- tapply(G_211$G_obs_TreeInc_MgHaYr, cut(G_211$STDAGE_t1, cutvec_211), mean)

## make column weights.1
G_211$nls_weights <- as.vector(1/G_bin_means[match(G_211$StdAge_bin, names(G_bin_means))])
...
### did not fit with other starting parameters -- try with fitted values from temporally balanced analysis
ge.start2  <- 0.39
phi.start2 <- 0.003
alpha.start2 <- 0.62
a.start2   <- 0
...
try(
  nls_211.1 <- nls(fg2_1, data = G_211, 
                   start = c(ge=ge.start2, a=a.start2, b=b.start2, c=c.start2, d=d.start2), 
...
try(
  nls_211.2 <- nls(fg2_2, data=G_211, 
                  start = c(ge=ge.start2, phi=phi.start2, a=a.start2, b=b.start2, c=c.start2, d=d.start2), 
                   weights = G_211$nls_weights)
 )
...
try(
  nls_211.3 <- nls(fg2_3, data = G_211, 
                   start = c(ge=ge.start2, phi=phi.start2, alpha=alpha.start2, a=a.start2, b=b.start2, c=c.start2, d=d.start2), 
                   weights = G_211$nls_weights)
 )
...
## PLOTTING 2
gg.211.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_211, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_211, 
                              fun.data = function(x) {
...
DM_compare_211 <-data.frame(
  ...
  data.mean = tapply(G_211$G_obs_TreeInc_MgHaYr, cut(G_211$STDAGE_t1, cutvec_211), 
                     mean), 
  data.CI.high =  tapply(G_211$G_obs_TreeInc_MgHaYr, cut(G_211$STDAGE_t1, cutvec_211), 
                    high.CI), 
  data.CI.low = tapply(G_211$G_obs_TreeInc_MgHaYr, cut(G_211$STDAGE_t1, cutvec_211),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_212$G_obs_TreeInc_MgHaYr, cut(G_212$STDAGE_t1, cutvec_212), mean)

## make column weights.1
G_212$nls_weights <- as.vector(1/G_bin_means[match(G_212$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.212.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_212, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_212, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_212 <-data.frame(
  ...
  data.mean = tapply(G_212$G_obs_TreeInc_MgHaYr, cut(G_212$STDAGE_t1, cutvec_212), 
                     mean, na.rm =T), 
  data.CI.high =  tapply(G_212$G_obs_TreeInc_MgHaYr, cut(G_212$STDAGE_t1, cutvec_212), 
                    high.CI), 
  data.CI.low = tapply(G_212$G_obs_TreeInc_MgHaYr, cut(G_212$STDAGE_t1, cutvec_212),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_221$G_obs_TreeInc_MgHaYr, cut(G_221$STDAGE_t1, cutvec_221), mean)

## make column weights.1
G_221$nls_weights <- as.vector(1/G_bin_means[match(G_221$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.221.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_221, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_221, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_221 <-data.frame(
  ...
  data.mean = tapply(G_221$G_obs_TreeInc_MgHaYr, cut(G_221$STDAGE_t1, cutvec_221), 
                     mean, na.rm =T), 
  data.CI.high =  tapply(G_221$G_obs_TreeInc_MgHaYr, cut(G_221$STDAGE_t1, cutvec_221), 
                    high.CI), 
  data.CI.low = tapply(G_221$G_obs_TreeInc_MgHaYr, cut(G_221$STDAGE_t1, cutvec_221),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_222$G_obs_TreeInc_MgHaYr, cut(G_222$STDAGE_t1, cutvec_222), mean)

## make column weights.1
G_222$nls_weights <- as.vector(1/G_bin_means[match(G_222$StdAge_bin, names(G_bin_means))])
...
`222_pred2` <- predict(get(paste("nls_222.",  Mod.Sel1, sep ="")),
                      newdata = if(Mod.Sel1 == 1){
                        ...
                        data.frame("MEASTIME_avg"= rep(mean(G_222$MEASTIME_avg), max(G_222$STDAGE_t1)),
                                   "STDAGE_t1"=seq(1, max(G_222$STDAGE_t1), by = 1),
...
## PLOTTING 2
gg.222.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_222, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_222, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_222 <-data.frame(
  ...
  data.mean = tapply(G_222$G_obs_TreeInc_MgHaYr, cut(G_222$STDAGE_t1, cutvec_222), 
                     mean), 
  data.CI.high =  tapply(G_222$G_obs_TreeInc_MgHaYr, cut(G_222$STDAGE_t1, cutvec_222), 
                    high.CI), 
  data.CI.low = tapply(G_222$G_obs_TreeInc_MgHaYr, cut(G_222$STDAGE_t1, cutvec_222),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_223$G_obs_TreeInc_MgHaYr, cut(G_223$STDAGE_t1, cutvec_223), mean)

## make column weights.1
G_223$nls_weights <- as.vector(1/G_bin_means[match(G_223$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.223.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_223, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_223, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_223 <-data.frame(
  ...
  data.mean = tapply(G_223$G_obs_TreeInc_MgHaYr, cut(G_223$STDAGE_t1, cutvec_223), 
                     mean), 
  data.CI.high =  tapply(G_223$G_obs_TreeInc_MgHaYr, cut(G_223$STDAGE_t1, cutvec_223), 
                    high.CI), 
  data.CI.low = tapply(G_223$G_obs_TreeInc_MgHaYr, cut(G_223$STDAGE_t1, cutvec_223),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_231$G_obs_TreeInc_MgHaYr, cut(G_231$STDAGE_t1, cutvec_231), mean)

## make column weights.1
G_231$nls_weights <- as.vector(1/G_bin_means[match(G_231$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.231.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_231, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_231, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_231 <-data.frame(
  ...
  data.mean = tapply(G_231$G_obs_TreeInc_MgHaYr, cut(G_231$STDAGE_t1, cutvec_231), 
                     mean), 
  data.CI.high =  tapply(G_231$G_obs_TreeInc_MgHaYr, cut(G_231$STDAGE_t1, cutvec_231), 
                    high.CI), 
  data.CI.low = tapply(G_231$G_obs_TreeInc_MgHaYr, cut(G_231$STDAGE_t1, cutvec_231),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_232$G_obs_TreeInc_MgHaYr, cut(G_232$STDAGE_t1, cutvec_232), mean)

## make column weights.1
G_232$nls_weights <- as.vector(1/G_bin_means[match(G_232$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.232.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_232, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_232, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_232 <-data.frame(
  ...
  data.mean = tapply(G_232$G_obs_TreeInc_MgHaYr, cut(G_232$STDAGE_t1, cutvec_232), 
                     mean), 
  data.CI.high =  tapply(G_232$G_obs_TreeInc_MgHaYr, cut(G_232$STDAGE_t1, cutvec_232), 
                    high.CI), 
  data.CI.low = tapply(G_232$G_obs_TreeInc_MgHaYr, cut(G_232$STDAGE_t1, cutvec_232),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_234$G_obs_TreeInc_MgHaYr, cut(G_234$STDAGE_t1, cutvec_234), mean)

## make column weights.1
G_234$nls_weights <- as.vector(1/G_bin_means[match(G_234$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.234.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_234, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_234, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_234 <-data.frame(
  ...
  data.mean = tapply(G_234$G_obs_TreeInc_MgHaYr, cut(G_234$STDAGE_t1, cutvec_234), 
                     mean), 
  data.CI.high =  tapply(G_234$G_obs_TreeInc_MgHaYr, cut(G_234$STDAGE_t1, cutvec_234), 
                    high.CI), 
  data.CI.low = tapply(G_234$G_obs_TreeInc_MgHaYr, cut(G_234$STDAGE_t1, cutvec_234),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_242$G_obs_TreeInc_MgHaYr, cut(G_242$STDAGE_t1, cutvec_242), mean)

## make column weights.1
G_242$nls_weights <- as.vector(1/G_bin_means[match(G_242$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.242.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_242, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_242, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_242 <-data.frame(
  ...
  data.mean = tapply(G_242$G_obs_TreeInc_MgHaYr, cut(G_242$STDAGE_t1, cutvec_242), 
                     mean), 
  data.CI.high =  tapply(G_242$G_obs_TreeInc_MgHaYr, cut(G_242$STDAGE_t1, cutvec_242), 
                    high.CI), 
  data.CI.low = tapply(G_242$G_obs_TreeInc_MgHaYr, cut(G_242$STDAGE_t1, cutvec_242),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_251$G_obs_TreeInc_MgHaYr, cut(G_251$STDAGE_t1, cutvec_251), mean)

## make column weights.1
G_251$nls_weights <- as.vector(1/G_bin_means[match(G_251$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.251.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_251, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_251, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_251 <-data.frame(
  ...
  data.mean = tapply(G_251$G_obs_TreeInc_MgHaYr, cut(G_251$STDAGE_t1, cutvec_251), 
                     mean), 
  data.CI.high =  tapply(G_251$G_obs_TreeInc_MgHaYr, cut(G_251$STDAGE_t1, cutvec_251), 
                    high.CI), 
  data.CI.low = tapply(G_251$G_obs_TreeInc_MgHaYr, cut(G_251$STDAGE_t1, cutvec_251),
                    low.CI), 
...
## get bin means
G_255_bin_means <- tapply(G_255$G_obs_TreeInc_MgHaYr, cut(G_255$STDAGE_t1, cutvec_255), mean)

## make column weights.1
G_255$nls_weights <- as.vector(1/G_bin_means[match(G_255$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.255.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_255, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_255, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_255 <-data.frame(
  ...
  data.mean = tapply(G_255$G_obs_TreeInc_MgHaYr, cut(G_255$STDAGE_t1, cutvec_255), 
                     mean), 
  data.CI.high =  tapply(G_255$G_obs_TreeInc_MgHaYr, cut(G_255$STDAGE_t1, cutvec_255), 
                    high.CI), 
  data.CI.low = tapply(G_255$G_obs_TreeInc_MgHaYr, cut(G_255$STDAGE_t1, cutvec_255),
                    low.CI), 
...
#### add weights data column 
## first get the correct bin  - assign as column in data frame
G_261$STDAGE_t1_bin<-  cut(G_261$STDAGE_t1, cutvec_261)
## then get bin means
G_261_bin_means <- tapply(G_261$BIO_MgHa, cut(G_261$STDAGE_t1,  cutvec_261), mean)

## make column weights.2
G_261$nls_weights.2 <- as.numeric(1/(G_261_bin_means[match(G_261$STDAGE_t1_bin, names(G_261_bin_means))])^2)
...
## PLOTTING 2
gg.261.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_261, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_261, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_261 <-data.frame(
  ...
  data.mean = tapply(G_261$G_obs_TreeInc_MgHaYr, cut(G_261$STDAGE_t1, cutvec_261), 
                     mean), 
  data.CI.high =  tapply(G_261$G_obs_TreeInc_MgHaYr, cut(G_261$STDAGE_t1, cutvec_261), 
                    high.CI), 
  data.CI.low = tapply(G_261$G_obs_TreeInc_MgHaYr, cut(G_261$STDAGE_t1, cutvec_261),
                    low.CI), 
...
## then get bin means
G_262_bin_means <- tapply(G_262$BIO_MgHa, cut(G_262$STDAGE_t1,  cutvec_262), mean)

## make column weights.2
G_262$nls_weights.2 <- as.numeric(1/(G_262_bin_means[match(G_262$STDAGE_t1_bin, names(G_262_bin_means))])^2)
...
## PLOTTING 2
gg.262.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_262, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_262, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_262 <-data.frame(
  ...
  data.mean = tapply(G_262$G_obs_TreeInc_MgHaYr, cut(G_262$STDAGE_t1, cutvec_262), 
                     mean), 
  data.CI.high =  tapply(G_262$G_obs_TreeInc_MgHaYr, cut(G_262$STDAGE_t1, cutvec_262), 
                    high.CI), 
  data.CI.low = tapply(G_262$G_obs_TreeInc_MgHaYr, cut(G_262$STDAGE_t1, cutvec_262),
                    low.CI), 
...
## get bin means
G_263_bin_means <- tapply(G_263$G_obs_TreeInc_MgHaYr, cut(G_263$STDAGE_t1, cutvec_263), mean)

## make column weights.1
G_263$nls_weights <- as.vector(1/G_bin_means[match(G_263$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.263.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_263, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_263, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_263 <-data.frame(
  ...
  data.mean = tapply(G_263$G_obs_TreeInc_MgHaYr, cut(G_263$STDAGE_t1, cutvec_263), 
                     mean), 
  data.CI.high =  tapply(G_263$G_obs_TreeInc_MgHaYr, cut(G_263$STDAGE_t1, cutvec_263), 
                    high.CI), 
  data.CI.low = tapply(G_263$G_obs_TreeInc_MgHaYr, cut(G_263$STDAGE_t1, cutvec_263),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_313$G_obs_TreeInc_MgHaYr, cut(G_313$STDAGE_t1, cutvec_313), mean)

## make column weights.1
G_313$nls_weights <- as.vector(1/G_bin_means[match(G_313$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.313.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_313, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_313, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_313 <-data.frame(
  ...
  data.mean = tapply(G_313$G_obs_TreeInc_MgHaYr, cut(G_313$STDAGE_t1, cutvec_313), 
                     mean), 
  data.CI.high =  tapply(G_313$G_obs_TreeInc_MgHaYr, cut(G_313$STDAGE_t1, cutvec_313), 
                    high.CI), 
  data.CI.low = tapply(G_313$G_obs_TreeInc_MgHaYr, cut(G_313$STDAGE_t1, cutvec_313),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_315$G_obs_TreeInc_MgHaYr, cut(G_315$STDAGE_t1, cutvec_315), mean)

## make column weights.1
G_315$nls_weights <- as.vector(1/G_bin_means[match(G_315$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.315.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_315, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_315, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_315 <-data.frame(
  ...
  data.mean = tapply(G_315$G_obs_TreeInc_MgHaYr, cut(G_315$STDAGE_t1, cutvec_315), 
                     mean), 
  data.CI.high =  tapply(G_315$G_obs_TreeInc_MgHaYr, cut(G_315$STDAGE_t1, cutvec_315), 
                    high.CI), 
  data.CI.low = tapply(G_315$G_obs_TreeInc_MgHaYr, cut(G_315$STDAGE_t1, cutvec_315),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_321$G_obs_TreeInc_MgHaYr, cut(G_321$STDAGE_t1, cutvec_321), mean)

## make column weights.1
G_321$nls_weights <- as.vector(1/G_bin_means[match(G_321$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.321.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_321, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_321, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_321 <-data.frame(
  ...
  data.mean = tapply(G_321$G_obs_TreeInc_MgHaYr, cut(G_321$STDAGE_t1, cutvec_321), 
                     mean), 
  data.CI.high =  tapply(G_321$G_obs_TreeInc_MgHaYr, cut(G_321$STDAGE_t1, cutvec_321), 
                    high.CI), 
  data.CI.low = tapply(G_321$G_obs_TreeInc_MgHaYr, cut(G_321$STDAGE_t1, cutvec_321),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_322$G_obs_TreeInc_MgHaYr, cut(G_322$STDAGE_t1, cutvec_322), mean)

## make column weights.1
G_322$nls_weights <- as.vector(1/G_bin_means[match(G_322$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.322.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_322, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_322, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_322 <-data.frame(
  ...
  data.mean = tapply(G_322$G_obs_TreeInc_MgHaYr, cut(G_322$STDAGE_t1, cutvec_322), 
                     mean), 
  data.CI.high =  tapply(G_322$G_obs_TreeInc_MgHaYr, cut(G_322$STDAGE_t1, cutvec_322), 
                    high.CI), 
  data.CI.low = tapply(G_322$G_obs_TreeInc_MgHaYr, cut(G_322$STDAGE_t1, cutvec_322),
                    low.CI), 
...
cutvec_331[8] <-  83 ## fix duplicated 
...
## get bin means
G_bin_means <- tapply(G_331$G_obs_TreeInc_MgHaYr, cut(G_331$STDAGE_t1, cutvec_331), mean)

## make column weights.1
G_331$nls_weights <- as.vector(1/G_bin_means[match(G_331$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.331.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_331, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_331, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
                              col = scales::seq_gradient_pal("#00FF00", "#FF00FF")(seq(0,1,length.out=length(bin_mids_331)-1)), breaks = cutvec_331) +         
...
DM_compare_331 <-data.frame(
  ...
  data.mean = tapply(G_331$G_obs_TreeInc_MgHaYr, cut(G_331$STDAGE_t1, cutvec_331), 
                     mean), 
  data.CI.high =  tapply(G_331$G_obs_TreeInc_MgHaYr, cut(G_331$STDAGE_t1, cutvec_331), 
                    high.CI), 
  data.CI.low = tapply(G_331$G_obs_TreeInc_MgHaYr, cut(G_331$STDAGE_t1, cutvec_331),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_332$G_obs_TreeInc_MgHaYr, cut(G_332$STDAGE_t1, cutvec_332), mean)

## make column weights.1
G_332$nls_weights <- as.vector(1/G_bin_means[match(G_332$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.332.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_332, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_332, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_332 <-data.frame(
  ...
  data.mean = tapply(G_332$G_obs_TreeInc_MgHaYr, cut(G_332$STDAGE_t1, cutvec_332), 
                     mean), 
  data.CI.high =  tapply(G_332$G_obs_TreeInc_MgHaYr, cut(G_332$STDAGE_t1, cutvec_332), 
                    high.CI), 
  data.CI.low = tapply(G_332$G_obs_TreeInc_MgHaYr, cut(G_332$STDAGE_t1, cutvec_332),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_341$G_obs_TreeInc_MgHaYr, cut(G_341$STDAGE_t1, cutvec_341), mean, na.rm =T)

## fix negative numbers in G_bin_means
G_bin_means[11] <-  0.1
G_bin_means[19] <-  0.1

## make column weights.1
G_341$nls_weights <- as.vector(1/G_bin_means[match(G_341$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.341.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_341, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_341, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_341 <-data.frame(
  ...
  data.mean = tapply(G_341$G_obs_TreeInc_MgHaYr, cut(G_341$STDAGE_t1, cutvec_341), 
                     mean), 
  data.CI.high =  tapply(G_341$G_obs_TreeInc_MgHaYr, cut(G_341$STDAGE_t1, cutvec_341), 
                    high.CI), 
  data.CI.low = tapply(G_341$G_obs_TreeInc_MgHaYr, cut(G_341$STDAGE_t1, cutvec_341),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_342$G_obs_TreeInc_MgHaYr, cut(G_342$STDAGE_t1, cutvec_342), mean)

## make column weights.1
G_342$nls_weights <- as.vector(1/G_bin_means[match(G_342$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.342.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_342, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_342, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_342 <-data.frame(
  ...
  data.mean = tapply(G_342$G_obs_TreeInc_MgHaYr, cut(G_342$STDAGE_t1, cutvec_342), 
                     mean), 
  data.CI.high =  tapply(G_342$G_obs_TreeInc_MgHaYr, cut(G_342$STDAGE_t1, cutvec_342), 
                    high.CI), 
  data.CI.low = tapply(G_342$G_obs_TreeInc_MgHaYr, cut(G_342$STDAGE_t1, cutvec_342),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_411$G_obs_TreeInc_MgHaYr, cut(G_411$STDAGE_t1, cutvec_411), mean)

## make column weights.1
G_411$nls_weights <- as.vector(1/G_bin_means[match(G_411$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.411.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_411, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_411, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_411 <-data.frame(
  ...
  data.mean = tapply(G_411$G_obs_TreeInc_MgHaYr, cut(G_411$STDAGE_t1, cutvec_411), 
                     mean), 
  data.CI.high =  tapply(G_411$G_obs_TreeInc_MgHaYr, cut(G_411$STDAGE_t1, cutvec_411), 
                    high.CI), 
  data.CI.low = tapply(G_411$G_obs_TreeInc_MgHaYr, cut(G_411$STDAGE_t1, cutvec_411),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M211$G_obs_TreeInc_MgHaYr, cut(G_M211$STDAGE_t1, cutvec_M211), mean)

## make column weights.1
G_M211$nls_weights <- as.vector(1/G_bin_means[match(G_M211$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M211.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M211, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M211, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M211 <-data.frame(
  ...
  data.mean = tapply(G_M211$G_obs_TreeInc_MgHaYr, cut(G_M211$STDAGE_t1, cutvec_M211), 
                     mean), 
  data.CI.high =  tapply(G_M211$G_obs_TreeInc_MgHaYr, cut(G_M211$STDAGE_t1, cutvec_M211), 
                    high.CI), 
  data.CI.low = tapply(G_M211$G_obs_TreeInc_MgHaYr, cut(G_M211$STDAGE_t1, cutvec_M211),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M221$G_obs_TreeInc_MgHaYr, cut(G_M221$STDAGE_t1, cutvec_M221), mean)

## make column weights.1
G_M221$nls_weights <- as.vector(1/G_bin_means[match(G_M221$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M221.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M221, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M221, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M221 <-data.frame(
  ...
  data.mean = tapply(G_M221$G_obs_TreeInc_MgHaYr, cut(G_M221$STDAGE_t1, cutvec_M221), 
                     mean), 
  data.CI.high =  tapply(G_M221$G_obs_TreeInc_MgHaYr, cut(G_M221$STDAGE_t1, cutvec_M221), 
                    high.CI), 
  data.CI.low = tapply(G_M221$G_obs_TreeInc_MgHaYr, cut(G_M221$STDAGE_t1, cutvec_M221),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M223$G_obs_TreeInc_MgHaYr, cut(G_M223$STDAGE_t1, cutvec_M223), mean)

## make column weights.1
G_M223$nls_weights <- as.vector(1/G_bin_means[match(G_M223$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M223.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M223, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M223, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M223 <-data.frame(
  ...
  data.mean = tapply(G_M223$G_obs_TreeInc_MgHaYr, cut(G_M223$STDAGE_t1, cutvec_M223), 
                     mean), 
  data.CI.high =  tapply(G_M223$G_obs_TreeInc_MgHaYr, cut(G_M223$STDAGE_t1, cutvec_M223), 
                    high.CI), 
  data.CI.low = tapply(G_M223$G_obs_TreeInc_MgHaYr, cut(G_M223$STDAGE_t1, cutvec_M223),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M231$G_obs_TreeInc_MgHaYr, cut(G_M231$STDAGE_t1, cutvec_M231), mean)

## make column weights.1
G_M231$nls_weights <- as.vector(1/G_bin_means[match(G_M231$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M231.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M231, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M231, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M231 <-data.frame(
  ...
  data.mean = tapply(G_M231$G_obs_TreeInc_MgHaYr, cut(G_M231$STDAGE_t1, cutvec_M231), 
                     mean), 
  data.CI.high =  tapply(G_M231$G_obs_TreeInc_MgHaYr, cut(G_M231$STDAGE_t1, cutvec_M231), 
                    high.CI), 
  data.CI.low = tapply(G_M231$G_obs_TreeInc_MgHaYr, cut(G_M231$STDAGE_t1, cutvec_M231),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M242$G_obs_TreeInc_MgHaYr, cut(G_M242$STDAGE_t1, cutvec_M242), mean)

## make column weights.1
G_M242$nls_weights <- as.vector(1/G_bin_means[match(G_M242$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M242.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M242, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M242, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M242 <-data.frame(
  ...
  data.mean = tapply(G_M242$G_obs_TreeInc_MgHaYr, cut(G_M242$STDAGE_t1, cutvec_M242), 
                     mean), 
  data.CI.high =  tapply(G_M242$G_obs_TreeInc_MgHaYr, cut(G_M242$STDAGE_t1, cutvec_M242), 
                    high.CI), 
  data.CI.low = tapply(G_M242$G_obs_TreeInc_MgHaYr, cut(G_M242$STDAGE_t1, cutvec_M242),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M261$G_obs_TreeInc_MgHaYr, cut(G_M261$STDAGE_t1, cutvec_M261), mean)

## make column weights.1
G_M261$nls_weights <- as.vector(1/G_bin_means[match(G_M261$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M261.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M261, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M261, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M261 <-data.frame(
  ...
  data.mean = tapply(G_M261$G_obs_TreeInc_MgHaYr, cut(G_M261$STDAGE_t1, cutvec_M261), 
                     mean), 
  data.CI.high =  tapply(G_M261$G_obs_TreeInc_MgHaYr, cut(G_M261$STDAGE_t1, cutvec_M261), 
                    high.CI), 
  data.CI.low = tapply(G_M261$G_obs_TreeInc_MgHaYr, cut(G_M261$STDAGE_t1, cutvec_M261),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M262$G_obs_TreeInc_MgHaYr, cut(G_M262$STDAGE_t1, cutvec_M262), mean)

## make column weights.1
G_M262$nls_weights <- as.vector(1/G_bin_means[match(G_M262$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M262.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M262, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M262, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M262 <-data.frame(
  ...
  data.mean = tapply(G_M262$G_obs_TreeInc_MgHaYr, cut(G_M262$STDAGE_t1, cutvec_M262), 
                     mean), 
  data.CI.high =  tapply(G_M262$G_obs_TreeInc_MgHaYr, cut(G_M262$STDAGE_t1, cutvec_M262), 
                    high.CI), 
  data.CI.low = tapply(G_M262$G_obs_TreeInc_MgHaYr, cut(G_M262$STDAGE_t1, cutvec_M262),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M313$G_obs_TreeInc_MgHaYr, cut(G_M313$STDAGE_t1, cutvec_M313), mean)

## make column weights.1
G_M313$nls_weights <- as.vector(1/G_bin_means[match(G_M313$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M313.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M313, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M313, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M313 <-data.frame(
  ...
  data.mean = tapply(G_M313$G_obs_TreeInc_MgHaYr, cut(G_M313$STDAGE_t1, cutvec_M313), 
                     mean), 
  data.CI.high =  tapply(G_M313$G_obs_TreeInc_MgHaYr, cut(G_M313$STDAGE_t1, cutvec_M313), 
                    high.CI), 
  data.CI.low = tapply(G_M313$G_obs_TreeInc_MgHaYr, cut(G_M313$STDAGE_t1, cutvec_M313),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M331$G_obs_TreeInc_MgHaYr, cut(G_M331$STDAGE_t1, cutvec_M331), mean)

## make column weights.1
G_M331$nls_weights <- as.vector(1/G_bin_means[match(G_M331$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M331.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M331, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M331, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M331 <-data.frame(
  ...
  data.mean = tapply(G_M331$G_obs_TreeInc_MgHaYr, cut(G_M331$STDAGE_t1, cutvec_M331), 
                     mean), 
  data.CI.high =  tapply(G_M331$G_obs_TreeInc_MgHaYr, cut(G_M331$STDAGE_t1, cutvec_M331), 
                    high.CI), 
  data.CI.low = tapply(G_M331$G_obs_TreeInc_MgHaYr, cut(G_M331$STDAGE_t1, cutvec_M331),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M332$G_obs_TreeInc_MgHaYr, cut(G_M332$STDAGE_t1, cutvec_M332), mean)

## make column weights.1
G_M332$nls_weights <- as.vector(1/G_bin_means[match(G_M332$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M332.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M332, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M332, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M332 <-data.frame(
  ...
  data.mean = tapply(G_M332$G_obs_TreeInc_MgHaYr, cut(G_M332$STDAGE_t1, cutvec_M332), 
                     mean), 
  data.CI.high =  tapply(G_M332$G_obs_TreeInc_MgHaYr, cut(G_M332$STDAGE_t1, cutvec_M332), 
                    high.CI), 
  data.CI.low = tapply(G_M332$G_obs_TreeInc_MgHaYr, cut(G_M332$STDAGE_t1, cutvec_M332),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M333$G_obs_TreeInc_MgHaYr, cut(G_M333$STDAGE_t1, cutvec_M333), mean)

## make column weights.1
G_M333$nls_weights <- as.vector(1/G_bin_means[match(G_M333$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M333.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M333, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M333, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M333 <-data.frame(
  ...
  data.mean = tapply(G_M333$G_obs_TreeInc_MgHaYr, cut(G_M333$STDAGE_t1, cutvec_M333), 
                     mean), 
  data.CI.high =  tapply(G_M333$G_obs_TreeInc_MgHaYr, cut(G_M333$STDAGE_t1, cutvec_M333), 
                    high.CI), 
  data.CI.low = tapply(G_M333$G_obs_TreeInc_MgHaYr, cut(G_M333$STDAGE_t1, cutvec_M333),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M334$G_obs_TreeInc_MgHaYr, cut(G_M334$STDAGE_t1, cutvec_M334), mean)

## make column weights.1
G_M334$nls_weights <- as.vector(1/G_bin_means[match(G_M334$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M334.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M334, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M334, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M334 <-data.frame(
  ...
  data.mean = tapply(G_M334$G_obs_TreeInc_MgHaYr, cut(G_M334$STDAGE_t1, cutvec_M334), 
                     mean), 
  data.CI.high =  tapply(G_M334$G_obs_TreeInc_MgHaYr, cut(G_M334$STDAGE_t1, cutvec_M334), 
                    high.CI), 
  data.CI.low = tapply(G_M334$G_obs_TreeInc_MgHaYr, cut(G_M334$STDAGE_t1, cutvec_M334),
                    low.CI), 
...
## get bin means
G_bin_means <- tapply(G_M341$G_obs_TreeInc_MgHaYr, cut(G_M341$STDAGE_t1, cutvec_M341), mean)

## make column weights.1
G_M341$nls_weights <- as.vector(1/G_bin_means[match(G_M341$StdAge_bin, names(G_bin_means))])
...
## PLOTTING 2
gg.M341.2 <- ggplot() +
             geom_jitter(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M341, 
                         alpha = 0.5, color = "#00000080", shape = "+") +
             ## dark ponts = "#1E88E580"
             geom_hline(yintercept =0, lty =3) +
            
             stat_summary_bin(aes(x = STDAGE_t1, y = G_obs_TreeInc_MgHaYr), data = G_M341, 
                              fun.data = function(x) {
                                res <- c(high.CI(x), mean(x, na.rm=T), low.CI(x))
                                names(res) <- c("ymin","y","ymax")
                                res}, 
...
DM_compare_M341 <-data.frame(
  ...
  data.mean = tapply(G_M341$G_obs_TreeInc_MgHaYr, cut(G_M341$STDAGE_t1, cutvec_M341), 
                     mean), 
  data.CI.high =  tapply(G_M341$G_obs_TreeInc_MgHaYr, cut(G_M341$STDAGE_t1, cutvec_M341), 
                    high.CI), 
  data.CI.low = tapply(G_M341$G_obs_TreeInc_MgHaYr, cut(G_M341$STDAGE_t1, cutvec_M341),
                    low.CI), 
