---
title: "FIA - NLS Models: Biomass Growth vs. Stand Age, Temporally-balanced"
author: "JAH"
date: "`r Sys.Date()`"
output:
  html_document:
...
# 
# ###### COMBINE G_calc
# G <- dplyr::left_join(FIA_G_calc, P_cond_surv[,c("STATE", "CN", "PLT_CN", "INVYR", "STDAGE_t1", "STDORGCD", "CONDPROP_UNADJ", "SITECLCD", "STDSZCD", "COND_STATUS_CD", "P3_OZONE_IND", "ANN_INVENTORY")], by = c("STATE", "CN" = "PLT_CN", "INVYR")) %>% distinct()  # 370598 observations
# 
...
# #### APPLYING FILTERS ####
# 
# ## remove cases of NA's STDAGE_t1 columns
# G <- G[!is.na(G$STDAGE_t1) & !G$STDAGE_t1 == 9999,]
